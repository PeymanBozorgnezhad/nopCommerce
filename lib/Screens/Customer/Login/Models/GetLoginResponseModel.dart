...
GetLoginResponseModel getLoginResponseModelFromJson(String str) =>
    GetLoginResponseModel.fromJson(json.decode(str));

String getLoginResponseModelToJson(GetLoginResponseModel data) =>
