...
import 'package:nopsuite/Models/CustomPropertiesValues.dart';
import 'dart:convert';

import 'package:nopsuite/Models/OrderNote.dart';
import 'package:nopsuite/Models/OrderSummeryModel.dart';
import 'package:nopsuite/Models/ShipmentModel.dart';
import 'package:nopsuite/Models/TaxRateModel.dart';

GetShipmentDetailsModel getShipmentDetailsModelFromJson(String str) =>
    GetShipmentDetailsModel.fromJson(json.decode(str));

String getShipmentDetailsModelToJson(GetShipmentDetailsModel data) =>
...
class GetShipmentDetailsModel {
  ...
  factory GetShipmentDetailsModel.fromJson(Map<String, dynamic> json) =>
      GetShipmentDetailsModel(
        ...
        shipmentStatusEvents:
            List<dynamic>.from(json["ShipmentStatusEvents"].map((x) => x)),
        showSku: json["ShowSku"],
        items: List<GetShipmentDetailsModelItem>.from(
            json["Items"].map((x) => GetShipmentDetailsModelItem.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ShipmentStatusEvents":
            List<dynamic>.from(shipmentStatusEvents.map((x) => x)),
        "ShowSku": showSku,
...
class GetShipmentDetailsModelItem {
  ...
  factory GetShipmentDetailsModelItem.fromJson(Map<String, dynamic> json) =>
      GetShipmentDetailsModelItem(
        sku: json["Sku"],
...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
        ...
        showSku: json["ShowSku"],
        items: List<OrderSummeryModel>.from(
            json["Items"].map((x) => OrderSummeryModel.fromJson(x))),
        orderNotes: List<OrderNote>.from(
            json["OrderNotes"].map((x) => OrderNote.fromJson(x))),
