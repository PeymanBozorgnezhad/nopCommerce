...
import 'package:nopsuite/Models/OrderItemModel.dart';
import 'package:nopsuite/Models/RecurringOrderModel.dart';

CustomerOrdersModel customerOrdersModelFromJson(String str) =>
    CustomerOrdersModel.fromJson(json.decode(str));

String customerOrdersModelToJson(CustomerOrdersModel data) =>
...
class CustomerOrdersModel {
  ...
  factory CustomerOrdersModel.fromJson(Map<String, dynamic> json) =>
      CustomerOrdersModel(
        orders: List<OrderListItem>.from(
            json["Orders"].map((x) => OrderListItem.fromJson(x))),
        recurringOrders: List<RecurringOrder>.from(
            json["RecurringOrders"].map((x) => RecurringOrder.fromJson(x))),
