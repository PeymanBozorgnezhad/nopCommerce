...
import 'package:nopsuite/Models/GiftCardModel.dart';
import 'package:nopsuite/Models/OrderDetailsItemModel.dart';
...
class GetOrderDetailsModel {
  ...
  factory GetOrderDetailsModel.fromJson(Map<String, dynamic> json) =>
      GetOrderDetailsModel(
        ...
        items: List<OrderDetailsItem>.from(
...
class Address {
  ...
  factory Address.fromJson(Map<String, dynamic> json) => Address(
        ...
        customAddressAttributes: List<CustomAddressAttribute>.from(
            json["CustomAddressAttributes"]
                .map((x) => CustomAddressAttribute.fromJson(x))),
        id: json["Id"],
        customProperties: CustomProperties.fromJson(json["CustomProperties"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "CustomAddressAttributes":
            List<dynamic>.from(customAddressAttributes.map((x) => x.toJson())),
        "Id": id,
        "CustomProperties": customProperties.toJson(),
      };
}
...
class CustomAddressAttribute {
  ...
  factory CustomAddressAttribute.fromJson(Map<String, dynamic> json) =>
      CustomAddressAttribute(
        name: json["Name"],
