...
GetCustomerRewardPointsModel getCustomerRewardPointsModelFromJson(String str) =>
    GetCustomerRewardPointsModel.fromJson(json.decode(str));

String getCustomerRewardPointsModelToJson(GetCustomerRewardPointsModel data) =>
...
class GetCustomerRewardPointsModel {
  ...
  factory GetCustomerRewardPointsModel.fromJson(Map<String, dynamic> json) =>
      GetCustomerRewardPointsModel(
