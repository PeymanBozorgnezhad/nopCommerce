...
GetRegisterResponseModel getRegisterResponseModelFromJson(String str) =>
    GetRegisterResponseModel.fromJson(json.decode(str));

String getRegisterResponseModelToJson(GetRegisterResponseModel data) =>
...
class GetRegisterResponseModel {
  ...
  factory GetRegisterResponseModel.fromJson(Map<String, dynamic> json) =>
      GetRegisterResponseModel(
        email: json["Email"],
        ...
        availableCountries: List<CountryStateModel>.from(
            json["AvailableCountries"]
                .map((x) => CountryStateModel.fromJson(x))),
        ...
        availableStates: List<CountryStateModel>.from(
            json["AvailableStates"].map((x) => CountryStateModel.fromJson(x))),
        ...
        availableTimeZones: List<CountryStateModel>.from(
        ...
        customerAttributes: List<CustomerAttributeModel>.from(
            json["CustomerAttributes"]
                .map((x) => CustomerAttributeModel.fromJson(x))),
        gdprConsents: List<GdprConsent_Register>.from(
            json["GdprConsents"].map((x) => GdprConsent_Register.fromJson(x))),
...
class GdprConsent_Register {
  ...
  factory GdprConsent_Register.fromJson(Map<String, dynamic> json) =>
      GdprConsent_Register(
