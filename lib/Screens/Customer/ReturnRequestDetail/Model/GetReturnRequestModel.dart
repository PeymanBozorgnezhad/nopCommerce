...
import 'package:nopsuite/Models/AvailableReturn.dart';
import 'package:nopsuite/Models/CustomProperties.dart';
import 'package:nopsuite/Models/ReturnRequestItem.dart';
import 'dart:convert';

GetReturnRequestModel getReturnRequestModelFromJson(String str) =>
    GetReturnRequestModel.fromJson(json.decode(str));

String getReturnRequestModelToJson(GetReturnRequestModel data) =>
...
class GetReturnRequestModel {
  ...
  factory GetReturnRequestModel.fromJson(Map<String, dynamic> json) =>
      GetReturnRequestModel(
        orderId: json["OrderId"],
        customOrderNumber: json["CustomOrderNumber"],
        items: List<ReturnRequestItem>.from(
            json["Items"].map((x) => ReturnRequestItem.fromJson(x))),
