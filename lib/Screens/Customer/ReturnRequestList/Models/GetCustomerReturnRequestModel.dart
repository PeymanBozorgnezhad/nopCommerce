...
GetCustomerReturnRequestModel getCustomerReturnRequestModelFromJson(
        String str) =>
    GetCustomerReturnRequestModel.fromJson(json.decode(str));

String getCustomerReturnRequestModelToJson(
        GetCustomerReturnRequestModel data) =>
...
class GetCustomerReturnRequestModel {
  ...
  factory GetCustomerReturnRequestModel.fromJson(Map<String, dynamic> json) =>
      GetCustomerReturnRequestModel(
        items: List<CustomerReturnRequestItem>.from(
            json["Items"].map((x) => CustomerReturnRequestItem.fromJson(x))),
...
class CustomerReturnRequestItem {
  ...
  factory CustomerReturnRequestItem.fromJson(Map<String, dynamic> json) =>
      CustomerReturnRequestItem(
