...
import 'package:nopsuite/Screens/Customer/ReturnRequestList/Models/GetCustomerReturnRequestModel.dart';
...
class ReturnRequestProvider extends ChangeNotifier {
  ...
  getCustomerReturnRequest({required BuildContext context}) async {
    ...
    notifyListeners();
    Response response =
        await ReturnRequestService().getCustomerReturnRequest(context: context);
    if (response.statusCode == 200) {
      getCustomerReturnRequestModel =
          getCustomerReturnRequestModelFromJson(response.body);
    }
  ...
  pdfDownloadClickButton(
      {required BuildContext context, required String downloadGuild}) async {
    ...
    if (permissionGranted) {
      ...
      Response response = await ReturnRequestService()
          .getPdfDownload(context: context, param: '/$downloadGuild');
      if (response.statusCode == 200) {
