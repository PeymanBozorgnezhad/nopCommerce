...
import 'package:nopsuite/Screens/Checkout/Models/GetOrderCompletedResponseModel.dart';
...
class _CheckoutPaypalViewState extends State<CheckoutPaypalView> {
  ...
  completeOrderMethod({required BuildContext context}) async {
    Response response =
        await CheckoutService().getOrderCompleteInfo(context: context);
    if (response.statusCode == 200) {
      setState(() {
        getOrderCompletedResponseModel =
            getOrderCompletedResponseModelFromJson(response.body);
        isPageLoader = false;
      });
    } else {
      setState(() {
        ...
        body: isPageLoader
            ...
            : InAppWebView(
                ...
                initialUrlRequest:
                    ...
                    URLRequest(url: WebUri(widget.redirectionUrl.toString())),
                ...
                onLoadStart: (controller, url) {
                  setState(() {
                    ...
                    if (urlController.text ==
                        'https://webapi.nopadvance.team/') {
                      if (localResourceProvider.getSettingByName(
                              "ordersettings.disableordercompletedpage") ==
                          'True') {
                        ...
                        Navigator.pushReplacement(
                            ...
                            PageTransition(
                                type: selectedTransition,
                                child:
                                    OrderConfirmPage(orderId: widget.orderId)));
                      }
                    }
                  });
                },
