...
GetProductReviewsModel getProductReviewsModelFromJson(String str) =>
    GetProductReviewsModel.fromJson(json.decode(str));

String getProductReviewsModelToJson(GetProductReviewsModel data) =>
...
class GetProductReviewsModel {
  ...
  factory GetProductReviewsModel.fromJson(Map<String, dynamic> json) =>
      GetProductReviewsModel(
        ...
        items: List<ProductReviewItem>.from(
            json["Items"].map((x) => ProductReviewItem.fromJson(x))),
        addProductReview: AddProductReview.fromJson(json["AddProductReview"]),
        reviewTypeList: List<ReviewTypeList>.from(
            json["ReviewTypeList"].map((x) => ReviewTypeList.fromJson(x))),
        addAdditionalProductReviewList:
            List<AddAdditionalProductReviewList>.from(
                json["AddAdditionalProductReviewList"]
                    .map((x) => AddAdditionalProductReviewList.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ReviewTypeList":
            List<dynamic>.from(reviewTypeList.map((x) => x.toJson())),
        "AddAdditionalProductReviewList": List<dynamic>.from(
            addAdditionalProductReviewList.map((x) => x.toJson())),
...
class AddAdditionalProductReviewList {
  ...
  factory AddAdditionalProductReviewList.fromJson(Map<String, dynamic> json) =>
      AddAdditionalProductReviewList(
...
class ProductReviewItem {
  ...
  factory ProductReviewItem.fromJson(Map<String, dynamic> json) =>
      ProductReviewItem(
        ...
        additionalProductReviewList: List<AdditionalProductReviewList>.from(
            json["AdditionalProductReviewList"]
                .map((x) => AdditionalProductReviewList.fromJson(x))),
        id: json["Id"],
        customProperties: CustomProperties.fromJson(json["CustomProperties"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "AdditionalProductReviewList": List<dynamic>.from(
            additionalProductReviewList.map((x) => x.toJson())),
        "Id": id,
        "CustomProperties": customProperties.toJson(),
      };
}
...
class AdditionalProductReviewList {
  ...
  factory AdditionalProductReviewList.fromJson(Map<String, dynamic> json) =>
      AdditionalProductReviewList(
        productReviewId: json["ProductReviewId"],
        reviewTypeId: json["ReviewTypeId"],
        rating: json["Rating"],
