...
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductReview/ProductReview.dart';
...
class _ProductReviewState extends State<ProductReview> {
  ...
  loadData() async {
    ...
    if (await CheckConnectivity().checkInternet(context)) {
      context.read<ProductReviewProvider>().pageLoadData(
          context: context,
          productReviewOverview: widget.productReviewOverview);
    }
  }
