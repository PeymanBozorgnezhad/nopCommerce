...
List<RecentlyViewedProductResponseModel>
    recentlyViewedProductResponseModelFromJson(String str) =>
        List<RecentlyViewedProductResponseModel>.from(json
            .decode(str)
            .map((x) => RecentlyViewedProductResponseModel.fromJson(x)));

String recentlyViewedProductResponseModelToJson(
        List<RecentlyViewedProductResponseModel> data) =>
...
class RecentlyViewedProductResponseModel {
  ...
  factory RecentlyViewedProductResponseModel.fromJson(
