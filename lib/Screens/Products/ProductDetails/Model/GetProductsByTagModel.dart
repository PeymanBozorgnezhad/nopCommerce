...
import 'package:nopsuite/Models/SpecificationFilterModel.dart';

GetProductsByTagModel getProductsByTagModelFromJson(String str) =>
    GetProductsByTagModel.fromJson(json.decode(str));

String getProductsByTagModelToJson(GetProductsByTagModel data) =>
...
class GetProductsByTagModel {
  ...
  factory GetProductsByTagModel.fromJson(Map<String, dynamic> json) =>
      GetProductsByTagModel(
...
class CatalogProductsModel {
  ...
  factory CatalogProductsModel.fromJson(Map<String, dynamic> json) =>
      CatalogProductsModel(
        ...
        availableSortOptions: List<AvailableSortOption>.from(
            json["AvailableSortOptions"]
                .map((x) => AvailableSortOption.fromJson(x))),
        allowProductViewModeChanging: json["AllowProductViewModeChanging"],
        availableViewModes: List<AvailableSortOption>.from(
            json["AvailableViewModes"]
                .map((x) => AvailableSortOption.fromJson(x))),
        allowCustomersToSelectPageSize: json["AllowCustomersToSelectPageSize"],
        pageSizeOptions: List<AvailableSortOption>.from(json["PageSizeOptions"]
            .map((x) => AvailableSortOption.fromJson(x))),
        orderBy: json["OrderBy"],
        viewMode: json["ViewMode"],
        products: List<ProductBoxModel>.from(
            json["Products"].map((x) => ProductBoxModel.fromJson(x))),
