...
GetSubscribesModel getSubscribesModelFromJson(String str) =>
    GetSubscribesModel.fromJson(json.decode(str));

String getSubscribesModelToJson(GetSubscribesModel data) =>
...
class GetSubscribesModel {
  ...
  factory GetSubscribesModel.fromJson(Map<String, dynamic> json) =>
      GetSubscribesModel(
