...
class GetProductDetailsModel {
  ...
  factory GetProductDetailsModel.fromJson(Map<String, dynamic> json) =>
      GetProductDetailsModel(
        ...
        productManufacturers: List<VendorModel>.from(
            json["ProductManufacturers"].map((x) => VendorModel.fromJson(x))),
        productReviewOverview:
            ProductReviewOverview.fromJson(json["ProductReviewOverview"]),
        productEstimateShipping:
            ProductEstimateShipping.fromJson(json["ProductEstimateShipping"]),
        tierPrices: List<TierPrice>.from(
            json["TierPrices"].map((x) => TierPrice.fromJson(x))),
        associatedProducts: List<GetProductDetailsModel>.from(
            json["AssociatedProducts"]
                .map((x) => GetProductDetailsModel.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "AssociatedProducts":
            List<GetProductDetailsModel>.from(associatedProducts.map((x) => x)),
...
class ProductAttribute {
  ...
  factory ProductAttribute.fromJson(Map<String, dynamic> json) =>
      ProductAttribute(
        ...
        allowedFileExtensions:
            List<String>.from(json["AllowedFileExtensions"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "AllowedFileExtensions":
            List<String>.from(allowedFileExtensions.map((x) => x)),
...
class ProductEstimateShipping {
  ...
  factory ProductEstimateShipping.fromJson(Map<String, dynamic> json) =>
      ProductEstimateShipping(
        productId: json["ProductId"],
