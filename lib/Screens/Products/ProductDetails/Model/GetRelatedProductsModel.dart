...
List<GetRelatedProductsModel> getRelatedProductsModelFromJson(String str) =>
    List<GetRelatedProductsModel>.from(
        json.decode(str).map((x) => GetRelatedProductsModel.fromJson(x)));

String getRelatedProductsModelToJson(List<GetRelatedProductsModel> data) =>
...
class GetRelatedProductsModel {
  ...
  factory GetRelatedProductsModel.fromJson(Map<String, dynamic> json) =>
      GetRelatedProductsModel(
        name: json["Name"],
