...
List<GetProductsAlsoPurchasedModel> getProductsAlsoPurchasedModelFromJson(
        String str) =>
    List<GetProductsAlsoPurchasedModel>.from(
        json.decode(str).map((x) => GetProductsAlsoPurchasedModel.fromJson(x)));

String getProductsAlsoPurchasedModelToJson(
        List<GetProductsAlsoPurchasedModel> data) =>
...
class GetProductsAlsoPurchasedModel {
  ...
  factory GetProductsAlsoPurchasedModel.fromJson(Map<String, dynamic> json) =>
      GetProductsAlsoPurchasedModel(
        name: json["Name"],
        shortDescription:
