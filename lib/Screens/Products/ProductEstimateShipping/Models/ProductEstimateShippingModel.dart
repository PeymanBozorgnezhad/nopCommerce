...
ProductEstimateShippingModel productEstimateShippingModelFromJson(String str) =>
    ProductEstimateShippingModel.fromJson(json.decode(str));

String productEstimateShippingModelToJson(ProductEstimateShippingModel data) =>
...
class ProductEstimateShippingModel {
  ...
  factory ProductEstimateShippingModel.fromJson(Map<String, dynamic> json) =>
      ProductEstimateShippingModel(
