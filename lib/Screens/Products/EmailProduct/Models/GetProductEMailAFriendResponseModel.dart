...
GetProductEmailAFriendResponseModel getProductEmailAFriendResponseModelFromJson(
        String str) =>
    GetProductEmailAFriendResponseModel.fromJson(json.decode(str));

String getProductEmailAFriendResponseModelToJson(
        GetProductEmailAFriendResponseModel data) =>
...
class GetProductEmailAFriendResponseModel {
  ...
  factory GetProductEmailAFriendResponseModel.fromJson(
