...
GetTopMenuModel getTopMenuModelFromJson(String str) =>
    GetTopMenuModel.fromJson(json.decode(str));

String getTopMenuModelToJson(GetTopMenuModel data) =>
...
class GetTopMenuModel {
  ...
  factory GetTopMenuModel.fromJson(Map<String, dynamic> json) =>
      GetTopMenuModel(
