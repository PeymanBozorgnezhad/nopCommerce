...
GetFooterInfoModel getFooterInfoModelFromJson(String str) =>
    GetFooterInfoModel.fromJson(json.decode(str));

String getFooterInfoModelToJson(GetFooterInfoModel data) =>
...
class GetFooterInfoModel {
  ...
  factory GetFooterInfoModel.fromJson(Map<String, dynamic> json) =>
      GetFooterInfoModel(
        ...
        allowCustomersToApplyForVendorAccount:
            json["AllowCustomersToApplyForVendorAccount"],
        allowCustomersToCheckGiftCardBalance:
            json["AllowCustomersToCheckGiftCardBalance"],
        ...
        topics: List<Topic_Footer>.from(
            json["Topics"].map((x) => Topic_Footer.fromJson(x))),
        ...
        displayRecentlyViewedProductsFooterItem:
            json["DisplayRecentlyViewedProductsFooterItem"],
        displayCompareProductsFooterItem:
            json["DisplayCompareProductsFooterItem"],
        ...
        displayCustomerOrdersFooterItem:
            json["DisplayCustomerOrdersFooterItem"],
        displayCustomerAddressesFooterItem:
            json["DisplayCustomerAddressesFooterItem"],
        displayShoppingCartFooterItem: json["DisplayShoppingCartFooterItem"],
        displayWishlistFooterItem: json["DisplayWishlistFooterItem"],
        displayApplyVendorAccountFooterItem:
            json["DisplayApplyVendorAccountFooterItem"],
