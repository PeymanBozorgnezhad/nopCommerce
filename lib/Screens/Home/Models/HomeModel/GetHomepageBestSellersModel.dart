...
List<GetHomepageBestSellersModel> getHomepageBestSellersModelFromJson(
        String str) =>
    List<GetHomepageBestSellersModel>.from(
        json.decode(str).map((x) => GetHomepageBestSellersModel.fromJson(x)));

String getHomepageBestSellersModelToJson(
        List<GetHomepageBestSellersModel> data) =>
...
class GetHomepageBestSellersModel {
  ...
  factory GetHomepageBestSellersModel.fromJson(Map<String, dynamic> json) =>
      GetHomepageBestSellersModel(
        name: json["Name"],
