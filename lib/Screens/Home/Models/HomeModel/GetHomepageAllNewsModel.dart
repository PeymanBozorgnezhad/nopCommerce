...
GetHomepageAllNewsModel getHomepageAllNewsModelFromJson(String str) =>
    GetHomepageAllNewsModel.fromJson(json.decode(str));

String getHomepageAllNewsModelToJson(GetHomepageAllNewsModel data) =>
...
class GetHomepageAllNewsModel {
  ...
  factory GetHomepageAllNewsModel.fromJson(Map<String, dynamic> json) =>
      GetHomepageAllNewsModel(
        ...
        newsItems: List<NewsItem>.from(
            json["NewsItems"].map((x) => NewsItem.fromJson(x))),
