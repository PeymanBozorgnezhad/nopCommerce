...
List<GetHomepageCategoriesModel> getHomepageCategoriesModelFromJson(
        String str) =>
    List<GetHomepageCategoriesModel>.from(
        json.decode(str).map((x) => GetHomepageCategoriesModel.fromJson(x)));

String getHomepageCategoriesModelToJson(
        List<GetHomepageCategoriesModel> data) =>
...
class GetHomepageCategoriesModel {
  ...
  factory GetHomepageCategoriesModel.fromJson(Map<dynamic, dynamic> json) =>
      GetHomepageCategoriesModel(
        name: json["Name"],
...
List<GetLocalHomepageCategoriesModel> getLocalHomepageCategoriesModelFromJson(
        String str) =>
    List<GetLocalHomepageCategoriesModel>.from(
        json.decode(str).map((x) => GetHomepageCategoriesModel.fromJson(x)));

String getLocalHomepageCategoriesModelToJson(
        List<GetLocalHomepageCategoriesModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class GetLocalHomepageCategoriesModel {
  ...
  factory GetLocalHomepageCategoriesModel.fromJson(
