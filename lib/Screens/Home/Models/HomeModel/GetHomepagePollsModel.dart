...
List<GetHomepagePollsModel> getHomepagePollsModelFromJson(String str) =>
    List<GetHomepagePollsModel>.from(
        json.decode(str).map((x) => GetHomepagePollsModel.fromJson(x)));

String getHomepagePollsModelToJson(List<GetHomepagePollsModel> data) =>
...
class GetHomepagePollsModel {
  ...
  factory GetHomepagePollsModel.fromJson(Map<String, dynamic> json) =>
      GetHomepagePollsModel(
        name: json["Name"],
