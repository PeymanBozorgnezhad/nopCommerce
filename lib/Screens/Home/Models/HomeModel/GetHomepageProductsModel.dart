...
List<GetHomepageProductsModel> getHomepageProductsModelFromJson(String str) =>
    List<GetHomepageProductsModel>.from(
        json.decode(str).map((x) => GetHomepageProductsModel.fromJson(x)));

String getHomepageProductsModelToJson(List<GetHomepageProductsModel> data) =>
...
class GetHomepageProductsModel {
  ...
  factory GetHomepageProductsModel.fromJson(Map<String, dynamic> json) =>
      GetHomepageProductsModel(
        name: json["Name"],
