...
RemoveDiscountCouponResponseModel removeDiscountCouponResponseModelFromJson(
        String str) =>
    RemoveDiscountCouponResponseModel.fromJson(json.decode(str));

String removeDiscountCouponResponseModelToJson(
        RemoveDiscountCouponResponseModel data) =>
...
class RemoveDiscountCouponResponseModel {
  ...
  factory RemoveDiscountCouponResponseModel.fromJson(
      ...
      RemoveDiscountCouponResponseModel(
        ...
        giftCards: List<GiftCardData>.from(
            json["GiftCards"].map((x) => GiftCardData.fromJson(x))),
