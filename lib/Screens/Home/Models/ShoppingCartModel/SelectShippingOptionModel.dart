...
SelectShippingOptionModel selectShippingOptionModelFromJson(String str) =>
    SelectShippingOptionModel.fromJson(json.decode(str));

String selectShippingOptionModelToJson(SelectShippingOptionModel data) =>
...
class SelectShippingOptionModel {
  ...
  factory SelectShippingOptionModel.fromJson(Map<String, dynamic> json) =>
      SelectShippingOptionModel(
