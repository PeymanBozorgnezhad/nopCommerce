...
DiscountCouponResponseModel discountCouponResponseModelFromJson(String str) =>
    DiscountCouponResponseModel.fromJson(json.decode(str));

String discountCouponResponseModelToJson(DiscountCouponResponseModel data) =>
...
class DiscountCouponResponseModel {
  ...
  factory DiscountCouponResponseModel.fromJson(Map<String, dynamic> json) =>
      DiscountCouponResponseModel(
