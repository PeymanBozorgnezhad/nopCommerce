...
GiftCardResponseModel giftCardResponseModelFromJson(String str) =>
    GiftCardResponseModel.fromJson(json.decode(str));

String giftCardResponseModelToJson(GiftCardResponseModel data) =>
...
class GiftCardResponseModel {
  ...
  factory GiftCardResponseModel.fromJson(Map<String, dynamic> json) =>
      GiftCardResponseModel(
