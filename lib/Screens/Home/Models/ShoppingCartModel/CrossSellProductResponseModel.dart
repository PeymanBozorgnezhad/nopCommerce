...
import 'package:nopsuite/Models/ProductPriceModel.dart';
import 'package:nopsuite/Models/ProductSpecificationModel.dart';

List<CrossSellProductResponseModel> crossSellProductResponseModelFromJson(
        String str) =>
    List<CrossSellProductResponseModel>.from(
        json.decode(str).map((x) => CrossSellProductResponseModel.fromJson(x)));

String crossSellProductResponseModelToJson(
        List<CrossSellProductResponseModel> data) =>
...
class CrossSellProductResponseModel {
  ...
  factory CrossSellProductResponseModel.fromJson(Map<String, dynamic> json) =>
      CrossSellProductResponseModel(
        name: json["Name"],
