...
GetEmailWishlistResponseModel getEmailWishlistResponseModelFromJson(
        String str) =>
    GetEmailWishlistResponseModel.fromJson(json.decode(str));

String getEmailWishilistResponseModelToJson(
        GetEmailWishlistResponseModel data) =>
...
class GetEmailWishlistResponseModel {
  ...
  factory GetEmailWishlistResponseModel.fromJson(Map<String, dynamic> json) =>
      GetEmailWishlistResponseModel(
