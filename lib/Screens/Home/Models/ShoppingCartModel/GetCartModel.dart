...
class GetCartModel {
  ...
  factory GetCartModel.fromJson(Map<String, dynamic> json) => GetCartModel(
        ...
        checkoutAttributes: List<CheckoutAttribute>.from(
            json["CheckoutAttributes"]
                .map((x) => CheckoutAttribute.fromJson(x))),
        ...
        buttonPaymentMethodViewComponentNames: List<String>.from(
