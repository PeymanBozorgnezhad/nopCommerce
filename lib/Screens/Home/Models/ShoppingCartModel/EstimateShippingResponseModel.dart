...
EstimateShippingResponseModel estimateShippingResponseModelFromJson(
        String str) =>
    EstimateShippingResponseModel.fromJson(json.decode(str));

String estimateShippingResponseModelToJson(
        EstimateShippingResponseModel data) =>
...
class EstimateShippingResponseModel {
  ...
  factory EstimateShippingResponseModel.fromJson(Map<String, dynamic> json) =>
      EstimateShippingResponseModel(
