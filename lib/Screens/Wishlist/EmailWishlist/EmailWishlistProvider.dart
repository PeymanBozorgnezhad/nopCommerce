...
class EmailWishlistProvider extends ChangeNotifier {
  ...
  getEmailWishlistData({required BuildContext context}) async {
    ...
    Response response =
        await WishlistService().getEmailWishlist(context: context);
    if (response.statusCode == 200) {
      getEmailWishlistResponseModel =
          getEmailWishlistResponseModelFromJson(response.body);
      ...
      if (getEmailWishlistResponseModel.yourEmailAddress != null) {
        yourEmailController.text =
            getEmailWishlistResponseModel.yourEmailAddress;
      }
  ...
  shareEmailWishlist({required BuildContext context}) async {
    ...
    var body = '{'
        ...
        '"}';
    Response response = await WishlistService()
        .shareEmailWishlist(context: context, body: body);
    if (response.statusCode == 200) {
      Navigator.pop(context);
      FlushBarMessage().successMessage(
          context: context, title: response.body.replaceAll('"', ""));
