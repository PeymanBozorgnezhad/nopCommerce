...
class OrderServices {
  ...
  getListOfOrderData({required BuildContext context}) async {
    return _apiService.httpGet(
        context: context,
        url: APIConstants.GET_CUSTOMER_ORDERS_API,
  ...
  getPdfInvoiceOrder(
    ...
    return _apiService.httpGet(
        context: context,
        url: APIConstants.GET_PDF_INVOICE_API + param,
        isWithoutToken: false);
  }
  ...
  getOrderShipmentDetails(
    ...
    return _apiService.httpGet(
        context: context,
        url: APIConstants.GET_SHIPMENT_DETAILS_API + param,
        isWithoutToken: false);
  }
  ...
  cancelRecurringPayment(
    ...
    return await _apiService.httpPostWithoutBody(
        context: context,
        url: APIConstants.CANCEL_RECURRING_PAYMENT_API + param);
  }
  ...
  retryLastRecurringPayment(
    ...
    return await _apiService.httpPost(
        context: context,
        url: APIConstants.RETRY_LAST_RECURRING_PAYMENT_API + param,
        body: body);
  }
}
