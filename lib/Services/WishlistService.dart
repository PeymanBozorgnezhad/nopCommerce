...
class WishlistService {
  ...
  getWishlist({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_WISH_LIST_API,
  ...
  productDetailsAddToWishlist(
    ...
    return await _apiService.httpPost(
        context: context,
        url: APIConstants.SET_ADD_TO_WISHLIST_API + params,
        body: body);
  }
  ...
  getEmailWishlist({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_EMAIL_WISHLIST_API,
        isWithoutToken: false);
  }

  shareEmailWishlist({required BuildContext context, required var body}) async {
    return await _apiService.httpPost(
        context: context, url: APIConstants.EMAIL_WISHLIST_API, body: body);
  }
  ...
  addToCartWishlistItem(
    ...
    return await _apiService.httpPost(
        context: context,
        url: APIConstants.ADD_ITEMS_TO_CART_FROM_WISHLIST_API,
        body: body);
  }
  ...
  deleteWishlistItem({required BuildContext context, required var body}) async {
    return await _apiService.httpDelete(
        context: context,
        url: APIConstants.DELETE_WISHLIST_ITEMS_API,
        body: body);
  }
}
