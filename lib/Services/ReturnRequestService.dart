...
class ReturnRequestService {
  ...
  getCustomerReturnRequest({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_CUSTOMER_RETURN_REQUEST_API,
  ...
  getReturnRequest(
    ...
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_RETURN_REQUEST_API + param,
        isWithoutToken: false);
  }
  ...
  returnRequest(
    ...
    return await _apiService.httpPost(
        context: context,
        url: APIConstants.RETURN_REQUEST_API + param,
        body: body);
  }
  ...
  uploadFileReturnRequest(
    ...
    return await _apiService.httpPost(
        context: context,
        url: APIConstants.UPLOAD_FILE_RETURN_REQUEST_API,
        body: body);
  }
  ...
  getPdfDownload({required BuildContext context, required String param}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.DOWNLOAD_PDF_API + param,
        isWithoutToken: false);
  }
}
