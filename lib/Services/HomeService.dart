...
class HomeService {
  ...
  getNivoSlider({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_NIVO_SLIDER_API,
  ...
  getHomeCategoryData({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_HOME_PAGE_CATEGORIES_API,
        isWithoutToken: false);
  }
  ...
  getHomeProductsData({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_HOME_PAGE_PRODUCTS_API,
        isWithoutToken: false);
  }
  ...
  getHomeBestSellerData({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_HOME_PAGE_BEST_SELLERS_API,
        isWithoutToken: false);
  }
  ...
  getTopMenuData({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_TOP_MENU_API,
        isWithoutToken: false);
  }
}
