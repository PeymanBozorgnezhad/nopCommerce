...
class CommonService {
  ...
  getLocalResource({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_LOCAL_STRING_RESOURCES_API,
        isWithoutToken: true);
  }
  ...
  getSettings({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_SETTING_API,
        isWithoutToken: true);
  }

  getPing({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context, url: APIConstants.GET_PING_API, isWithoutToken: true);
  }

  getGuestToken({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GUEST_TOKEN_API,
        isWithoutToken: true);
  }
  ...
  getTopicBlock({required BuildContext context, required String topic}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_TOPIC_BLOCK_API + '/$topic',
  ...
  getTopicBlockById(
    ...
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_TOPIC_BLOCK_BY_ID_API + '/$topicId',
        isWithoutToken: false);
  }
  ...
  getHeaderData({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_HEADER_INFO_API,
        isWithoutToken: false);
  }
  ...
  getStateData({required BuildContext context, required int countryId}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_STATE_API + "/$countryId",
        isWithoutToken: false);
  }
  ...
  getUserAgreement(
    ...
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.USER_AGREEMENT_API + params,
        isWithoutToken: false);
  }
