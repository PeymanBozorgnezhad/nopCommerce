...
class BackInStockSubscriptionsService {
  ...
  getCustomerSubscriptions({required BuildContext context}) async {
    return await _apiService.httpGet(
        context: context,
        url: APIConstants.GET_CUSTOMER_SUBSCRIPTION_API,
  ...
  setSubscriptions({required BuildContext context, required var body}) async {
    return await _apiService.httpPost(
        context: context, url: APIConstants.ADD_SUBSCRIPTION_API, body: body);
  }

  removeProductSubscriptions(
      {required BuildContext context, required var body}) async {
    return await _apiService.httpPost(
        context: context,
        url: APIConstants.REMOVE_SUBSCRIPTION_API,
        body: body);
  }
}
