...
import 'package:nopsuite/Common/ThemeFont.dart';
import 'package:nopsuite/Screens/Checkout/CheckoutPaypalView/CheckoutPaypalViewProvider.dart';
...
import 'package:nopsuite/Screens/General/SplashScreen.dart';
import 'package:nopsuite/Screens/Customer/Avatar/AvatarProvider.dart';
import 'package:nopsuite/Screens/Customer/ChangePassword/ChangePasswordProvider.dart';
import 'package:nopsuite/Screens/Customer/Login/LoginProvider.dart';
...
void main() async {
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider<LocalResourceProvider>(
        create: (_) => LocalResourceProvider()),
    ChangeNotifierProvider<LoginProvider>(create: (_) => LoginProvider()),
    ChangeNotifierProvider<ForgotPasswordProvider>(
        create: (_) => ForgotPasswordProvider()),
    ChangeNotifierProvider<HomeProvider>(create: (_) => HomeProvider()),
    ChangeNotifierProvider<ProductBoxProvider>(
        create: (_) => ProductBoxProvider()),
    ...
    ChangeNotifierProvider<GdprToolsProvider>(
        create: (_) => GdprToolsProvider()),
    ChangeNotifierProvider<RewardPointProvider>(
        create: (_) => RewardPointProvider()),
    ChangeNotifierProvider<BackInStockSubscriptionsProvider>(
        create: (_) => BackInStockSubscriptionsProvider()),
    ChangeNotifierProvider<GiftCardBalanceProvider>(
        create: (_) => GiftCardBalanceProvider()),
    ...
    ChangeNotifierProvider<SearchTermProvider>(
        create: (_) => SearchTermProvider()),
    ChangeNotifierProvider<ProductEstimateShippingProvider>(
        create: (_) => ProductEstimateShippingProvider()),
    ChangeNotifierProvider<DownloadableProductProvider>(
        create: (_) => DownloadableProductProvider()),
    ChangeNotifierProvider<UserAgreementProvider>(
        create: (_) => UserAgreementProvider()),
    ChangeNotifierProvider<AppBarProvider>(create: (_) => AppBarProvider()),
    ChangeNotifierProvider<EmailProductProvider>(
        create: (_) => EmailProductProvider()),
    ChangeNotifierProvider<BottomNavigationProvider>(
        create: (_) => BottomNavigationProvider()),
    ChangeNotifierProvider<CompareProductProvider>(
        create: (_) => CompareProductProvider()),
    ChangeNotifierProvider<CartEstimateShippingProvider>(
        create: (_) => CartEstimateShippingProvider()),
    ChangeNotifierProvider<CheckoutProvider>(create: (_) => CheckoutProvider()),
    ChangeNotifierProvider<OrderShipmateDetailProvider>(
        create: (_) => OrderShipmateDetailProvider()),
    ChangeNotifierProvider<ReturnRequestDetailProvider>(
        create: (_) => ReturnRequestDetailProvider()),
    ChangeNotifierProvider<ReturnRequestProvider>(
        create: (_) => ReturnRequestProvider()),
    ChangeNotifierProvider<OrderConfirmPageProvider>(
        create: (_) => OrderConfirmPageProvider()),
    ChangeNotifierProvider<CheckoutPaypalViewProvider>(
        create: (_) => CheckoutPaypalViewProvider()),
    ChangeNotifierProvider<TopicBlockDetailsProvider>(
        create: (_) => TopicBlockDetailsProvider()),
    ChangeNotifierProvider<SearchProductsProvider>(
        create: (_) => SearchProductsProvider()),
    ChangeNotifierProvider<WishlistProvider>(create: (_) => WishlistProvider()),
    ChangeNotifierProvider<EmailWishlistProvider>(
        create: (_) => EmailWishlistProvider()),
    ChangeNotifierProvider<ProductByPopularTagProvider>(
        create: (_) => ProductByPopularTagProvider()),
    ChangeNotifierProvider<ProductTagProvider>(
        create: (_) => ProductTagProvider()),
    ChangeNotifierProvider<NewProductsProvider>(
        create: (_) => NewProductsProvider()),
    ChangeNotifierProvider<ContactUsProvider>(
        create: (_) => ContactUsProvider()),
    ChangeNotifierProvider<CustomerProductReviewProvider>(
        create: (_) => CustomerProductReviewProvider()),
    ChangeNotifierProvider<CreateOrUpdateAddressProvider>(
        create: (_) => CreateOrUpdateAddressProvider()),
  ], child: const MyApp()));
}
