        ...
        child: Container(
          ...
          child: Scaffold(
                  ...
                  searchProductsProvider.searchProductModel.availableCategories.where((element) => element.selected).isEmpty &&
                          (searchProductsProvider.currentRangeValues.start ==
                              ...
                              searchProductsProvider
                                      ...
                                      .from ==
                                  null) &&
                          (searchProductsProvider.currentRangeValues.end ==
                                  searchProductsProvider
                                      .searchProductModel
                                      .catalogProductsModel
                                      .priceRangeFilter
                                      .availablePriceRange
                                      .to ||
                              searchProductsProvider.maxPrice == 10000000 ||
                              searchProductsProvider
                                      .searchProductModel
                                      .catalogProductsModel
                                      .priceRangeFilter
                      ...
                      : searchProductsProvider.searchProductModel.catalogProductsModel.specificationFilter.enabled ||
                          ...
                          ? GestureDetector(
                              onTap: () {
                                searchProductsProvider.clearAttributes(
                                    context: context);
                              },
                              child: Container(
            ...
            bottomNavigationBar: Container(
              ...
              height: searchProductsProvider.searchProductModel
                          .catalogProductsModel.specificationFilter.enabled ||
                      searchProductsProvider.searchProductModel
                          .catalogProductsModel.manufacturerFilter.enabled ||
                      searchProductsProvider.searchProductModel
                          .catalogProductsModel.priceRangeFilter.enabled
                  ? FlexoValues.controlsHeight + FlexoValues.widthSpace4Px
                  : 0,
              child:
                  searchProductsProvider.searchProductModel.catalogProductsModel
                              .specificationFilter.enabled ||
                          searchProductsProvider
                              .searchProductModel
                              .catalogProductsModel
                              .manufacturerFilter
                            ...
                            child: Column(
                              children: [
                                ...
                                searchProductsProvider
                                    ...
                                    : Container(),
                                searchProductsProvider.getCatalogRootModel ==
                                            null ||
                                        searchProductsProvider
                                                ...
                                                Container(
                                                  width:
                                                      FlexoValues.deviceWidth *
                                                          06,
                                                  child: RangeSlider(
                                                    min: searchProductsProvider
                                                        .searchProductModel
                                                        .catalogProductsModel
                                                        .priceRangeFilter
                                                        .availablePriceRange
                                                        .from,
                                                    max: searchProductsProvider
                                                        .searchProductModel
                                                        .catalogProductsModel
                                                        .priceRangeFilter
                                                        .availablePriceRange
