...
import 'package:nopsuite/Screens/Catalog/SearchProducts/SearchProductsProvider.dart';
import 'package:nopsuite/Screens/General/LocalResourceProvider.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Catalog/SearchProducts/Component/SearchProductDrawerComponent.dart';
...
import 'package:nopsuite/Themes/Flexo/Screen/Shared/ProductBox/ProductBox.dart';
      ...
      child: Scaffold(
        ...
        appBar: FlexoAppBarWidget().appbar(
            ...
            title: localResourceProvider.isLocalDataLoad
                ? ""
                : localResourceProvider.getResourseByKey("pageTitle.search"),
            backButton: true),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: searchProductsProvider.headerModel,
            headerLoader: searchProductsProvider.isPageLoader),
        body: searchProductsProvider.isPageLoader
            ? Loaders.pageLoader()
            : StatefulBuilder(builder: (context, setState) {
                return Column(
                  children: [
                    searchProductsProvider.isAPILoader
                        ? Loaders.apiLoader()
                        : Container(),
                    Expanded(
                      child: Container(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          Container(
                                                            child: Column(
                                                              children: searchProductsProvider
                                                                  .searchProductModel
                                                                  .catalogProductsModel
                                                                  ...
                                                                  onTap: () {
                                                                    setState(
                                                                      ...
                                                                      searchProductsProvider
                                                                          .searchProductModel
                                                                          .catalogProductsModel
                                                                          .orderBy = int.parse(data.value);
                                                                      Navigator.pop(
                                                                          context);
                                                                      searchProductsProvider.searchButtonClick(
                                                                          context:
                                                                              context,
                                                                          searchTerms: searchProductsProvider
                                                                              .searchProductModel
                                                                              .q);
                                                                    });
                                                                  },
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                            child:
                                                                                Icon(
                                                                          searchProductsProvider.searchProductModel.catalogProductsModel.orderBy.toString() == data.value
                                                                              ? Icons.radio_button_checked
                                                                              : Icons.radio_button_off,
                                                                          color: searchProductsProvider.searchProductModel.catalogProductsModel.orderBy.toString() == data.value
                                ...
                                child: Column(
                                  children: [
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          border: new OutlineInputBorder(
                                              ...
                                              borderRadius: BorderRadius.zero),
                                          filled: true,
                                          fillColor: FlexoColorConstants
                                              .CONTROL_BACKGROUND_COLOR,
                                        ),
                                        keyboardType: TextInputType.text,
                                        cursorColor:
                                            FlexoColorConstants.CURSOR_COLOR,
                                        ...
                                        children: [
                                          Transform.scale(
                                            ...
                                            child: CupertinoSwitch(
                                              ...
                                              value: searchProductsProvider
                                                  .searchProductModel.advs,
                                    ...
                                    ButtonWidget().getButton(
                                        text: localResourceProvider
                                            .getResourseByKey("search.button")
                                            .toString()
                                            .toUpperCase(),
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Wrap(
                                                            ...
                                                            children: searchProductsProvider
                                                                ...
                                                                .map((e) {
                                                              return Container(
                                                                child: ProductBox().getProductBox(
                                                                    context:
                                                                        context,
                                                                    productBoxModel:
                                                                        e,
