...
import 'package:nopsuite/Models/GetPopularProductTagsModel.dart';
import 'package:nopsuite/Screens/Catalog/ProductsByCategory/Model/GetCategoryResponseModel.dart';
...
class ProductByCategoryDrawerComponent {
  getProductByCategoryDrawerComponent({
    ...
    return StatefulBuilder(builder: (context, setState) {
      List<int> specsList = [];
      for (var item in getCategoryResponseModel
        ...
        child: Container(
          ...
          child: Scaffold(
                  ...
                  specsList.isEmpty &&
                          ...
                          (currentRangeValues.end ==
                                  getCategoryResponseModel
                                      ...
                                      .availablePriceRange
                                      .to ||
                              currentRangeValues.end == 10000000 ||
                              getCategoryResponseModel
                                      .catalogProductsModel
                                      .priceRangeFilter
                                      .availablePriceRange
                                  ...
                                  null)
                      ? Container()
                      : getCategoryResponseModel.catalogProductsModel
            ...
            bottomNavigationBar: Container(
              height: getCategoryResponseModel
              ...
              child: getCategoryResponseModel
                          .catalogProductsModel.specificationFilter.enabled ||
                      getCategoryResponseModel
                          .catalogProductsModel.priceRangeFilter.enabled
                  ? Row(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                getPopularProductTagsModel == null
                                    ? Container()
                                    : GestureDetector(
                                        onTap: () {
                                          setState(() {
                                                ...
                                                Container(
                                                  width:
                                                      FlexoValues.deviceWidth *
                                                          0.6,
                                                  child: RangeSlider(
                                                    min: getCategoryResponseModel
                                                        .catalogProductsModel
                                                        .priceRangeFilter
                                                        .availablePriceRange
                                                        .from,
                                                    max: getCategoryResponseModel
                                                        .catalogProductsModel
                                                        .priceRangeFilter
                                                        .availablePriceRange
                                                        .to,
