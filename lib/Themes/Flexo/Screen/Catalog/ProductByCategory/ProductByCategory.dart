      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            margin:
                EdgeInsets.symmetric(horizontal: FlexoValues.horizontalSpace),
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    getCategoryResponseModel
                            .catalogProductsModel.products.isEmpty
                        ? Container()
                        : GestureDetector(
                            onTap: () {
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Container(
                                            child: Column(
                                              children: getCategoryResponseModel
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          getCategoryResponseModel
                                                              ...
                                                              : Icons
                                                                  .radio_button_off,
                                                          color: getCategoryResponseModel
                                                                      .catalogProductsModel
                                                                      .orderBy
                                                                      .toString() ==
                                                                  data.value
                                ...
                                children: [
                                  Container(
                                    child: FlexoTextWidget().headingText16(
                                      text: StringConstants.SORT_BUTTON_STRING,
                                    ),
                                  ),
                                  SizedBox(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              child: FlexoTextWidget().headingText16(
                                text: StringConstants.FILTER_BUTTON_STRING,
                              ),
                            ),
          ...
          Container(
            margin: EdgeInsets.symmetric(
                vertical: FlexoValues.deviceHeight * 0.005,
                horizontal: FlexoValues.widthSpace2Px),
            alignment: Alignment.centerLeft,
            child: FlexoTextWidget().headingBoldText16(
              text: "${getCategoryResponseModel.name.toUpperCase()}",
            ),
          ),
          getCategoryResponseModel.subCategories.isNotEmpty
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: getCategoryResponseModel.subCategories
                                  .map((e) {
                                return GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                  ...
                                  child: Container(
                                    margin: EdgeInsets.only(
                                        left: FlexoValues.widthSpace2Px),
                                    child: Column(
                                      children: [
                                        Container(
                                          width: FlexoValues.deviceWidth * 0.35,
                                          height:
                                              FlexoValues.deviceWidth * 0.25,
                                          alignment: Alignment.center,
                                          decoration: BoxDecoration(
                                          ...
                                          child: Container(
                                            width:
                                                FlexoValues.deviceWidth * 0.32,
                                            height:
                                                FlexoValues.deviceWidth * 0.23,
                                            alignment: Alignment.center,
                                            child: Container(
                                              width:
              ...
              : Container(),
          getCategoryResponseModel.catalogProductsModel.products.isEmpty &&
                  getCategoryResponseModel.subCategories.isEmpty
              ? StatefulBuilder(builder: (context, setState) {
                  return Container(
                    padding: EdgeInsets.symmetric(
                        vertical: FlexoValues.widthSpace3Px,
                        horizontal: FlexoValues.widthSpace2Px),
                    alignment: Alignment.centerLeft,
                    child: FlexoTextWidget().headingText16(
                      text: context
                          .watch<LocalResourceProvider>()
                          .getResourseByKey("catalog.products.noResult"),
                    ),
                  );
                })
              : Container(
                          ...
                          children: products.map((e) {
                            return Container(
                              child: ProductBox().getProductBox(
                                  ...
                                  productBoxModel: e,
                                  localResourceProvider:
                                      context.watch<LocalResourceProvider>(),
