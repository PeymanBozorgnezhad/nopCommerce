  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: FlexoAppBarWidget()
          .searchableAppbar(context: context, backButton: false),
      ...
      body: RefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              homeProvider.isHomePageRefresh
                  ? Loaders.apiLoader()
                  : Container(),
              HomePageNivoSlider().getHomePageNivoSlider(context: context),
              SizedBox(
                height: FlexoValues.verticalPadding,
              ),
                          ...
                          Container(
                            ...
                            child: FlexoTextWidget().headingBoldText16(
                                text: localResourceProvider
                                    .getResourseByKey("homepage.products")
                                    .toUpperCase(),
                                maxLines: 2),
                          ),
                          Expanded(
              ...
              localResourceProvider.getSettingByName(
                          "catalogsettings.showbestsellersonhomepage") ==
                      "True"
                  ? Column(
                      children: [
                        homeProvider.getHomepageBestSellerModel.length > 0
                            ...
                            : Container(),
                        HomePageProducts().getHomePageBestSeller(
                            context: context,
                            localResourceProvider: localResourceProvider),
                      ],
                    )
