...
import 'package:nopsuite/Screens/General/ContactUs/ContactUs.dart';
...
import 'package:nopsuite/Screens/Products/CompareProduct/CompareProduct.dart';
import 'package:nopsuite/Screens/Products/NewProducts/NewProducts.dart';
        ...
        child: Column(
          children: [
            ...
            homeProvider.getTopMenuModel.topics.length > 0
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Column(
                            children:
                                homeProvider.getTopMenuModel.topics.map((e) {
                              return Container(
                                child: categoryItem(
                                    context: context,
                ...
                : Container(),
            homeProvider.getTopMenuModel.newProductsEnabled &&
                    homeProvider.getTopMenuModel.displayNewProductsMenuItem
                ? categoryItem(
                    context: context,
                    title: localResourceProvider
                        .getResourseByKey('products.newProducts'),
                    icon: Ionicons.bag_outline,
                    onTap: () {
                      Navigator.push(
                          context,
                          PageTransition(
                              type: selectedTransition, child: NewProducts()));
                    })
                : Container(),
            localResourceProvider.getSettingByName(
                        "CustomerSettings.AllowCustomersTocCheckGiftCardBalance") ==
                    'True'
                ? categoryItem(
                    context: context,
                    title: localResourceProvider
                        .getResourseByKey('pageTitle.checkGiftCardBalance'),
                ...
                ? categoryItem(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          PageTransition(
                              type: selectedTransition, child: ContactUs()));
                    })
                : Container(),
            categoryItem(
                context: context,
                title: localResourceProvider
                    .getResourseByKey('products.compare.list'),
                icon: Ionicons.git_compare_outline,
                onTap: () {
                  Navigator.push(
                      context,
                      PageTransition(
                          type: selectedTransition, child: CompareProduct()));
                }),
          ],
        ),
      ),
