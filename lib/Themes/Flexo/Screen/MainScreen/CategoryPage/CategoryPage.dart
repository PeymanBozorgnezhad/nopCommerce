    ...
    return Scaffold(
      appBar: FlexoAppBarWidget().appbar(
          ...
          title: localResourceProvider.isLocalDataLoad
              ? ""
              : localResourceProvider.getResourseByKey("menu"),
          backButton: false),
      backgroundColor: FlexoColorConstants.BACKGROUND_COLOR,
      body:
          homeProvider.isTopMenuLoader || localResourceProvider.isLocalDataLoad
              ? Loaders.pageLoader()
              : SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                              ...
                              child: Column(
                                children: [
                                  Theme(
                                    ...
                                    child: ExpansionTile(
                                      title: FlexoTextWidget().headingText16(
                                          text: localResourceProvider
                                              .getResourseByKey(
                                                  "NopAdvance.plugin.PublicApi.DefaultClean.ShopByCategory"),
                                          maxLines: 1),
                                      initiallyExpanded:
                                          homeProvider.isExpandCategory,
                                      onExpansionChanged: (val) {
                                        homeProvider.changeCategoryStatus();
                                        if (!homeProvider.isExpandCategory) {
                                          for (var i in homeProvider
                                              .getTopMenuModel.categories) {
                                            homeProvider.changeExpandListStatus(
                                                listId: i.id, status: false);
                                          }
                                        }
                                      },
                                      trailing: Icon(
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Theme(
                                                                ...
                                                                child:
                                                                  ...
                                                                  trailing:
                                                                      Icon(
                                                                    homeProvider.categoryExpandList[p
                                                                            .id]!
                                                                        ? Ionicons
                                                                            .caret_up_outline
                                                                        : Ionicons
                      ...
                      CategoryComponent()
                          .getCategoryComponent(context: context),
                    ],
                  ),
                ),
    );
