            ...
            children: [
              ...
              Container(
                ...
                child: FlexoTextWidget().headingText16(
                  text: localResourceProvider.getResourseByKey(
                      "nopAdvance.plugin.publicApi.defaultClean.signInForBetterExperience"),
                ),
              ),
              SizedBox(
                height: FlexoValues.heightSpace2Px,
              ...
              ButtonWidget().getButton(
                  text: localResourceProvider
                      .getResourseByKey("account.login.loginButton")
                      .toString()
                      .toUpperCase(),
                  ...
                  onClick: () {
                    Navigator.push(
                        ...
                        PageTransition(
                            ...
                            child: Login(loginType: LoginTypeAttribute.Other)));
                  },
                  isApiLoad: false),
              SizedBox(
              ...
              ButtonWidget().getButton(
                  text: localResourceProvider
                      .getResourseByKey("account.register")
                      .toString()
                      .toUpperCase(),
                  width: FlexoValues.controlsWidth,
                  onClick: () {
                    Navigator.push(
                        ...
                        PageTransition(
                            type: selectedTransition,
                            child: Register(
                              loginType: LoginTypeAttribute.Other,
                            )));
                  },
                  isApiLoad: false),
              SizedBox(
              ...
              ButtonWidget().getButton(
                  text: localResourceProvider
                      .getResourseByKey("shoppingCart.continueShopping")
                      .toString()
                      .toUpperCase(),
                  width: FlexoValues.controlsWidth,
                  onClick: () {
