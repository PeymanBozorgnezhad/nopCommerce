...
class FlexoCartEstimateShippingPopup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var cartEstimateShippingProvider =
        context.watch<CartEstimateShippingProvider>();

    return GestureDetector(
      onTap: () => FocusManager.instance.primaryFocus?.unfocus(),
      child: Scaffold(
        appBar: FlexoAppBarWidget().appbarPopup(
            context: context,
            title: localResourceProvider.isLocalDataLoad
                ? ""
                : localResourceProvider.getResourseByKey("Estimate Shipping")),
        backgroundColor: FlexoColorConstants.BACKGROUND_COLOR,
        body: cartEstimateShippingProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  cartEstimateShippingProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  FlexoDropDown(
                                      width: FlexoValues.controlsWidth,
                                      selectedValue:
                                          cartEstimateShippingProvider
                                              .estimateShippingResponseModel
                                              .countryId
                                              .toString(),
                                      items: cartEstimateShippingProvider
                                          .countryDropDownList,
                                  ...
                                  cartEstimateShippingProvider
                                          .estimateShippingResponseModel.useCity
                                      ? Container(
                                          width: FlexoValues.controlsWidth,
                                          child: Row(
                                            mainAxisAlignment:
                                            ...
                                            children: [
                                              TextFieldWidget(
                                                ...
                                                hintText: localResourceProvider
                                                    .getResourseByKey(
                                                        "shipping.estimateShippingPopup.city"),
                                              ),
                                              Expanded(
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                              BoxDecoration(
                                                                            border:
                                                                                Border(bottom: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR), right: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR)),
                                                                          ),
                                                                          alignment:
                                                                              Alignment.centerLeft,
                                                                          width:
                                                                              FlexoValues.deviceWidth * 0.5,
                                                                          height:
                                                                              FlexoValues.deviceHeight * 0.06,
                                                                          child: FlexoTextWidget().headingBoldText16(
                                                                              text: localResourceProvider.getResourseByKey("shipping.estimateShippingPopup.shippingOption.name"),
                                                                              maxLines: 1),
                                                                        ),
                                                                        Container(
                                                                          padding:
                                                                          ...
                                                                          height:
                                                                              FlexoValues.deviceHeight * 0.06,
                                                                          child: FlexoTextWidget().headingBoldText16(
                                                                              text: localResourceProvider.getResourseByKey("shipping.estimateShippingPopup.shippingOption.estimatedDelivery"),
                                                                              maxLines: 1),
                                                                        ),
                                                                        Container(
                                                                          padding:
                                                                          ...
                                                                          alignment:
                                                                              Alignment.centerLeft,
                                                                          width:
                                                                              FlexoValues.deviceWidth * 0.35,
                                                                          height:
                                                                              FlexoValues.deviceHeight * 0.06,
                                                                          child: FlexoTextWidget().headingBoldText16(
                                                                              text: localResourceProvider.getResourseByKey("shipping.estimateShippingPopup.shippingOption.price"),
                                                                              maxLines: 1),
                                                                        ),
                                                                      ],
                                                                    ),
                                                                  ...
                                                                  Container(
                                                                    child:
                                                                        Column(
                                                                      children: cartEstimateShippingProvider
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(
                                                                                    border: Border(bottom: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR), right: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR)),
                                                                                  ),
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Container(
                                                                                          ...
                                                                                          child: Text(
                                                                                            ...
                                                                                            style: TextStyle(fontSize: FlexoValues.fontSize16, color: FlexoColorConstants.LIGHT_TEXT_COLOR, fontWeight: e.selected ? FontWeight.bold : FontWeight.normal),
                                                                                          )),
                                                                                    ],
                                                                                  ),
                                                                                ),
