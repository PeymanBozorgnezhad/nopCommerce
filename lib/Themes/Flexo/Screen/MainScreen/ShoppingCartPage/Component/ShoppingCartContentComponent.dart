...
import 'package:nopsuite/Screens/General/TopicBlockDetailsById/TopicBlockDetailsById.dart';
import 'package:nopsuite/Screens/Home/CartEstimateShipping/CartEstimateShipping.dart';
...
import 'package:nopsuite/Utils/Enum/TaxDisplayType.dart';
...
import 'package:nopsuite/Screens/Home/HomeProvider.dart';
...
import 'package:nopsuite/Utils/Enum/TopicType.dart';
...
class ShoppingCartContentComponent {
  ...
  radioListContainer(
      ...
      required CheckoutAttribute checkoutAttribute,
        ...
        children: checkoutAttribute.values.map((item) {
          return Container(
            margin: EdgeInsets.only(
                right: FlexoValues.widthSpace3Px,
                bottom: FlexoValues.widthSpace3Px),
            child: GestureDetector(
              ...
              child: ButtonWidget().getRatioButton(
                  text: item.priceAdjustment == null
                      ? item.name
                      : item.name + " [${item.priceAdjustment}]",
                  isCheck: item.isPreSelected),
            ),
          );
        }).toList(),
      ),
    ...
    return Container(
      ...
      child: Wrap(
        children: checkoutAttribute.values.map((item) {
          return Container(
            margin: EdgeInsets.only(
                right: FlexoValues.widthSpace4Px,
                bottom: FlexoValues.widthSpace3Px),
            child: Container(
              child: Row(
                ...
                children: [
                  Transform.scale(
                    ...
                    child: CupertinoSwitch(
                      onChanged: (val) {
                        if (checkoutAttribute.attributeControlType !=
                      ...
                      activeColor: checkoutAttribute.attributeControlType ==
                              AttributeControlType.ReadonlyCheckboxes
                          ? FlexoColorConstants.ACCENT_DE_ACTIVE_COLOR
                          : FlexoColorConstants.ACCENT_COLOR,
                    ),
                  ),
                  Flexible(
                    child: Container(
  ...
  customerAttributesSwitch(
      {required BuildContext context,
      required List<CheckoutAttribute> customerAttributes}) {
          ...
          children: customerAttributes.map((e) {
            ...
            switch (e.attributeControlType) {
              case AttributeControlType.DropdownList:
                ...
                if (!e.isRequired) {
                  List<Value> values =
                      e.values.where((element) => element.id == 0).toList();
                  if (values.isEmpty) {
                    e.values.insert(
                        0,
                        new Value(
                ...
                for (var item in e.values) {
                  dropdownList.add(new DropDownModel(
                      text:
                          '${item.priceAdjustment == null || item.priceAdjustment == "" ? item.name : item.name + " [${item.priceAdjustment}]"}',
                  ...
                  child: Container(
                    child: Column(
                      ...
                      children: [
                        attributeHeading(
                            heading:
                                e.textPrompt == null ? e.name : e.textPrompt,
                        ...
                        FlexoDropDown(
                            ...
                            onChange: (val) {
                              setState(() {
                                ...
                                homeProvider.attributeOnChanged(
                                    context: context);
                              });
                            }),
                        SizedBox(
              ...
              case AttributeControlType.RadioList:
                widget = Container(
                  child: Column(
                    ...
                    children: [
                      attributeHeading(
                          heading: e.textPrompt == null ? e.name : e.textPrompt,
                          isRequired: e.isRequired),
                      SizedBox(
                        height: FlexoValues.widthSpace2Px,
                      ),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                            color: FlexoColorConstants
                                                .BROWSE_BUTTON_BORDER_COLOR)),
                                    child: FlexoTextWidget().browseButtonText(
                                        text: StringConstants.BROWSE_BUTTON),
                                  ),
                                ),
                          ...
                          homeProvider.fileUploadMap[e.id] != null &&
                                  homeProvider.removeShow
                              ? Container(
                                  width: FlexoValues.deviceWidth * 0.3,
                                  padding:
                                      EdgeInsets.all(FlexoValues.widthSpace1Px),
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [
                                      Container(
                                        margin: EdgeInsets.symmetric(
                                            vertical:
                                                FlexoValues.widthSpace1Px),
                                        width: FlexoValues.deviceWidth * 0.3,
                                        child: GestureDetector(
                                          onTap: () async {
                                            homeProvider.downloadPDF(
                                                context: context);
                                          },
                                          child: Text(
                                            localResourceProvider.getResourseByKey(
                                                "common.fileUploader.downloadUploadedFile"),
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                      ...
                                      Container(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child:
                                              FlexoTextWidget().redirectText15(
                                            text: localResourceProvider
                                                .getResourseByKey(
                                                    "common.fileUploader.removeDownload"),
                                          ),
                                        ),
                                      ),
                                    ],
                        ...
                        child: Wrap(
                          ...
                          children: e.values.map((value) {
                            int colorCode = int.parse(
                                value.colorSquaresRgb.replaceAll("#", "0xff"));
                            ...
                            return GestureDetector(
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    margin: EdgeInsets.only(
                                        right: FlexoValues.widthSpace2Px,
                                        bottom: FlexoValues.widthSpace2Px),
                                    height:
                                        e.defaultValue == value.id.toString()
                                            ? FlexoValues.deviceWidth * 0.09
                                            : FlexoValues.deviceWidth * 0.08,
                                    width: e.defaultValue == value.id.toString()
                                        ? FlexoValues.deviceWidth * 0.09
                                        : FlexoValues.deviceWidth * 0.08,
                                    padding: EdgeInsets.all(
                                        FlexoValues.widthSpace1Px),
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                            ...
                                            width: FlexoValues.deviceWidth *
                                                0.005)),
                                    child: e.defaultValue == value.id.toString()
                                        ? Icon(
                                            Icons.check,
    ...
    return StatefulBuilder(
      builder: (BuildContext context, StateSetter setState) {
        ...
        return Container(
            child: Column(
          children: [
            homeProvider.estimateShippingResponseModel == null
                ? Container()
                : Container(
                    margin: EdgeInsets.symmetric(
                            ...
                            onClick: () {
                              Navigator.push(
                                      ...
                                      PageTransition(
                                          ...
                                          child: CartEstimateShippingPopup(
                                  ...
                                  .then((value) {
                                if (value != null) {
                                  /* homeProvider.updateEstimateData(
                                      context: context, requestModel: value); */
                                }
                              });
                            },
                            isApiLoad: false),
            ...
            customerAttributesSwitch(
                context: context,
                customerAttributes:
                    homeProvider.getCartModel.checkoutAttributes),
            SizedBox(
              height: FlexoValues.widthSpace2Px,
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  TextFieldWidget(
                    ...
                    showRequiredIcon: false,
                    required: true,
                    hintText: localResourceProvider.getResourseByKey(
                        "shoppingCart.DiscountCouponCode.tooltip"),
                    errorMsg: localResourceProvider.getResourseByKey(
                        "shoppingCart.discountCouponCode.empty"),
            ...
            homeProvider.discountCouponMsg == ""
                ? Container()
                : Container(
                    width: FlexoValues.deviceWidth,
                    padding: EdgeInsets.symmetric(
                        horizontal: FlexoValues.widthSpace2Px,
                        vertical: FlexoValues.widthSpace1Px),
                    alignment: Alignment.centerLeft,
                    child: Text(
                      homeProvider.discountCouponMsg.trim(),
                      style: TextStyle(
                          fontSize: FlexoValues.fontSize14,
                          color: homeProvider.isDiscountApplied
                              ? Colors.green
                              : Colors.red,
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            if (await CheckConnectivity()
                                .checkInternet(context)) {
                              homeProvider.removeDiscountCouponClickEvent(
                                  context: context,
                                  appliedDiscountsWithCode: e);
                            }
                          },
                          child: Container(
                            child: Icon(
              ...
              child: Row(
                ...
                children: [
                  TextFieldWidget(
                    ...
                    required: true,
                    hintText: localResourceProvider.getResourseByKey(
                        "shoppingCart.giftCardCouponCode.label"),
                    errorMsg: localResourceProvider.getResourseByKey(
                        "shoppingCart.discountCouponCode.empty"),
                  ...
                  GestureDetector(
                    onTap: () async {
                      if (await CheckConnectivity().checkInternet(context)) {
                        homeProvider.giftCardCouponCodeClickEvent(
                            context: context);
                      }
                    },
                    child: Container(
            ...
            homeProvider.giftCardCouponMsg == ""
                ? Container()
                : Container(
                    width: FlexoValues.deviceWidth,
                    padding: EdgeInsets.symmetric(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          fontSize: FlexoValues.fontSize14,
                          color: homeProvider.isGiftCardApplied
                              ? Colors.green
                              : Colors.red,
                          fontWeight: FontWeight.w500),
                    ),
            ...
            homeProvider.getCartModel.isEditable &&
                    homeProvider.getCartModel.items.length > 0 &&
                    homeProvider.getCartModel.displayTaxShippingInfo
                ? Container(
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: RichText(
                            ...
                            text: HTML.toTextSpan(
                                context,
                                homeProvider.taxTypeModel.currentTaxType ==
                                        TaxDisplayType.IncludingTax
                                    ? localResourceProvider.getResourseByKey(
                                        "wishlist.taxShipping.inclTax")
                                    : localResourceProvider.getResourseByKey(
                                        "wishlist.taxShipping.exclTax"),
                                defaultTextStyle:
                                    TextStyleWidget.contentTextStyle15,
                                overrideStyle: {
                              ...
                              setState(() {
                                Navigator.push(
                                    ...
                                    PageTransition(
                                        type: selectedTransition,
                                        child: TopicBlockDetailsById(
                                            name: "",
                                            seName: "ShippingInfo",
                                            topicId: 0,
                                            topicType: TopicType.SeName)));
                              });
                            }),
                          ),
                        ),
            ...
            Container(
              width: FlexoValues.deviceWidth,
              padding:
                  EdgeInsets.symmetric(vertical: FlexoValues.widthSpace2Px),
              alignment: Alignment.center,
              decoration: BoxDecoration(
                  border: Border(
                      bottom: BorderSide(
              ...
              child: FlexoTextWidget().headingBoldText16(
                  text: localResourceProvider
                      .getResourseByKey("shoppingCart.totals.subtotal")
                      .toString()
                      .toUpperCase(),
                  maxLines: 2),
            ),
              ...
              child: Column(
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: FlexoTextWidget().subTotalLeftText(
                              text: localResourceProvider.getResourseByKey(
                        ...
                        Container(
                          ...
                          child: FlexoTextWidget().subTotalRightText(
                              text: homeProvider
                                          .orderTotalResponseModel.subTotal ==
                                      null
                                  ? localResourceProvider.getResourseByKey(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: FlexoTextWidget().subTotalLeftText(
                                        text: localResourceProvider
                                                .getResourseByKey(
                                                    "shoppingCart.totals.subtotalDiscount") +
                                            ":",
                                        maxLines: 2),
                                  ),
                                  Container(
                  ...
                  homeProvider.orderTotalResponseModel
                      ...
                      : Container(),
                  homeProvider.orderTotalResponseModel.displayTaxRates &&
                          homeProvider.orderTotalResponseModel.taxRates.length >
                              0
                      ? Container(
                          child: Column(
                            children: [
                              Column(
                                  children: homeProvider
                                      .orderTotalResponseModel.taxRates
                                      .map((taxRate) {
                                return Container(
                                  child: Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: FlexoTextWidget().subTotalLeftText(
                                            text: localResourceProvider
                                                    .getResourseByKey(
                                                        "shoppingCart.totals.taxRateLine")
                                                    .toString()
                                                    .replaceAll(
                                                        "{0}", taxRate.rate) +
                                                ":",
                  ...
                  homeProvider.orderTotalResponseModel.displayTax
                      ...
                      : Container(),
                  homeProvider.orderTotalResponseModel.orderTotalDiscount !=
                          null
                      ? Container(
                          child: Column(
                            children: [
                          ...
                          child: Column(
                            children: [
                              Container(
                                child: Column(
                                  children: homeProvider
                                      .orderTotalResponseModel.giftCards
                                      .map((e) {
                                    return Container(
                                      child: Row(
                                        mainAxisAlignment:
                                                    ...
                                                    children: [
                                                      Container(
                                                        child: FlexoTextWidget().subTotalLeftText(
                                                            text: localResourceProvider
                                                                    .getResourseByKey(
                                                                        "shoppingCart.totals.giftCardInfo") +
                                                                ": " +
                                                                localResourceProvider
                                                                    .getResourseByKey(
                                                                        "shoppingCart.totals.giftCardInfo.code")
                                                                    .toString()
                                                                    .replaceAll(
                                                                        "{0}",
                                                                        e.couponCode),
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: FlexoTextWidget().subTotalLeftText(
                                          text: localResourceProvider
                                                  .getResourseByKey(
                                                      "shoppingCart.totals.rewardPoints")
                                                  .toString()
                                                  .replaceAll(
                                                      "{0}",
                                                      homeProvider
                  ...
                  Container(
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: FlexoValues.deviceWidth * 0.3,
                          child: FlexoTextWidget().subTotalLeftTextBold(
                              text: localResourceProvider.getResourseByKey(
                                      "shoppingCart.totals.orderTotal") +
                                  ":",
                              maxLines: 2),
                        ),
                        Container(
                          width: FlexoValues.deviceWidth * 0.6,
                          alignment: Alignment.centerRight,
                          child: FlexoTextWidget().subTotalRightTextBold(
                              text: homeProvider.orderTotalResponseModel
                                              .orderTotal ==
                                          null ||
                                      homeProvider.orderTotalResponseModel
                                              .orderTotal ==
                                  ...
                                  ? localResourceProvider.getResourseByKey(
                                      "shoppingCart.totals.calculatedDuringCheckout")
                                  : homeProvider
                                      .orderTotalResponseModel.orderTotal,
                              maxLines: 2),
                        ),
                      ],
                    ),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        localResourceProvider
                                            .getResourseByKey(
                                                "shoppingCart.totals.rewardPoints.willEarn.point")
                                            .toString()
                                            .replaceAll(
                                                "{0}",
                                                homeProvider
            ...
            homeProvider.getCartModel.isEditable
                ? homeProvider.getCartModel.minOrderSubtotalWarning != null
                    ? Container(
                        width: FlexoValues.deviceWidth,
                        margin: EdgeInsets.symmetric(
                            vertical: FlexoValues.widthSpace2Px),
                        alignment: Alignment.center,
                        child: FlexoTextWidget().warningMessageText(
                            text: homeProvider
                                .getCartModel.minOrderSubtotalWarning,
                            maxLines: 2),
                      )
                    : Container()
                : Container(),
            ...
            homeProvider.getCartModel.isEditable
                ? Container(
                    child: Column(
                      children: [
                        homeProvider
                                .getCartModel.termsOfServiceOnShoppingCartPage
                            ? Container(
                                margin: EdgeInsets.symmetric(
                                    ...
                                    Transform.scale(
                                      ...
                                      child: CupertinoSwitch(
                                        onChanged: (val) {
                                          setState(() {
                                            homeProvider
                                                .isStartCheckoutCheckbox = val;
                                          });
                                        },
                                        value: homeProvider
                                            .isStartCheckoutCheckbox,
                                        activeColor:
                                            FlexoColorConstants.ACCENT_COLOR,
                                      ),
                                    ),
                                                              ...
                                                              if (homeProvider
                                                                ...
                                                                Navigator.push(
                                                                    ...
                                                                    PageTransition(
                                                                        type:
                                                                            selectedTransition,
                                                                        child: TopicBlockDetails(
                                                                            topicTitle:
                                                                                homeProvider.topicTitle,
                                                                            topicBody: homeProvider.topicBody)));
                                                              }
                                                            });
                                                          })
                                              ]),
                        ...
                        homeProvider.getCartModel.minOrderSubtotalWarning ==
                                    null &&
                                !homeProvider.getCartModel.hideCheckoutButton
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                  child: FlexoTextWidget().buttonText(
                                                      text: localResourceProvider
                                                          .getResourseByKey(
                                                              "checkout.button")
                                                          .toString()
