              ...
              child: Column(
                children: homeProvider.getCartModel.items.map((e) {
                  ...
                  for (var item in e.allowedQuantities) {
                    setState(() {
                      dropDownQtyList.add(
                          new DropDownModel(text: item.text, value: item.text));
                    });
                  }
                  return Container(
                    decoration: BoxDecoration(
                        border: Border(
                            bottom: BorderSide(
                                color:
                                    FlexoColorConstants.PRODUCT_BORDER_COLOR))),
                    child: Container(
                      child: Column(
                        children: [
                          Row(
                              ...
                              children: [
                                ...
                                Container(
                                  width: homeProvider
                                          .getCartModel.showProductImages
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      homeProvider.getCartModel.showSku &&
                                              e.sku == null
                                          ? Container()
                                          : Column(
                                              children: [
                                      ...
                                      homeProvider.getCartModel
                                          ...
                                          ? Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  FlexoTextWidget().richTextContentText16(
                                                      text:
                                                          localResourceProvider
                                                                  .getResourseByKey(
                                                                      "ShoppingCart.VendorName") +
                                                              ": ",
                                                      subTextList: [
                                                        e.vendorName
                                                      ]),
                                      ...
                                      e.rentalInfo == "" || e.rentalInfo == null
                                          ? Container()
                                          : Container(
                                              child: Column(
                                              children: [
                                                                    ...
                                                                    onTap: () {
                                                                      setState(
                                                                        ...
                                                                        if (e.quantity >
                                                                          ...
                                                                          e.quantity =
                                                                              e.quantity - 1;
                                                                          homeProvider.updateCartClickEvent(
                                                                              context: context);
                                                                        }
                                                                      });
                                                                    },
