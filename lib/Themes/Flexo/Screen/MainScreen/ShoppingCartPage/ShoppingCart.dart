                  ...
                  : homeProvider.getCartModel != null &&
                      ...
                      ? Container(
                          ...
                          padding: EdgeInsets.symmetric(
                              ...
                              vertical: FlexoValues.verticalPadding),
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child:
                                      Image.asset(FlexoAssetsPath.EMPTY_CART),
                                ),
                                SizedBox(
                      ...
                      : Container(
                          child: Column(
                            children: [
                              homeProvider.isCartDataRefresh
                                  ? Loaders.apiLoader()
                                  : Container(),
                              localResourceProvider.isLocalDataLoad &&
                                      homeProvider.isCartLoader
                                  ...
                                  : Expanded(
                                      child: Container(
                                        child: SingleChildScrollView(
                                          controller:
                                              homeProvider.cartScrollController,
                                          child: Column(
                                            children: [
                                              localResourceProvider
                                                          .getSettingByName(
                                              ...
                                              ShoppingCartProductListComponent()
                                                  .getShoppingCartProductListComponent(
                                                      context: context),
                                              homeProvider.orderTotalResponseModel ==
                                                      null
                                                  ? Container()
                                                  : ShoppingCartContentComponent()
                                                      .getShoppingCartContentComponent(
                                                          context: context),
                                              homeProvider.crossSellProduct
                                                          .length >
                                                      0
                                                  ? ShoppingCartCrossSellProductComponent()
                                                      .getCrossSellProduct(
                                                          context: context)
                                                  : Container()
                                            ],
