...
class TopicBlockComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return getTopicBlockModel == null
        ? Container()
        : Container(
            child: Container(
              child: Column(
                ...
                children: [
                  ...
                  getTopicBlockModel.title == '' ||
                          getTopicBlockModel.title == null ||
                          getTopicBlockModel.title == "null"
                      ? Container()
                      : Column(
                          children: [
                            Container(
                              ...
                              child: FlexoTextWidget().headingBoldText17(
                                  text: getTopicBlockModel.title, maxLines: 5),
                            ),
                            Divider(
