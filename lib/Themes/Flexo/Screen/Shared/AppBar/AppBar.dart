            ...
            children: [
              ...
              Expanded(
                child: Container(
                    ...
                    child:
                        FlexoTextWidget().appbarText(text: title, maxLines: 1)),
              )
            ],
          ),
        ),
                  ...
                  child: Column(
                    children: [
                      localResourceProvider.getSettingByName(
                                  "catalogSettings.productSearchAutoCompleteEnabled") ==
                              "True"
                          ? Container(
                              width: FlexoValues.deviceWidth * 0.96,
                              height: FlexoValues.deviceHeight * 0.06,
                              margin: EdgeInsets.only(
                                  top: FlexoValues.heightSpace1Px,
                                  bottom: FlexoValues.heightSpace1Px,
                                ...
                                children: [
                                  TypeAheadField(
                                    ...
                                    /* noItemsFoundBuilder: (context) => Container(
                                      height: appBarProvider.matches.length == 0
                                          ? 0
                                    ...
                                    suggestionsCallback: (pattern) async {
                                      ...
                                      int searchLength = localResourceProvider
                                                  .getSettingByName(
                                                      "catalogSettings.productSearchTermMinimumLength") ==
                                              "catalogSettings.productSearchTermMinimumLength"
                                          ? 0
                                          : int.parse(localResourceProvider
                                              .getSettingByName(
                                                  "catalogSettings.productSearchTermMinimumLength"));
                                      if (pattern.length >= searchLength) {
                                        await appBarProvider
                                            .searchTermsOnChange(
                                                context: context,
                                                pattern: pattern);
                                    ...
                                    /* onSuggestionSelected:
                                        (GetSearchTermModel suggestion) {
                                      appBarProvider.searchText.text =
                                          suggestion.label;
                                    ...
                                    onSelected: (GetSearchTermModel value) {},
                                  ),
                                  GestureDetector(
                                    onTap: () {
