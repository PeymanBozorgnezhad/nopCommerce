...
class FlexoCreateOrUpdateAddressComponent extends StatefulWidget {
  ...
  FlexoCreateOrUpdateAddressComponent(
      {required this.addressModel, required this.apiLoaderFunction});

  @override
  State<FlexoCreateOrUpdateAddressComponent> createState() =>
      _FlexoCreateOrUpdateAddressComponentState();
}

class _FlexoCreateOrUpdateAddressComponentState
    extends State<FlexoCreateOrUpdateAddressComponent> {
  ...
  pageLoadData() {
    setState(() {
      ...
      for (var address in widget.addressModel.availableStates) {
        stateDropdownList
            .add(new DropDownModel(text: address.text, value: address.value));
      }
      widget.addressModel.stateProvinceId =
          int.parse(stateDropdownList[0].value);
      widget.addressModel.stateProvinceName = stateDropdownList[0].text;

      isAddressLoad = true;
      print(
          "Address ${widget.addressModel.firstName}, ${widget.addressModel.lastName}");
    });
  }
        ...
        children: [
          ...
          TextFieldAttributeWidgets(
            ...
            heading: localResourceProvider
                .getResourseByKey("address.fields.firstname"),
            hintText: localResourceProvider
                .getResourseByKey("address.fields.firstname"),
            errorMsg: localResourceProvider
                .getResourseByKey("address.fields.firstname.required"),
            required: true,
          ...
          TextFieldAttributeWidgets(
            ...
            keyBoardType: TextInputType.name,
            heading: localResourceProvider
                .getResourseByKey("address.fields.lastname"),
            hintText: localResourceProvider
                .getResourseByKey("address.fields.lastname"),
            errorMsg: localResourceProvider
                .getResourseByKey("address.fields.lastname.required"),
            required: true,
          ...
          TextFieldAttributeWidgets(
            ...
            keyBoardType: TextInputType.name,
            heading:
                localResourceProvider.getResourseByKey("address.fields.email"),
            hintText:
                localResourceProvider.getResourseByKey("address.fields.email"),
            errorMsg: localResourceProvider
                .getResourseByKey("address.fields.email.required"),
            errorMsgForEmail:
                localResourceProvider.getResourseByKey("common.wrongEmail"),
            required: true,
                  ...
                  children: [
                    FlexoDropDown(
                        ...
                        onChange: (val) {
                          ...
                          widget.addressModel.countryName = widget
                              .addressModel.availableCountries
                              .where((element) => element.value == val)
                              .first
                              .text;
                          statesByCountryId(
                              context: context,
                              countryId: widget.addressModel.countryId);
                        }),
                    SizedBox(height: FlexoValues.heightSpace2Px),
                  ],
                )
          ...
          widget.addressModel.countryEnabled &&
                  widget.addressModel.stateProvinceEnabled
              ? Column(
                  children: [
                    FlexoDropDown(
                        width: FlexoValues.controlsWidth,
                        selectedValue:
                            widget.addressModel.stateProvinceId.toString(),
                        items: stateDropdownList,
                        onChange: (val) {
                          widget.addressModel.stateProvinceId = int.parse(val);
                          widget.addressModel.stateProvinceName =
                              stateDropdownList
                                  .where((element) => element.value == val)
                                  .first
                                  .text;
          ...
          CheckoutAddressAttributes(
              customAddressAttributes:
                  widget.addressModel.customAddressAttributes),
        ],
      ),
    );
  }
