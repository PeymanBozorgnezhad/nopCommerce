                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          productBoxModel
                                  .productPrice.disableAddToCompareListButton
                              ? Container()
                              : Column(
                                  children: [
                                    GestureDetector(
              ...
              GestureDetector(
                ...
                child: Container(
                    ...
                    child: FlexoTextWidget().productBoxText(
                        text: productBoxModel.name, maxLines: 1)),
              ),
              SizedBox(
              ...
              productBoxModel.productPrice.price == null
                  ...
                  : Container(
                      ...
                      child: FlexoTextWidget().productPriceText(
                          text: productBoxModel.productPrice.price,
                          maxLines: 1),
                    ),
              SizedBox(
                height: FlexoValues.widthSpace1Px,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: FlexoTextWidget()
                  .productBoxText(text: productBoxModel.name, maxLines: 1),
            ),
          ),
          SizedBox(
            height: FlexoValues.heightSpace1Px,
