...
import 'package:nopsuite/Screens/General/ContactUs/ContactUsProvider.dart';
...
import 'package:nopsuite/Themes/Flexo/Screen/Shared/TopicBlock/TopicBlockComponent.dart';
      ...
      child: Scaffold(
        appBar: FlexoAppBarWidget().appbar(
            ...
            title: localResourceProvider.isLocalDataLoad
                ? ""
                : localResourceProvider.getResourseByKey("pageTitle.contactus"),
            backButton: true),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: contactUsProvider.headerModel,
            headerLoader: contactUsProvider.isPageLoader),
        body: contactUsProvider.isPageLoader ||
                localResourceProvider.isLocalDataLoad
            ? Loaders.pageLoader()
            : Column(
                children: [
                  contactUsProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                            ...
                            children: [
                              Container(
                                ...
                                child: FlexoTextWidget().contentText16(
                                  text: contactUsProvider
                                      .getContactUsModel.result,
                                ),
                              ),
                            ],
                          ),
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  TopicBlockComponent(
                                      getTopicBlockModel:
                                          contactUsProvider.getTopicBlockModel),
                                  Form(
                                    key: form,
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          contactUsProvider.getContactUsModel
                                                  .subjectEnabled
                                              ? Container(
                                                  width:
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      TextFieldWidget(
                                                        ...
                                                        hintText: localResourceProvider
                                                            .getResourseByKey(
                                                                "contactus.subject.hint"),
                                                        required: true,
                                                        errorMsg: localResourceProvider
                                                            .getResourseByKey(
                                                                "contactus.subject.required"),
                                                      ),
                                                      SizedBox(
                                                        height: FlexoValues
                                                            .heightSpace2Px,
