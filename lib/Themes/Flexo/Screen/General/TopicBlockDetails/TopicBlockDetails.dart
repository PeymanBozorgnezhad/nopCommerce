...
import 'package:nopsuite/Screens/General/TopicBlockDetails/TopicBlockDetailsProvider.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: FlexoAppBarWidget().appbar(
            context: context,
            title: topicBlockDetailsProvider.isPageLoader
                ? ""
                : topicBlockDetailsProvider.topicTitle,
            backButton: true),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: topicBlockDetailsProvider.headerModel,
            headerLoader: topicBlockDetailsProvider.isPageLoader),
        body: topicBlockDetailsProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  topicBlockDetailsProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                          ...
                          builder: (context, setState) {
                            return Column(
                              children: [
                                ...
                                topicBlockDetailsProvider.topicTitle != null
                                    ? Container(
                                        ...
                                        child: FlexoTextWidget()
                                            .headingBoldText17(
                                                text: topicBlockDetailsProvider
                                                    .topicTitle,
                                                maxLines: 3),
                                      )
                                    : Container(),
