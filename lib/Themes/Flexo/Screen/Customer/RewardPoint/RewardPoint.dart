    ...
    return GestureDetector(
      ...
      child: Scaffold(
            ...
            title: localResourceProvider.isLocalDataLoad
                ...
                : localResourceProvider.getResourseByKey("account.myAccount") +
                    ...
                    localResourceProvider
                        .getResourseByKey("account.rewardPoints")),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: rewardPointProvider.headerModel,
            headerLoader: rewardPointProvider.isAPILoader),
        body: rewardPointProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  rewardPointProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                      child: LazyLoadScrollView(
                        ...
                        onEndOfPage: () {
                          rewardPointProvider.loadMoreRewardsPoints(
                            context: context,
                          );
                        },
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: RewardPointComponent()
                                    .getRewardPointComponent(context: context),
                              ),
                              rewardPointProvider.isLazyLoader
                                  ? Loaders.lazyLoader()
                                  : Container()
                            ],
                          ),
