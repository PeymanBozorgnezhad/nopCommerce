...
import 'package:nopsuite/Models/AddressAttributeModel.dart';
...
import 'package:nopsuite/Utils/Enum/FormType.dart';
...
class FlexoCreateOrUpdateAddress extends StatefulWidget {
  ...
  @override
  State<FlexoCreateOrUpdateAddress> createState() =>
      _FlexoCreateOrUpdateAddressState();
}

class _FlexoCreateOrUpdateAddressState
    extends State<FlexoCreateOrUpdateAddress> {
  GlobalKey<FormState> formKey = new GlobalKey<FormState>();

  @override
  Widget build(BuildContext context) {
    var createOrUpdateAddressProvider =
        context.watch<CreateOrUpdateAddressProvider>();
      ...
      child: Scaffold(
        ...
        appBar: FlexoAppBarWidget().appbar(
            ...
            title: localResourceProvider.isLocalDataLoad
                ? ""
                : createOrUpdateAddressProvider.formType == FormType.Create
                    ? localResourceProvider
                            .getResourseByKey("account.myAccount") +
                        " - " +
                        localResourceProvider.getResourseByKey(
                            "account.customerAddresses.addNew")
                    : localResourceProvider
                            .getResourseByKey("account.myAccount") +
                        " - " +
                        localResourceProvider.getResourseByKey(
                            "account.customerAddresses.edit")),
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            context: context,
            tabIndexType: BottomNavigationIndexType.Other,
            headerData: createOrUpdateAddressProvider.headerModel,
            headerLoader: createOrUpdateAddressProvider.isPageLoader),
        body: createOrUpdateAddressProvider.isPageLoader ||
                localResourceProvider.isLocalDataLoad
            ? Loaders.pageLoader()
            : Column(
                children: [
                  createOrUpdateAddressProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFieldWidget(
                                    ...
                                    controller: createOrUpdateAddressProvider
                                        .firstNameController,
                                    hintText:
                                        localResourceProvider.getResourseByKey(
                                  ...
                                  TextFieldWidget(
                                    ...
                                    errorMsgForEmail: localResourceProvider
                                        .getResourseByKey("common.wrongEmail"),
                                    icon: Ionicons.mail_outline,
                                  ),
                                  SizedBox(height: FlexoValues.heightSpace2Px),
                                  createOrUpdateAddressProvider
                                          .addressModel.companyEnabled
                                      ? Column(
                                          children: [
                                            TextFieldWidget(
                                              width: FlexoValues.controlsWidth,
                                                      ...
                                                      setState(() {
                                                        ...
                                                        createOrUpdateAddressProvider
                                                            .getStateDataByCountryId(
                                                                context:
                                                                    context,
                                                                countryId: createOrUpdateAddressProvider
                                                                    .addressModel
                                                                    .countryId);
                                                      });
                                                    },
                                  ...
                                  createOrUpdateAddressProvider
                                              .addressModel.countryEnabled &&
                                          createOrUpdateAddressProvider
                                              .addressModel.stateProvinceEnabled
                                      ? Column(
                                          children: [
                                            Container(
                                              width: FlexoValues.deviceWidth,
                                  ...
                                  createOrUpdateAddressProvider
                                          .addressModel.streetAddressEnabled
                                      ? Column(
                                          children: [
                                            TextFieldWidget(
                                              width: FlexoValues.controlsWidth,
                                  ...
                                  createOrUpdateAddressProvider
                                          .addressModel.streetAddress2Enabled
                                      ? Column(
                                          children: [
                                            TextFieldWidget(
                                              width: FlexoValues.controlsWidth,
                                  ...
                                  createOrUpdateAddressProvider
                                          .addressModel.zipPostalCodeEnabled
                                      ? Column(
                                          children: [
                                            TextFieldWidget(
                                              width: FlexoValues.controlsWidth,
  ...
  radioListContainer(
      {required AddressAttribute e, required StateSetter setState}) {
  ...
  customerAttributesSwitch(
      {required BuildContext context,
      required StateSetter setState,
      required List<AddressAttribute> customerAttributes}) {
    return Container(
      width: FlexoValues.controlsWidth,
      child: Column(
