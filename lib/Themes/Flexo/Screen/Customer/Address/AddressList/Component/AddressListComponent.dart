...
import 'package:nopsuite/Screens/Customer/Address/AddressList/AddressListProvider.dart';
import 'package:nopsuite/Screens/Customer/Address/CreateOrUpdateAddress/CreateOrUpdateAddress.dart';
        ...
        child: Column(
          ...
          children: [
            addressListProvider.getAddressesModel.addresses.length > 0
                ? Container(
                    child: Column(
                      children: addressListProvider.getAddressesModel.addresses
                          .map((e) {
                        String addressLine = "";
            ...
            ButtonWidget().getButton(
                text: localResourceProvider
                    .getResourseByKey("common.addNew")
                    .toString()
                    .toUpperCase(),
