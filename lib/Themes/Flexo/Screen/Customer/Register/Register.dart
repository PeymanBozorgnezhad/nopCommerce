...
import 'package:nopsuite/Themes/Flexo/Widgets/TextFormWidgets/TextFieldConfirmPasswordWidget.dart';
...
import 'package:nopsuite/Screens/Customer/Register/RegisterProvider.dart';
...
import 'package:nopsuite/Themes/Flexo/Widgets/FormErrorsWidget.dart';
...
class _FlexoRegisterState extends State<FlexoRegister> {
  ...
  Widget build(BuildContext context) {
    ...
    String alreadyHaveAccount = localResourceProvider
        .getResourseByKey(
            "nopAdvance.plugin.publicApi.defaultClean.alreadyHaveAccount")
        .toString();
          ...
          appBar: FlexoAppBarWidget().appbar(
              ...
              title: localResourceProvider.isLocalDataLoad
                  ...
                  : localResourceProvider
                      .getResourseByKey("PageTitle.Register"),
              backButton: true),
          backgroundColor: FlexoColorConstants.BACKGROUND_COLOR,
          body: registerProvider.isPageLoader
              ? Loaders.pageLoader()
              : StatefulBuilder(builder: (context, setState) {
                  return Container(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          registerProvider.isAPILoader
                              ? Container(
                                  child: LinearProgressIndicator(
                                    color:
                                        FlexoColorConstants.LINEAR_LOADER_COLOR,
                                  ),
                                )
                              : Container(),
                          Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        SizedBox(
                                          ...
                                          child: FormErrorWidget(
                                              errors: registerProvider.errors),
                                        ),
                                        SizedBox(
                                    ...
                                    Container(
                                      ...
                                      child:
                                          FlexoTextWidget().headingBoldText15(
                                    ...
                                    registerProvider.getRegisterResponseModel
                                            .genderEnabled
                                        ? Container(
                                            child: Column(
                                              children: [
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                            width: FlexoValues.deviceWidth *
                                                                                0.25,
                                                                            padding: EdgeInsets.all(FlexoValues
                                                                                .widthSpace2Px),
                                                                            alignment: Alignment
                                                                                .center,
                                                                            decoration:
                                                                              ...
                                                                              border: Border.all(color: e.code == registerProvider.getRegisterResponseModel.gender ? FlexoColorConstants.ACCENT_COLOR : FlexoColorConstants.THEME_COLOR, width: 1),
                                                                            ),
                                                                            child:
                                                                                Text(
                                                                              e.name,
                                                                              ...
                                                                              style: TextStyle(color: e.code == registerProvider.getRegisterResponseModel.gender ? Colors.white : FlexoColorConstants.ACCENT_COLOR, fontSize: FlexoValues.fontSize15, fontWeight: FontWeight.normal),
                                                                            ))
                                                                      ],
                                                                    ),
                                                                  ),
                                        ...
                                        ? Column(
                                            children: [
                                              FlexoDatePickerPlugin(
                                                ...
                                                errorMsg: localResourceProvider
                                                    .getResourseByKey(
                                                        "account.fields.dateOfBirth.required"),
                                                hintText: localResourceProvider
                                                    .getResourseByKey(
                                    ...
                                    TextFieldWidget(
                                      ...
                                      errorMsgForEmail: localResourceProvider
                                          .getResourseByKey(
                                              "common.wrongEmail"),
                                    ),
                                    SizedBox(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    FocusManager
                                                                        ...
                                                                        .primaryFocus
                                                                        ?.unfocus();
                                                                    registerProvider.checkUserNameAvailability(
                                                                        context:
                                                                            context);
                                                                  },
                                                                  child: Text(
                                                                    localResourceProvider
                                                                        .getResourseByKey(
                                                                            "account.checkUsernameAvailability.button"),
                                                                    style: TextStyle(
                                                                        fontSize:
                                                                            FlexoValues
                                                                                .fontSize16,
                                                            ...
                                                            onChange: (value) {
                                                              setState(() {
                                                                registerProvider
                                                                    ...
                                                                    int.parse(
                                                                        value);
                                                                registerProvider.getStateDataByCountryId(
                                                                    context:
                                                                        context,
                                                                    countryId: registerProvider
                                                                        .getRegisterResponseModel
                                                                        .countryId);
                                                              });
                                                            },
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          registerProvider
                                                                              .getRegisterResponseModel
                                                                              .newsletter = !registerProvider.getRegisterResponseModel.newsletter;
                                                                        });
                                                                      },
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      FlexoDropDown(
                                                                          ...
                                                                          onChange:
                                                                            ...
                                                                            e.defaultValue =
                                                                                value.toString();
                                                                            List<CustomerAttributeValueModel>
                                                                                values =
                                                                                e.values.where((element) => element.name == value).toList();
                                        ...
                                        ? Column(
                                            children: [
                                              ...
                                              FlexoDropDown(
                                                width: FlexoValues
                                                    .loginControlsWidth,
                                                selectedValue: registerProvider
                                                    .getRegisterResponseModel
                                                    .timeZoneId,
                                                items: registerProvider
                                                    .getRegisterResponseModel
                                    ...
                                    TextFieldConfirmPasswordWidget(
                                      ...
                                      errorMsgConfirmPassword:
                                          localResourceProvider.getResourseByKey(
                                              "account.fields.password.enteredPasswordsDoNotMatch"),
                                      icon: Ionicons.lock_open_outline,
                                    ),
                                    SizedBox(
                                      height: FlexoValues.heightSpace2Px,
                                    ...
                                    registerProvider.getRegisterResponseModel
                                        ...
                                        ? Container(
                                            width:
                                                FlexoValues.loginControlsWidth,
                                            child: Column(
                                              mainAxisAlignment:
                                                                  ...
                                                                  text: TextSpan(
                                                                      ...
                                                                      style: TextStyle(
                                                                          color: FlexoColorConstants
                                                                              .LIGHT_TEXT_COLOR,
                                                                          fontSize:
                                                                              FlexoValues.fontSize16),
                                                                      children: <TextSpan>[
                                                                        TextSpan(
                                                                            text:
                                                                                localResourceProvider.getResourseByKey("checkout.termsOfService.read"),
                                                                            style: TextStyleWidget.redirectTextStyle16,
                                                                            recognizer: TapGestureRecognizer()
                                                                              ..onTap = () {
                                                                                setState(() {
                                                                                  if (registerProvider.getRegisterResponseModel.acceptPrivacyPolicyPopup) {
                                                                                    DialogBoxWidget().informationDialogBox(context: context, title: registerProvider.getTopicBlockModel.title, body: registerProvider.getTopicBlockModel.body, heading: localResourceProvider.getResourseByKey("account.fields.acceptPrivacyPolicy"));
                                                                                  } else {
                                        ...
                                        : Container(),
                                    SizedBox(
                                      height: FlexoValues.widthSpace4Px,
                                    ),
                                    ...
                                    SizedBox(
                                      height: FlexoValues.heightSpace4Px,
                                    )
                                  ],
                                ),
                              ),
