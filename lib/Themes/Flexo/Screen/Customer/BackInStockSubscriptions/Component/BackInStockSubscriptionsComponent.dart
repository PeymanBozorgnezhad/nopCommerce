...
import 'package:nopsuite/Screens/Customer/BackInStockSubscriptions/BackInStockSubscriptionsProvider.dart';
  ...
  getBackInSubscriptionComponent({required BuildContext context}) {
    return StatefulBuilder(
      builder: (BuildContext context, StateSetter setState) {
        ...
        var backInStockSubscriptionsProvider =
            context.watch<BackInStockSubscriptionsProvider>();
        return Container(
          child: Column(
            children: [
                  ...
                  children: [
                            ...
                            children: [
                              Container(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      backInStockSubscriptionsProvider.isAll =
                                          !backInStockSubscriptionsProvider
                                              .isAll;
                                      for (var i in backInStockSubscriptionsProvider
                                          .getCustomerSubscriptionsResponseModel
                                          .subscriptions) {
                                        if (backInStockSubscriptionsProvider
                                            .isAll) {
                                          backInStockSubscriptionsProvider
                                              .productList[i.id] = true;
                                          backInStockSubscriptionsProvider
                                              .removeList
                                              .add(i.id);
                                        } else if (backInStockSubscriptionsProvider
                                                .isAll ==
                                            false) {
                                          backInStockSubscriptionsProvider
                                              .productList[i.id] = false;
                                          backInStockSubscriptionsProvider
                                              .removeList
                                              .remove(i.id);
                                        }
                              ...
                              Container(
                                  ...
                                  child: FlexoTextWidget().headingBoldText16(
                                      text: localResourceProvider.getResourseByKey(
                                          'account.backInStockSubscriptions.productColumn'),
                                      maxLines: 1)),
                            ],
                          ),
                        ],
                    ...
                    Container(
                      ...
                      child: Table(
                        ...
                        defaultVerticalAlignment:
                            TableCellVerticalAlignment.middle,
                        children: backInStockSubscriptionsProvider
                            .getCustomerSubscriptionsResponseModel.subscriptions
                            .map((e) {
                          if (backInStockSubscriptionsProvider
                                  .productList[e.id] ==
                              null) {
                            backInStockSubscriptionsProvider.productList[e.id] =
                                false;
                          }
                          return TableRow(
                            children: [
              ...
              ButtonWidget().getButton(
                  ...
                  onClick: () async {
                    if (await CheckConnectivity().checkInternet(context)) {
                      backInStockSubscriptionsProvider.deleteButtonClickEvent(
                          context: context,
                          removePid:
                              backInStockSubscriptionsProvider.removeList);
                    }
                  },
                  isApiLoad: false),
            ],
