            ...
            title: localResourceProvider.isLocalDataLoad
                ...
                : localResourceProvider.getResourseByKey("account.myAccount") +
                    ...
                    localResourceProvider.getResourseByKey(
                        "pageTitle.backInStockSubscriptions")),
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            context: context,
            tabIndexType: BottomNavigationIndexType.Other,
            headerData: backInStockSubscriptionsProvider.headerModel,
            headerLoader: backInStockSubscriptionsProvider.isPageLoader),
        body: backInStockSubscriptionsProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  backInStockSubscriptionsProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: backInStockSubscriptionsProvider
                                  ...
                                  : BackInSubscriptionComponent()
                                      .getBackInSubscriptionComponent(
                                          context: context),
                            ),
                          ],
                        ),
