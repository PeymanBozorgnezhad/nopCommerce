...
import 'package:nopsuite/Screens/Customer/ForgotPassword/ForgotPasswordProvider.dart';
      ...
      appBar: FlexoAppBarWidget().appbar(
          ...
          title: localResourceProvider.isLocalDataLoad
              ...
              : localResourceProvider
                  .getResourseByKey("account.passwordRecovery")),
      backgroundColor: FlexoColorConstants.BACKGROUND_COLOR,
      body: forgotPasswordProvider.isPageLoader
          ? Loaders.pageLoader()
          : Column(
              children: [
                forgotPasswordProvider.isAPILoader
                    ? Loaders.apiLoader()
                    : Container(),
                Expanded(
                  child: Container(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: FormErrorWidget(
                                        errors: forgotPasswordProvider.errors),
                                  ),
                                  SizedBox(
                                  ...
                                  TextFieldWidget(
                                    width: FlexoValues.loginControlsWidth,
                                    controller:
                                        ForgotPasswordProvider.emailAddress,
                                    errorMsg:
