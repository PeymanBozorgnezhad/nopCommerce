...
import 'package:nopsuite/Screens/Customer/GiftCardBalance/GiftCardBalanceProvider.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: giftCardBalanceProvider.headerModel,
            headerLoader: giftCardBalanceProvider.isAPILoader),
        body: giftCardBalanceProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  giftCardBalanceProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                              ...
                              Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFieldWidget(
                                      width: FlexoValues.controlsWidth,
                                      controller: giftCardBalanceProvider
                                          .giftCodeController,
                                      errorMsg: localResourceProvider
                                          .getResourseByKey(
                                              "checkGiftCardBalance.giftCardCouponCode.empty"),
                                      required: true,
                                    ...
                                    ButtonWidget().getButton(
                                        text: localResourceProvider
                                            .getResourseByKey(
                                                "checkGiftCard.giftCardCouponCode.button")
                                            .toString()
                                            .toUpperCase(),
                                        width: FlexoValues.controlsWidth,
                                        onClick: () async {
                                        ...
                                        isApiLoad: giftCardBalanceProvider
                                            .isAPILoader),
                                  ],
                                ),
                              )
