                ...
                children: [
                          ...
                          Container(
                              ...
                              child: Text.rich(
                                TextSpan(
                                    text: '${e.title}',
                                    style:
                                        TextStyleWidget.headingBoldTextStyle16,
                                    children: [
                                      TextSpan(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        FlexoTextWidget()
                            .contentText16(text: e.reviewText, maxLines: 5),
                        SizedBox(
                          height: FlexoValues.widthSpace2Px,
                        ),
                        e.additionalProductReviewList.isNotEmpty
                            ? Container(
                                ...
                                child: Column(
                                  children:
                                      e.additionalProductReviewList.map((p) {
                                    return Container(
                          ...
                          child: RichText(
                            text: new TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text:
                                        " | ${localResourceProvider.getResourseByKey("reviews.date")}: ${e.writtenOnStr}",
                                ...
                                children: [
                                  Container(
                                      ...
                                      child: Text(
                                        ...
                                        overflow: TextOverflow.ellipsis,
                                        style:
                                            TextStyleWidget.headingTextStyle16,
                                      )),
                                  SizedBox(
                                    height: FlexoValues.heightSpace1Px,
                                  ),
