...
class FlexoCustomerProductReview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var customerProductReviewProvider =
        context.watch<CustomerProductReviewProvider>();
    ...
    return Scaffold(
          ...
          title: localResourceProvider.isLocalDataLoad
              ...
              : localResourceProvider.getResourseByKey("account.myAccount") +
                  ...
                  localResourceProvider
                      .getResourseByKey("pageTitle.customerProductReviews")),
      ...
      bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
          ...
          headerData: customerProductReviewProvider.headerModel,
          headerLoader: customerProductReviewProvider.isAPILoader),
      body: customerProductReviewProvider.isPageLoader
          ? Loaders.pageLoader()
          : Column(
              children: [
                customerProductReviewProvider.isAPILoader
                    ? Loaders.apiLoader()
                    : Container(),
                customerProductReviewProvider
                        .getCustomerProductReviewsModel.productReviews.isEmpty
                    ? Container(
                        ...
                        child: FlexoTextWidget().headingText17(
                            text: localResourceProvider.getResourseByKey(
                                "account.customerProductReviews.noRecords")))
                    : Expanded(
                        child: Container(
                          child: LazyLoadScrollView(
                            isLoading:
                                customerProductReviewProvider.isLazyLoader,
                            onEndOfPage: () {
                              customerProductReviewProvider.loadMoreProducts(
                                  context: context);
                            },
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    child: CustomerProductReviewComponent()
                                        .getCustomerProductReviewComponent(
                                            context: context),
                                  ),
                                  customerProductReviewProvider.isLazyLoader
                                      ? Loaders.lazyLoader()
