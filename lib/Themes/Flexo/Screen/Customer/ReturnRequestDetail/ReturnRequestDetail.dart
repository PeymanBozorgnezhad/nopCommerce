    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: FlexoAppBarWidget().appbar(
            context: context,
            backButton: true,
            title: returnRequestDetailProvider.isPageLoader
                ? ""
                : localResourceProvider
                    .getResourseByKey("returnRequests.title")
                    .toString()
                    .replaceAll("<a href=\"{0}\">", "")
                    .replaceAll(
                        "{1}",
                        returnRequestDetailProvider
                            .getReturnRequestModel.customOrderNumber)
                    .replaceAll("</a>", "")),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: returnRequestDetailProvider.headerModel,
            headerLoader: returnRequestDetailProvider.isAPILoader),
        body: returnRequestDetailProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  returnRequestDetailProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                          ...
                          children: [
                            returnRequestDetailProvider
                                ...
                                : Container(
                                    child: Column(
                                      children: [
                                        ReturnRequestProductListComponent()
                                            .getReturnRequestProductListComponent(
                                                context: context),
                                        ReturnRequestCommentComponent()
                                            .getReturnRequestCommentComponent(
                                                context: context),
                                      ],
                                    ),
                                  )
