...
class ReturnRequestCommentComponent {
  getReturnRequestCommentComponent({required BuildContext context}) {
    ...
    var returnRequestDetailProvider =
        context.watch<ReturnRequestDetailProvider>();
            ...
            children: [
              ...
              Container(
                ...
                child: FlexoTextWidget().headingBoldText15(
                    text: localResourceProvider
                        .getResourseByKey("returnRequests.whyReturning")),
              ),
              SizedBox(
                height: FlexoValues.widthSpace2Px,
              ),
              Container(
                  ...
                  child: FlexoTextWidget().contentText15(
                    text: localResourceProvider
                        .getResourseByKey("returnRequests.returnReason"),
                  )),
              SizedBox(height: FlexoValues.widthSpace1Px),
              FlexoDropDown(
                  width: FlexoValues.controlsWidth,
                  showRequiredIcon: false,
                  selectedValue: returnRequestDetailProvider.selectedReason,
                  items: returnRequestDetailProvider.reasonDropdown,
                  onChange: returnRequestDetailProvider.reasonChange),
              SizedBox(
                height: FlexoValues.widthSpace2Px,
              ),
              Container(
                  ...
                  child: FlexoTextWidget().contentText15(
                    text: localResourceProvider
                        .getResourseByKey("returnRequests.returnAction"),
                  )),
              SizedBox(height: FlexoValues.widthSpace1Px),
              FlexoDropDown(
                  width: FlexoValues.controlsWidth,
                  showRequiredIcon: false,
                  selectedValue: returnRequestDetailProvider.selectedAction,
                  items: returnRequestDetailProvider.actionDropdown,
                  onChange: returnRequestDetailProvider.actionChange),
              SizedBox(
                height: FlexoValues.widthSpace2Px,
              ),
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () async {
                                    returnRequestDetailProvider
                                        .openFileExplorer(context: context);
                                  },
                                  child: Container(
                                ...
                                returnRequestDetailProvider.base64 == ""
                                    ? Container(
                                        child: FlexoTextWidget().contentText14(
                                        text: StringConstants.NO_FILE_SELECTED,
                                      ))
                                    : Container(
              ...
              Container(
                  ...
                  child: FlexoTextWidget().contentText15(
                      text: localResourceProvider
                          .getResourseByKey("returnRequests.comments"))),
              SizedBox(height: FlexoValues.widthSpace1Px),
              TextFieldWidget(
                width: FlexoValues.controlsWidth,
                showRequiredIcon: false,
              ...
              ButtonWidget().getButton(
                  text: localResourceProvider
                      .getResourseByKey("returnRequests.submit")
                      .toString()
                      .toUpperCase(),
                  width: FlexoValues.controlsWidth,
                  onClick: () async {
                    if (await CheckConnectivity().checkInternet(context)) {
                      ...
                      returnRequestDetailProvider.updateButtonClickEvent(
                          context: context,
                          orderId: returnRequestDetailProvider
                              .getReturnRequestModel.orderId);
                    }
                  },
                  isApiLoad: false),
              SizedBox(height: FlexoValues.widthSpace3Px),
