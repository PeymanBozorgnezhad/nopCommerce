      ...
      builder: (BuildContext context, StateSetter setState) {
        return Column(
          children: [
            Container(
              child: Column(
                children: returnRequestDetailProvider
                    .getReturnRequestModel.items
                    .map((e) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                Navigator.push(
                                        ...
                                        PageTransition(
                                            ...
                                            child: ProductDetails(
                                                ...
                                                isCart: false)))
                                    .then((value) {
                                  returnRequestDetailProvider.getHeaderData(
                                      context: context);
                                });
                              },
                            ...
                            children: [
                              Container(
                                ...
                                text: localResourceProvider.getResourseByKey(
                                        "returnRequests.products.quantity") +
                                    ": ",
                              )),
                              Container(
                                child: FlexoCustomDropDown(
                                  ...
                                  selectedValue: returnRequestDetailProvider
                                      .qnt[e.id]
                                      .toString(),
                                  items: returnRequestDetailProvider
                                      .quantity[e.id]!
                                      .map((p) {
                                    return DropDownModel(
                                        text: "$p", value: p.toString());
                                  }).toList(),
                                  onChange: (value) {
                                    setState(() {
                                      returnRequestDetailProvider.qnt[e.id] =
                                          int.parse(value);
                                    });
                                  },
                                ),
                        ...
                        e.attributeInfo == "" || e.attributeInfo == null
                            ? Container()
                            : Container(
