...
class OrderShipmateDetailsComponent {
  getOrderShipmateDetails({required BuildContext context}) {
    ...
    var orderShipmateDetailProvider =
        context.watch<OrderShipmateDetailProvider>();
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: FlexoTextWidget().headingBoldText16(
                            text:
                                "${localResourceProvider.getResourseByKey("order.order#")}${orderShipmateDetailProvider.getShipmentDetailsModel.order.customOrderNumber}",
                            maxLines: 2)),
                    SizedBox(
                      height: FlexoValues.heightSpace1Px,
                    ),
                    Container(
                        ...
                        child: FlexoTextWidget().contentText16(
                            text:
                                "${localResourceProvider.getResourseByKey("order.shipments.shippingMethod")}: ${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingMethod}",
                            maxLines: 2)),
                    Container(
                        width: FlexoValues.controlsWidth,
                        child: FlexoTextWidget().contentText16(
                    ...
                    Container(
                        ...
                        child: FlexoTextWidget().contentText16(
                            ...
                            maxLines: 2)),
                    orderShipmateDetailProvider
                                .getShipmentDetailsModel.trackingNumber !=
                            null
                        ? Container(
                            width: FlexoValues.controlsWidth,
                            child: FlexoTextWidget().contentText16(
                                text:
                                    "${localResourceProvider.getResourseByKey("order.shipments.trackingNumber")}: ${orderShipmateDetailProvider.getShipmentDetailsModel.trackingNumber}",
                                maxLines: 2))
                        : Container(),
                    SizedBox(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    !orderShipmateDetailProvider
                            .getShipmentDetailsModel.order.pickupInStore
                        ? Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      color:
                                          FlexoColorConstants.LIGHT_TEXT_COLOR),
                                ),
                              ),
                              SizedBox(
                                height: FlexoValues.widthSpace2Px,
                              ...
                              Container(
                                  child: FlexoTextWidget().contentText16(
                                      text:
                                          '${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.firstName} ${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.lastName}',
                                      maxLines: 3)),
                              Container(
                                  child: FlexoTextWidget().contentText16(
                                      text:
                                          "${localResourceProvider.getResourseByKey("order.email")}: ${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.email}",
                                      maxLines: 3)),
                              orderShipmateDetailProvider
                                  ...
                                  ? orderShipmateDetailProvider
                                      ...
                                      : Container(
                                          child: FlexoTextWidget().contentText16(
                                              text:
                                                  "${localResourceProvider.getResourseByKey("order.phone")}: ${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.phoneNumber}",
                                              maxLines: 3))
                                  : Container(),
                              orderShipmateDetailProvider
                                      .getShipmentDetailsModel
                                  ...
                                  ? orderShipmateDetailProvider
                                      ...
                                      : Container(
                                          child: FlexoTextWidget().contentText16(
                                              text:
                                                  "${localResourceProvider.getResourseByKey("order.fax")}: ${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.faxNumber}",
                                              maxLines: 3))
                                  : Container(),
                              orderShipmateDetailProvider
                                      .getShipmentDetailsModel
                                  ...
                                  ? orderShipmateDetailProvider
                                      ...
                                      : Container(
                                          child: FlexoTextWidget().contentText16(
                                              text: orderShipmateDetailProvider
                                                  .getShipmentDetailsModel
                                                  .order
                                                  .shippingAddress
                                                  .company,
                              ...
                              Container(
                                  child: FlexoTextWidget().contentText16(
                                      text:
                                          '${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.city != null && orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.city != '' ? "${orderShipmateDetailProvider.getShipmentDetailsModel.order.shippingAddress.city + ','}" : ''}'
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              Container(
                                  child: FlexoTextWidget().contentText16(
                                      text:
                                          '${orderShipmateDetailProvider.getShipmentDetailsModel.order.pickupAddress.city != null && orderShipmateDetailProvider.getShipmentDetailsModel.order.pickupAddress.city != '' ? "${orderShipmateDetailProvider.getShipmentDetailsModel.order.pickupAddress.city + ','}" : ''}'
              ...
              orderShipmateDetailProvider.getShipmentDetailsModel.items.length >
                      0
                  ? Column(
                      children: [
                        Container(
                          ...
                          child: Text(
                            localResourceProvider
                                .getResourseByKey("order.shipments.product(s)")
                                .toString()
                                .toUpperCase(),
                            maxLines: 2,
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Table(
                                          ...
                                          defaultVerticalAlignment:
                                              TableCellVerticalAlignment.middle,
                                          children: orderShipmateDetailProvider
                                              .getShipmentDetailsModel.items
                                              .map((e) {
                                            return TableRow(
                                              children: [
                                                orderShipmateDetailProvider
                  ...
                  : Container(),
              orderShipmateDetailProvider
                          .getShipmentDetailsModel.shipmentStatusEvents.length >
                      0
                  ? Column(
                      children: [
                        Container(
                          ...
                          child: Text(
                            localResourceProvider
                                .getResourseByKey("order.shipmentStatusEvents")
                                .toString()
                                .toUpperCase(),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Text(
                                                    localResourceProvider
                                                        .getResourseByKey(
                                                            "order.shipmentStatusEvents.event"),
                                                    style: TextStyle(
                                                        fontSize: FlexoValues
                                                            .fontSize16,
                                                        color: FlexoColorConstants
                                                ...
                                                Container(
                                                  ...
                                                  child: Text(
                                                    localResourceProvider
                                                        .getResourseByKey(
                                                            "order.shipmentStatusEvents.location"),
                                                    style: TextStyle(
                                                        fontSize: FlexoValues
                                                            .fontSize16,
                                                        color: FlexoColorConstants
                                                ...
                                                Container(
                                                  ...
                                                  child: Text(
                                                    localResourceProvider
                                                        .getResourseByKey(
                                                            "order.shipmentStatusEvents.country"),
                                                    style: TextStyle(
                                                        fontSize: FlexoValues
                                                            .fontSize16,
                                                        color: FlexoColorConstants
