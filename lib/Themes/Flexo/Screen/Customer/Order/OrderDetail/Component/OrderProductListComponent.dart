              ...
              Container(
                ...
                child: Text(
                  localResourceProvider
                      .getResourseByKey("order.product(s)")
                      .toString()
                      .toUpperCase(),
                  maxLines: 2,
                        ...
                        Container(
                          width:
                              orderDetailsProvider.getOrderDetailsModel.showSku
                                  ? FlexoValues.deviceWidth * 2.7
                                  : FlexoValues.deviceWidth * 2.3,
                          child: Table(
                            columnWidths: {
                              0: FlexColumnWidth(orderDetailsProvider
                                      .getOrderDetailsModel.showSku
