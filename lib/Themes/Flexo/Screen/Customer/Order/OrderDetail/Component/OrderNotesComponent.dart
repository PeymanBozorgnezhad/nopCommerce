              ...
              children: [
                Container(
                    ...
                    child: FlexoTextWidget().headingBoldText16(
                      text:
                          localResourceProvider.getResourseByKey("order.notes"),
                    )),
                Container(
                  child: Column(
                    children: [
                            ...
                            TableRow(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: FlexoTextWidget().headingBoldText16(
                                      text: localResourceProvider
                                          .getResourseByKey("order.notes.note"),
                                    )),
                              ],
                            ),
                          ],
                      ...
                      Container(
                        ...
                        child: Table(
                          ...
                          children: orderDetailsProvider
                              .getOrderDetailsModel.orderNotes
                              .map((e) {
                            return TableRow(
                              children: [
                                Container(
                                    ...
                                    child: FlexoTextWidget().headingText16(
                                        text:
                                            '${DateFormat('dd/MM/yyyy hh:mm:ss a').format(e.createdOn)}',
                                        maxLines: 2)),
                                Container(
                                  width: FlexoValues.deviceWidth * 0.8,
                                  height: FlexoValues.deviceWidth * 0.15,
