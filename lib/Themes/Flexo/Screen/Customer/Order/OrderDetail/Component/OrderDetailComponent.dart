                          ...
                          GestureDetector(
                            onTap: () async {
                              if (await CheckConnectivity()
                                ...
                                orderDetailsProvider.printButtonClickEvent(
                                    context: context,
                            ...
                            child: Container(
                              child: Container(
                                width: orderDetailsProvider
                                        .getOrderDetailsModel.pdfInvoiceDisabled
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      text:
                          "${localResourceProvider.getResourseByKey('order.order#').toString().toUpperCase()}${orderDetailsProvider.getOrderDetailsModel.customOrderNumber}",
                    )),
                    SizedBox(
                    ...
                    Container(
                      ...
                      text:
                          "${localResourceProvider.getResourseByKey('order.orderDate')}: ${DateFormat.MMMEd().format(date)}, ${date.year}",
                    )),
                    SizedBox(
                      height: FlexoValues.heightSpace1Px,
                    ),
                    Container(
                        child: FlexoTextWidget().contentText16(
                      text:
                          "${localResourceProvider.getResourseByKey("order.orderStatus")}: ${orderDetailsProvider.getOrderDetailsModel.orderStatus}",
                    )),
                    SizedBox(
                      height: FlexoValues.heightSpace1Px,
                    ),
