      ...
      builder: (BuildContext context, StateSetter setState) {
        return Container(
          decoration: BoxDecoration(
            border: Border(
                bottom:
                    BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR)),
          ),
                ...
                children: [
                  ...
                  Container(
                    child: FlexoTextWidget().contentText16(
                        text:
                            '${orderDetailsProvider.getOrderDetailsModel.shippingAddress.firstName} ${orderDetailsProvider.getOrderDetailsModel.shippingAddress.lastName}',
                        maxLines: 3),
                  ),
                  ...
                  Container(
                    child: FlexoTextWidget().contentText16(
                        text:
                            "${localResourceProvider.getResourseByKey("order.email")}: ${orderDetailsProvider.getOrderDetailsModel.shippingAddress.email}",
                        maxLines: 3),
                  ),

                  orderDetailsProvider
                          .getOrderDetailsModel.shippingAddress.phoneEnabled
                      ? orderDetailsProvider.getOrderDetailsModel
                          ...
                          : Container(
                              child: FlexoTextWidget().contentText16(
                                  text:
                                      "${localResourceProvider.getResourseByKey("order.phone")}: ${orderDetailsProvider.getOrderDetailsModel.shippingAddress.phoneNumber}",
                                  maxLines: 3),
                            )
                      : Container(),

                  orderDetailsProvider
                          .getOrderDetailsModel.shippingAddress.faxEnabled
                      ? orderDetailsProvider.getOrderDetailsModel
                          ...
                          : Container(
                              child: FlexoTextWidget().contentText16(
                                  text:
                                      "${localResourceProvider.getResourseByKey("order.fax")}: ${orderDetailsProvider.getOrderDetailsModel.shippingAddress.faxNumber}",
                                  maxLines: 3),
                            )
                      : Container(),

                  orderDetailsProvider
                          .getOrderDetailsModel.shippingAddress.companyEnabled
                      ? orderDetailsProvider.getOrderDetailsModel
                  ...
                  orderDetailsProvider.getOrderDetailsModel.shippingAddress
                  ...
                  Container(
                    child: FlexoTextWidget().contentText16(
                        text:
                            '${orderDetailsProvider.getOrderDetailsModel.shippingAddress.city != null && orderDetailsProvider.getOrderDetailsModel.shippingAddress.city != '' ? "${orderDetailsProvider.getOrderDetailsModel.shippingAddress.city + ','}" : ''}'
                  ...
                  orderDetailsProvider
                          .getOrderDetailsModel.shippingAddress.countryEnabled
                      ? Container(
                          child: FlexoTextWidget().contentText16(
