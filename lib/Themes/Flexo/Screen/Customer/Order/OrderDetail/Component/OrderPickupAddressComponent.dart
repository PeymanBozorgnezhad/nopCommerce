            ...
            children: [
              ...
              Container(
                ...
                text: localResourceProvider
                    .getResourseByKey("order.pickupAddress"),
              )),
              SizedBox(
                height: FlexoValues.widthSpace2Px,
              ),
              orderDetailsProvider
                              .getOrderDetailsModel.pickupAddress.address1 !=
                          "" &&
                      orderDetailsProvider
                              .getOrderDetailsModel.pickupAddress.address1 !=
                          null
                  ? Container(
                      ...
                      text:
                          "${orderDetailsProvider.getOrderDetailsModel.pickupAddress.address1}",
                    ))
                  : Container(),
              Container(
                  child: FlexoTextWidget().contentText16(
                text:
                    '${orderDetailsProvider.getOrderDetailsModel.pickupAddress.city != null && orderDetailsProvider.getOrderDetailsModel.pickupAddress.city != '' ? "${orderDetailsProvider.getOrderDetailsModel.pickupAddress.city + ','}" : ''}'
              ...
              (orderDetailsProvider
                              .getOrderDetailsModel.pickupAddress.countryName !=
                          "" &&
                      orderDetailsProvider
                              .getOrderDetailsModel.pickupAddress.countryName !=
                          null)
