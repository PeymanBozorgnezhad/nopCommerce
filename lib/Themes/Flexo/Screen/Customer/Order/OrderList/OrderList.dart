        ...
        title: localResourceProvider.isLocalDataLoad
            ...
            : localResourceProvider.getResourseByKey("account.myAccount") +
                ...
                localResourceProvider
                    .getResourseByKey("account.customerOrders"),
        backButton: true,
      ),
      bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
          context: context,
          tabIndexType: BottomNavigationIndexType.Other,
          headerData: orderListProvider.headerModel,
          headerLoader: orderListProvider.isAPILoader),
      body: orderListProvider.isPageLoader ||
              localResourceProvider.isLocalDataLoad
          ? Loaders.pageLoader()
          : Column(
              children: [
                orderListProvider.isAPILoader
                    ? Loaders.apiLoader()
                    : Container(),
                Expanded(
                  child: Container(
                      ...
                      child: orderListProvider
                                  .customerOrderModel.orders.length ==
                              0
                          ? Container(
                              child: Padding(
                                padding:
                                ...
                                child: Container(
                                    child: FlexoTextWidget().headingText17(
                                        text: localResourceProvider
                                            .getResourseByKey(
                                                "account.customerOrders.noOrders"),
                                        maxLines: 2)),
                              ),
                            )
                          : SingleChildScrollView(
                              ...
                              child: Column(
                                children: [
                                  OrderListComponent()
                                      .getOrderListComponent(context: context),
                                ],
                              ),
                            )),
                ),
