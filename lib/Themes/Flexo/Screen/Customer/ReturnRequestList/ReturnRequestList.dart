      ...
      return GestureDetector(
        ...
        child: Scaffold(
          appBar: FlexoAppBarWidget().appbar(
              ...
              title: localResourceProvider.isLocalDataLoad
                  ...
                  : localResourceProvider
                      ...
                      " - " +
                      localResourceProvider
                          .getResourseByKey("account.customerReturnRequests")),
          ...
          bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
              ...
              headerData: returnRequestProvider.headerModel,
              headerLoader: returnRequestProvider.isPageLoader),
          body: returnRequestProvider.isPageLoader
              ? Loaders.pageLoader()
              : Column(
                  children: [
                    returnRequestProvider.isAPILoader
                        ? Loaders.apiLoader()
                        : Container(),
                    Expanded(
                      child: Container(
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              CustomerReturnRequestComponent()
                                  .getCustomerReturnRequestComponent(
                                      context: context),
                            ],
                          ),
                        ),
