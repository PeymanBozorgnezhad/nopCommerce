  ...
  getCustomerReturnRequestComponent({required BuildContext context}) {
    ...
    return StatefulBuilder(
      builder: (BuildContext context, StateSetter setState) {
        return Container(
          child: Column(
            children: returnRequestProvider.getCustomerReturnRequestModel.items
                .map((e) {
              return Container(
                    ...
                    Container(
                      ...
                      child: FlexoTextWidget().headingBoldText16(
                        text: localResourceProvider
                            ...
                            .toString()
                            .replaceAll("{0}", e.customNumber)
                            .replaceAll("{1}", e.returnRequestStatus),
                        maxLines: 1,
                      ),
                    ),
                    Container(
                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  text:
                                      "${localResourceProvider.getResourseByKey("account.customerReturnRequests.item")} ",
                                  maxLines: 1,
                                )),
                                Expanded(
                                  child: Container(
                          ...
                          Container(
                            ...
                            text: localResourceProvider.getResourseByKey(
                                    "account.customerReturnRequests.reason") +
                                ' ' +
                                e.returnReason,
                          )),
                          SizedBox(
                          ...
                          Container(
                            child: FlexoTextWidget().headingText16(
                              text:
                                  "${localResourceProvider.getResourseByKey("account.customerReturnRequests.date") + " " + '${DateFormat("M/d/yyyy hh:mm:ss aa").format(e.createdOn)}'}",
                            ),
                          ),
                          SizedBox(
                            height: FlexoValues.heightSpace1Px,
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    Container(
                                        child: FlexoTextWidget().headingText16(
                                      text:
                                          "${e.comments != null ? localResourceProvider.getResourseByKey("account.customerReturnRequests.comments") : ""}",
                                    )),
                                    SizedBox(
                                      height: FlexoValues.widthSpace2Px,
                                    ),
