...
import 'package:nopsuite/Models/CustomerAttributeModel.dart';
...
import 'package:nopsuite/Themes/Flexo/Widgets/FlexoDatePicker.dart';
import 'package:nopsuite/Themes/Flexo/Widgets/TextFormWidgets/TextFieldAttributeWidgets.dart';
...
import 'package:nopsuite/Screens/Customer/CustomerInfo/CustomerInfoProvider.dart';
...
class _FlexoCustomerInfoState extends State<FlexoCustomerInfo> {
          ...
          appBar: FlexoAppBarWidget().appbar(
              ...
              title: localResourceProvider.isLocalDataLoad
                  ...
                  : localResourceProvider
                          .getResourseByKey("account.myAccount") +
                      " - " +
                      localResourceProvider
                          .getResourseByKey("account.customerInfo")),
          backgroundColor: FlexoColorConstants.BACKGROUND_COLOR,
          bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
              context: context,
              tabIndexType: BottomNavigationIndexType.Other,
              headerData: customerInfoProvider.headerModel,
              headerLoader: customerInfoProvider.isPageLoader),
          body:
              customerInfoProvider.isPageLoader ||
                      localResourceProvider.isLocalDataLoad
                  ? Loaders.pageLoader()
                  : StatefulBuilder(builder: (context, setState) {
                      return Container(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              customerInfoProvider.isAPILoader
                                  ? Loaders.apiLoader()
                                  : Container(),
                              Expanded(
                                child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                                                          ...
                                                                          children: [
                                                                            Container(
                                                                                ...
                                                                                decoration: BoxDecoration(
                                                                                  ...
                                                                                  border: Border.all(color: e.code == customerInfoProvider.userInformationResponseModel.gender ? FlexoColorConstants.ACCENT_COLOR : FlexoColorConstants.THEME_COLOR, width: 1),
                                                                                ),
                                                                                child: Text(
                                                                                  e.name,
                                                                                  maxLines: 2,
                                                                                  ...
                                                                                  style: TextStyle(color: e.code == customerInfoProvider.userInformationResponseModel.gender ? Colors.white : FlexoColorConstants.ACCENT_COLOR, fontSize: FlexoValues.fontSize16, fontWeight: FontWeight.normal),
                                                                                ))
                                                                          ],
                                                                        ),
                                                                      ),
                                        ...
                                        TextFieldWidget(
                                          ...
                                          width: FlexoValues.controlsWidth,
                                          controller: customerInfoProvider
                                              .emailController,
                                          hintText: localResourceProvider
                                              .getResourseByKey(
                                            ...
                                            ? Column(
                                                children: [
                                                  TextFieldWidget(
                                                    ...
                                                    hintText: localResourceProvider
                                                        .getResourseByKey(
                                                            "account.fields.confirmEmail"),
                                                    keyBoardType: TextInputType
                                                        .emailAddress,
                                                    required: true,
                                                    errorMsg: localResourceProvider
                                                        .getResourseByKey(
                                                            "account.fields.confirmEmail.required"),
                                                    errorMsgForEmail:
                                                        localResourceProvider
                                                            .getResourseByKey(
                                                                "common.wrongEmail"),
                                                ...
                                                ? Column(
                                                    children: [
                                                      TextFieldWidget(
                                                          ...
                                                          errorMsg: localResourceProvider
                                                              .getResourseByKey(
                                                                  "account.fields.username.required"),
                                                          icon: Ionicons
                                                              .person_outline),
                                                      SizedBox(
                                                        height: FlexoValues
                                                                ...
                                                                children: [
                                                                  customerInfoProvider
                                                                      ...
                                                                      : Container(
                                                                          ...
                                                                          margin:
                                                                              EdgeInsets.only(left: FlexoValues.widthSpace2Px),
                                                                          alignment:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        KeyboardUtil.hideKeyboard(
                                                                            context);
                                                                        customerInfoProvider.checkUserNameAvailability(
                                                                            context:
                                                                                context);
                                                                      },
                                                                      child:
                                                                          Text(
                                                                        localResourceProvider
                                                                            .getResourseByKey("account.checkUserNameAvailability.button"),
                                                                        textAlign:
                                                                            TextAlign.end,
                                                                        overflow:
                                                                            TextOverflow.ellipsis,
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                TextFieldWidget(
                                                                    ...
                                                                    errorMsg: localResourceProvider
                                                                        .getResourseByKey(
                                                                            "account.fields.vatNumber.required"),
                                                                    icon: Ionicons
                                                                        .keypad_outline),
                                                                SizedBox(
                                                                  height: FlexoValues
                                                            ...
                                                            children: [
                                                              TextFieldWidget(
                                                                  width: FlexoValues
                                                                      .controlsWidth,
                                                                  controller: customerInfoProvider
                                                                      .countyRegionController,
                                                                  hintText: localResourceProvider
                                                                      .getResourseByKey(
                                                                          "account.fields.county"),
                                                                  keyBoardType:
                                                                      TextInputType
                                                                          .name,
                                                                  required: customerInfoProvider
                                                                  ...
                                                                  errorMsg: localResourceProvider
                                                                      .getResourseByKey(
                                                                          "account.fields.county.required"),
                                                                  icon: Ionicons
                                                                      .location_outline),
                                                              SizedBox(
                                                                height: FlexoValues
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    FlexoDropDown(
                                                                      ...
                                                                      selectedValue: customerInfoProvider
                                                                          .userInformationResponseModel
                                                                          .countryId
                                                                          .toString(),
                                                                      items: customerInfoProvider
                                                                          .userInformationResponseModel
                                                                          .availableCountries
                                                                          .map(
                                                                              (e) {
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("account.fields.country"),
                                                                      onChange:
                                                                          (value) {
                                                                        setState(
                                                                            () {
                                                                          ...
                                                                          customerInfoProvider.getStateDataByCountryId(
                                                                              context: context,
                                                                              countryId: customerInfoProvider.userInformationResponseModel.countryId);
                                                                        });
                                                                      },
                                                                    ),
                                                                  ],
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    FlexoDropDown(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("account.fields.stateProvince"),
                                                                      onChange:
                                                                          (value) {
                                                                        setState(
                                                                            () {
                                                                          customerInfoProvider
                                                                              .userInformationResponseModel
                                                                              .stateProvinceId = int.parse(value);
                                                                        });
                                                                      },
                                                                    ),
                                                                  ],
                                                    ...
                                                    Container(
                                                      ...
                                                      child: FlexoTextWidget()
                                                          .headingBoldText15(
                                                              text: localResourceProvider
                                                                  .getResourseByKey(
                                                                      "account.yourContactInformation")),
                                                    ),
                                                    SizedBox(
                                                      height: FlexoValues
                                                          .heightSpace1Px,
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        child: FlexoTextWidget().contentText16(
                                                                            text:
                                                                                localResourceProvider.getResourseByKey("account.fields.newsletter"),
                                                                            maxLines: 1),
                                                                      ),
                                                                      SizedBox(
                                                                        width: FlexoValues
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child: Container(
                                                                            padding:
                                                                                EdgeInsets.symmetric(vertical: FlexoValues.heightSpace1Px),
                                                                            child: FlexoTextWidget().contentText15(text: e.message, maxLines: 20)),
                                                                      )
                                                                    ],
                                                                  ),
                                                                ),
                                        ...
                                        ButtonWidget().getButton(
                                            ...
                                            onClick: () async {
                                              KeyboardUtil.hideKeyboard(
                                                  context);
                                              if (customerInfoProvider
                                                  .isAPILoader) {
                                                FlushBarMessage().warningMessage(
                                                    context: context,
  ...
  checkBoxContainer(
      {required CustomerAttributeModel e,
                ...
                children: [
                  Transform.scale(
                    ...
                    child: CupertinoSwitch(
                      ...
                      activeColor: e.attributeControlType ==
                              AttributeControlType.ReadonlyCheckboxes
  ...
  radioListContainer(
      {required CustomerAttributeModel e, required StateSetter setState}) {
        ...
        children: e.values.map((item) {
          return Container(
            ...
            child: GestureDetector(
              ...
              child: TextRadioButton().textRadioButtonComponent(
                  isCheck: item.isPreSelected, title: item.name),
            ),
          );
        }).toList(),
      ),
  ...
  customerAttributesSwitch(
      {required BuildContext context,
      required StateSetter setState,
      required List<CustomerAttributeModel> customerAttributes}) {
    return Container(
      width: FlexoValues.controlsWidth,
      child: Column(
            ...
            case AttributeControlType.DropdownList:
              if (!e.isRequired) {
                ...
                if (values.isEmpty) {
                  e.values.insert(
                      0,
                      new CustomerAttributeValueModel(
                          name: "---",
                          isPreSelected: true,
                          id: 0,
              ...
              widget = Container(
                child: Column(
                  ...
                  children: [
                    attributeHeading(
                        heading: e.name == null ? e.name : e.name,
                            ...
                            children: [
                              FlexoDropDown(
                                  ...
                                  onChange: (value) {
                                    ...
                                    List<CustomerAttributeValueModel> values = e
                                        .values
                                        .where(
              ...
              widget = Container(
                child: Column(
                  ...
                  children: [
                    ...
                    checkBoxContainer(
                        e: e, setState: setState, context: context),
                  ],
                ),
              );
              break;
