            ...
            children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: FormErrorWidget(
                            errors: changePasswordProvider.errors),
                      ),
                      SizedBox(height: FlexoValues.widthSpace2Px),
                    ],
                  ),
              ...
              TextFieldWidget(
                ...
                hintText: localResourceProvider
                    .getResourseByKey("account.passwordRecovery.newPassword"),
                icon: Ionicons.lock_closed_outline,
              ),
              SizedBox(height: FlexoValues.heightSpace2Px),
              TextFieldConfirmPasswordWidget(
                ...
                errorMsg: localResourceProvider.getResourseByKey(
                    "account.changePassword.fields.confirmNewPassword.required"),
                errorMsgConfirmPassword: localResourceProvider.getResourseByKey(
              ...
              ButtonWidget().getButton(
                  text: localResourceProvider
                      .getResourseByKey('account.changePassword.button')
                      .toString()
                      .toUpperCase(),
                  width: FlexoValues.controlsWidth,
                  onClick: () async {
                    ...
                    if (await CheckConnectivity().checkInternet(context)) {
                      if (form.currentState!.validate()) {
                        changePasswordProvider.updateButtonClickEvent(
                            context: context);
                      }
                    }
                  },
