    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: orderConfirmPageProvider.headerModel,
            headerLoader: orderConfirmPageProvider.isPageLoader),
        body: orderConfirmPageProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  orderConfirmPageProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                            ...
                            Container(
                              child: FlexoTextWidget().headingBoldText17(
                                text: localResourceProvider
                                    .getResourseByKey("checkout.thankyou"),
                              ),
                            ),
                              ...
                              onTap: () {
                                Navigator.push(
                                    ...
                                    PageTransition(
                                        ...
                                        child: OrderDetails(
                                            orderId: orderConfirmPageProvider
