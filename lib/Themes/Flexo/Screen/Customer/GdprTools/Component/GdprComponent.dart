        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: FlexoTextWidget().headingBoldText16(
                    text: localResourceProvider
                        .getResourseByKey("account.gdpr.export"))),
            SizedBox(
              height: FlexoValues.heightSpace2Px,
            ),
            Container(
              ...
              child: FlexoTextWidget().contentText16(
                  text: localResourceProvider
                      .getResourseByKey("account.gdpr.export.hint")),
            ),
            SizedBox(
              height: FlexoValues.heightSpace2Px,
            ),
            ButtonWidget().getButton(
                text: localResourceProvider
                    .getResourseByKey("account.gdpr.export.button")
                    .toString()
                    .toUpperCase(),
            ...
            Container(
                ...
                child: FlexoTextWidget().headingBoldText16(
                    text: localResourceProvider
                        .getResourseByKey("account.gdpr.delete"))),
            SizedBox(
              height: FlexoValues.heightSpace2Px,
            ),
            Container(
              ...
              child: FlexoTextWidget().contentText16(
                  text: localResourceProvider
                      .getResourseByKey("account.gdpr.delete.hint")),
            ),
            SizedBox(
              height: FlexoValues.heightSpace2Px,
            ),
            ButtonWidget().getButton(
                text: localResourceProvider
                    .getResourseByKey("account.gdpr.delete.button")
                    .toString()
                    .toUpperCase(),
                width: FlexoValues.controlsWidth,
                onClick: () async {
