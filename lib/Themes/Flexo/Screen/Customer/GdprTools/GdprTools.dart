...
import 'package:nopsuite/Screens/Customer/GdprTools/GdprToolsProvider.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Customer/GdprTools/Component/GdprComponent.dart';
        ...
        appBar: FlexoAppBarWidget().appbar(
            ...
            title: localResourceProvider.isLocalDataLoad
                ...
                : localResourceProvider.getResourseByKey("account.myAccount") +
                    " - " +
                    localResourceProvider.getResourseByKey("account.gdpr")),
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            context: context,
            tabIndexType: BottomNavigationIndexType.Other,
            headerData: gdprToolsProvider.headerModel,
            headerLoader: gdprToolsProvider.isAPILoader),
        body: gdprToolsProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  gdprToolsProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
