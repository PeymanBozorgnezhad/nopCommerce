            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    setState(() {
                      userAgreementProvider.isAgreement =
                          !userAgreementProvider.isAgreement;
                    });
                  },
                  child: checkboxWidget(
                      isCheck: userAgreementProvider.isAgreement,
                      isReadOnly: false),
                ),
                SizedBox(
                ...
                Container(
                  ...
                  text: userAgreementProvider
                              .userAgreementModel.userAgreementText ==
                          null
                      ? ""
          ...
          ButtonWidget().getButton(
              ...
              onClick: () async {
                if (await CheckConnectivity().checkInternet(context)) {
                  userAgreementProvider.continueButtonClick(
                      context: context,
                      orderGuid: userAgreementProvider
                          .userAgreementModel.orderItemGuid);
                }
              },
              isApiLoad: true),
        ],
