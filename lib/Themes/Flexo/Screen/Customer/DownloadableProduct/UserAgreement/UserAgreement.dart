...
import 'package:nopsuite/Screens/Customer/DownloadableProduct/UserAgreement/UserAgreementProvider.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: FlexoAppBarWidget().appbar(
            ...
            title: localResourceProvider.isLocalDataLoad
                ...
                : localResourceProvider
                    .getResourseByKey("account.userAgreement")),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: userAgreementProvider.headerModel,
            headerLoader: userAgreementProvider.isAPILoader),
        body: userAgreementProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  userAgreementProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                        ...
                        child: Column(
                          children: [
                            UserAgreementComponent()
                                .getUserAgreementComponent(context: context)
                          ],
                        ),
                      ),
                    ),
