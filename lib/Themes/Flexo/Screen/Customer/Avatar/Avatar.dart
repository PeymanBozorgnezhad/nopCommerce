    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: FlexoAppBarWidget().appbar(
            ...
            title: localResourceProvider.isLocalDataLoad
                ...
                : localResourceProvider.getResourseByKey("account.myAccount") +
                    " - " +
                    localResourceProvider.getResourseByKey("account.avatar")),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: avatarProvider.headerModel,
            headerLoader: avatarProvider.isPageLoader),
        body:
            avatarProvider.isPageLoader || localResourceProvider.isLocalDataLoad
                ? Loaders.pageLoader()
                : Column(
                    children: [
                      avatarProvider.isAPILoader
                          ? Loaders.apiLoader()
                          : Container(),
                      Expanded(
                        child: Container(
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                AvatarComponent()
                                    .getAvatarComponent(context: context),
                              ],
                            ),
                          ),
                        ),
