          ...
          children: [
            Column(
              ...
              children: [
                ...
                (avatarProvider.imageFile == null ||
                            avatarProvider.imageFile == "" ||
                            avatarProvider.imageFile.path == "" ||
                            avatarProvider.imageFile.path == null) &&
                        avatarProvider.getAvatarResponseModel.avatarUrl.isEmpty
                    ? Container(
                    ...
                    : Container(
                        ...
                        child: avatarProvider.imageNetwork
                            ? CachedNetworkImage(
                                imageUrl: avatarProvider
                                    .getAvatarResponseModel.avatarUrl,
                              )
                            : Image.file(
                                avatarProvider.imageFile,
                              ),
                          ...
                          ? GestureDetector(
                              onTap: () async {
                                DialogBoxWidget().deleteItemDialogBox(
                                    ...
                                    cancelText: localResourceProvider
                                        .getResourseByKey("common.cancel"),
                                    submitText: localResourceProvider
                                        .getResourseByKey("common.delete"),
                                    isCancelable: true,
                                    onSubmit: () async {
                                      if (await CheckConnectivity()
                                          .checkInternet(context)) {
                                        avatarProvider.deleteButtonClickEvent(
                                            context: context);
                                      }
                                    });
                              },
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: avatarProvider.getAvatarResponseModel
                                          .avatarUrl.isEmpty
                                      ? FlexoColorConstants.BUTTON_COLOR_GREY
                                      : Colors.red,
                                ),
                                child: Text(
                                  localResourceProvider
                                      .getResourseByKey(
                                          "account.avatar.removeAvatar")
                                      .toString()
                                      .toUpperCase(),
                                  maxLines: 2,
                                  ...
                                  style: TextStyle(
                                      color:
                                          FlexoColorConstants.BUTTON_TEXT_COLOR,
                          ...
                          : avatarProvider.imageFile == null ||
                              ...
                              ? GestureDetector(
                                  onTap: () async {
                                    if (await CheckConnectivity()
                                        .checkInternet(context)) {
                                      avatarProvider.openFileExplorer(
                                          context: context);
                                    }
                                  },
                                  child: Container(
                ...
                Container(
                  ...
                  child: FlexoTextWidget().contentText15(
                      text: localResourceProvider
                          .getResourseByKey("account.avatar.uploadRules")),
                )
              ],
            ),
          ],
