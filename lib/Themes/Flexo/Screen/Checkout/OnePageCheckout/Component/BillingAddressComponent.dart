...
class CheckoutBillingAddressComponent extends StatefulWidget {
  ...
  @override
  State<CheckoutBillingAddressComponent> createState() =>
      _CheckoutBillingAddressComponentState();
}

class _CheckoutBillingAddressComponentState
    extends State<CheckoutBillingAddressComponent> {
        ...
        child: IgnorePointer(
          ...
          child: new ExpansionTile(
            ...
            collapsedBackgroundColor:
                checkoutProvider.isBillingAddressTabCompleted
            ...
            leading: Container(
              decoration: BoxDecoration(
                ...
                color: checkoutProvider.isBillingAddress ||
                        checkoutProvider.isBillingAddressTabCompleted
            ...
            title: Container(
              ...
              localResourceProvider.getResourseByKey(
                  "enums.nop.core.domain.tax.taxBasedOn.billingAddress"),
              style: new TextStyle(
            ...
            children: <Widget>[
              !checkoutProvider.isBillingAddressLoad
                  ? Container()
                  : Container(
                      color: Colors.white,
                      child: new Column(
                        ...
                        children: [
                          ...
                          checkoutProvider
                                  .getBillingAddressesModel.addresses.isNotEmpty
                              ? Container(
                              ...
                              : Container(),
                          checkoutProvider.getBillingAddressesModel
                          ...
                          checkoutProvider
                              ...
                              ? FlexoDropDown(
                                  ...
                                  selectedValue:
                                      checkoutProvider.selectedBillingAddress,
                                  ...
                                  onChange: (val) {
                                    setState(() {
                                      checkoutProvider
                                          ...
                                          .clear();
                                      checkoutProvider.lastNameBillingController
                                          .clear();
                                      checkoutProvider.emailBillingController
                                          .clear();
                                      checkoutProvider
                                          .companyNameBillingController
                                          .clear();
                                      checkoutProvider.cityBillingController
                                          .clear();
                                      checkoutProvider.countyBillingController
                                          .clear();
                                      checkoutProvider.address1BillingController
                                          .clear();
                                      checkoutProvider.address2BillingController
                                          .clear();
                                      checkoutProvider.zipCodeBillingController
                                          .clear();
                                      checkoutProvider
                                    ...
                                    checkoutProvider.billingDropdownOnChange(
                                        context: context, value: val);
                                  })
                              : Container(),
