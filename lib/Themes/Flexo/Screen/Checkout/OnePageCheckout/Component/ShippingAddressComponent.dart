...
class ShippingAddressComponent extends StatefulWidget {
  ...
  State<ShippingAddressComponent> createState() =>
      _ShippingAddressComponentState();
}
        ...
        child: IgnorePointer(
          ...
          child: new ExpansionTile(
            ...
            collapsedBackgroundColor:
                checkoutProvider.isShippingAddressTabCompleted
            ...
            leading: Container(
              decoration: BoxDecoration(
                ...
                color: checkoutProvider.isShippingAddress ||
                        checkoutProvider.isShippingAddressTabCompleted
            ...
            title: Container(
              ...
              localResourceProvider.getResourseByKey(
                  "enums.nop.core.domain.tax.taxBasedOn.shippingAddress"),
              style: new TextStyle(
            ...
            children: <Widget>[
              !checkoutProvider.isShippingAddressLoad
                  ? Container()
                  : Container(
                      color: Colors.white,
                      child: new Column(
                        ...
                        children: [
                          !checkoutProvider.isPickupPointsLoad
                              ? Container()
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    alignment:
                                                                        Alignment
                                                                            .center,
                                                                    child: FlexoTextWidget().headingCenterText16(
                          ...
                          !checkoutProvider.isPickupPointEnable
                              ? Column(
                                  children: [
                                    ...
                                    checkoutProvider.getShippingAddressesModel
                                        ...
                                        : Container(
                                            height: FlexoValues.widthSpace3Px),
                                    Container(
                                      child: Column(
                                        children: [
                                          checkoutProvider
                                              ...
                                              ? FlexoDropDown(
                                                  ...
                                                  onChange: (val) {
                                                    setState(() {
                                                      checkoutProvider
                                                          .firstNameShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .lastNameShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .emailShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .companyNameShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .cityShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .countyShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .address1ShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .address2ShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .zipCodeShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .phoneNumberShippingController
                                                          .clear();
                                                      checkoutProvider
                                                          .faxNumberShippingController
                                                          .clear();
                                                      checkBoxMap = {};
                                                    });
                                                    checkoutProvider
                                                        .shippingDropdownOnChange(
                                                            context: context,
                                                            value: val);
                                                  })
                                              : Container(),
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.company"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.company.required"),
                                                                    ...
                                                                    FlexoDropDown(
                                                                        ...
                                                                        onChange:
                                                                          ...
                                                                          checkoutProvider
                                                                              .getShippingAddressesModel
                                                                              .newAddress
                                                                              .countryId = int.parse(val);
                                                                          checkoutProvider.getShippingAddressesModel.newAddress.countryName = checkoutProvider
                                                                              .getShippingAddressesModel
                                                                              .newAddress
                                                                              .availableCountries
                                                                        ...
                                                                        onChange:
                                                                          ...
                                                                          setState(
                                                                            ...
                                                                            checkoutProvider.getShippingAddressesModel.newAddress.stateProvinceId =
                                                                                int.parse(val);
                                                                            checkoutProvider.getShippingAddressesModel.newAddress.stateProvinceName =
                                                                                checkoutProvider.shippingStateDropdownList.where((element) => element.value == val).first.text;
                                                                          });
                                                                        }),
                                                                    SizedBox(
                                                                        height:
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.county"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.county.required"),
                                                                      required: checkoutProvider
                                                                          .getShippingAddressesModel
                                                                          .newAddress
                                                                          .countyRequired,
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.city"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.city.required"),
                                                                      required: checkoutProvider
                                                                          .getShippingAddressesModel
                                                                          .newAddress
                                                                          .cityRequired,
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.address1"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.address1.required"),
                                                                      required: checkoutProvider
                                                                          .getShippingAddressesModel
                                                                          .newAddress
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.address2"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.address2.required"),
                                                                      required: checkoutProvider
                                                                          .getShippingAddressesModel
                                                                          .newAddress
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.zipPostalCode"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.zipPostalCode.required"),
                                                                      required: checkoutProvider
                                                                          .getShippingAddressesModel
                                                                          .newAddress
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.phoneNumber"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.phoneNumber.required"),
                                                                      required: checkoutProvider
                                                                          .getShippingAddressesModel
                                                                          .newAddress
                                                                          .phoneRequired,
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    TextFieldWidget(
                                                                      ...
                                                                      hintText:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.faxNumber"),
                                                                      errorMsg:
                                                                          localResourceProvider
                                                                              .getResourseByKey("address.fields.faxNumber.required"),
                                                                      required: checkoutProvider
                                                                          .getShippingAddressesModel
                                                                          .newAddress
                                                                          .faxRequired,
                                            ...
                                            if (checkoutProvider
                                              ...
                                              addAddressRequestModel = AddAddressRequestModel(
                                                  firstName: checkoutProvider
                                                      .firstNameShippingController
                                                      .text,
                                                  lastName: checkoutProvider
                                                      .lastNameShippingController
                                                      .text,
                                                  email: checkoutProvider
                                                      .emailShippingController
                                                      .text,
                                                  company: checkoutProvider
                                                      .companyNameShippingController
                                                      .text,
                                                  ...
                                                  stateProvinceId: checkoutProvider
                                                      ...
                                                      .newAddress
                                                      .stateProvinceId,
                                                  county: checkoutProvider
                                                      .countyShippingController
                                                      .text,
                                                  city: checkoutProvider
                                                      .cityShippingController
                                                      .text,
                                                  address1: checkoutProvider
                                                      .address1ShippingController
                                                      .text,
