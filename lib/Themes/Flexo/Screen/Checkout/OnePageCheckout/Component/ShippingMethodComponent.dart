        ...
        child: IgnorePointer(
          ...
          child: new ExpansionTile(
            ...
            collapsedBackgroundColor:
                checkoutProvider.isShippingMethodTabCompleted
            ...
            leading: Container(
              decoration: BoxDecoration(
                ...
                color: checkoutProvider.isShippingMethod ||
                        checkoutProvider.isShippingMethodTabCompleted
            ...
            children: <Widget>[
              !checkoutProvider.isShippingMethodsLoad
                  ? Container()
                  : Container(
                      color: Colors.white,
                      child: Column(
                        children: [
                          ...
                          checkoutProvider.getShippingMethodsModel
                                  .shippingMethods.isNotEmpty
                              ? Column(
                                  children: checkoutProvider
                                      .getShippingMethodsModel.shippingMethods
                                      .map((e) {
                                    return GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          for (var it in checkoutProvider
                                          ...
                                          checkoutProvider
                                              ...
                                              '${e.name}___${e.shippingRateComputationMethodSystemName}';
                                        });
                                      },
                                      child: Container(
                              ...
                              : Container(
                                  ...
                                  child: checkoutProvider
                                      ...
                                      ? Text(
                                          checkoutProvider
                                              .getShippingMethodsModel.warnings
                                              .map((e) {
                                            return e;
                                          }).toString(),
                                          style: TextStyle(
                            ...
                            child: Row(
                              ...
                              children: [
                                ButtonWidget().getBackButton(
                                    ...
                                    onClick: () {
                                      checkoutProvider.shippingMethodBackButton(
                                          context: context,
                                ...
                                ButtonWidget().getButton(
                                    ...
                                    onClick: () {
                                      ...
                                      if (checkoutProvider
                                          .getPickupPointsModel.pickupInStore) {
                                        setState(() {
                                      ...
                                      checkoutProvider.updateShippingMethod(
                                          context: context,
                                          shippingMethodName: checkoutProvider
                                              .selectedShippingMethodName,
