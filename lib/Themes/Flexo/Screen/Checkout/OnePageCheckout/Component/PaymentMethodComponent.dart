        ...
        child: IgnorePointer(
          ...
          child: new ExpansionTile(
            ...
            collapsedBackgroundColor:
                checkoutProvider.isPaymentMethodTabCompleted
            ...
            leading: Container(
              decoration: BoxDecoration(
                ...
                color: checkoutProvider.isPaymentMethod ||
                        checkoutProvider.isPaymentMethodTabCompleted
            ...
            children: <Widget>[
              !checkoutProvider.isPaymentMethodsLoad
                  ? Container()
                  : Container(
                      color: Colors.white,
                      child: new Column(
                        children: [
                          ...
                          checkoutProvider
                                  .paymentMethodsModel450.displayRewardPoints
                              ? GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      checkoutProvider.isRewardPointEnable =
                                          !checkoutProvider.isRewardPointEnable;
                                    });
                                  },
                                  child: Row(
                              ...
                              : Container(),
                          checkoutProvider.paymentMethodsModel450.paymentMethods
                                  .isNotEmpty
                              ? Container(
                                  child: Column(
                                    children: checkoutProvider
                                        .paymentMethodsModel450.paymentMethods
                                        .map((e) {
                                      return Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ButtonWidget().getBackButton(
                                    ...
                                    onClick: () {
                                      checkoutProvider.paymentMethodBackButton(
                                          context: context,
                                          scrollController:
                                ...
                                ButtonWidget().getButton(
                                    ...
                                    width: FlexoValues.deviceWidth * 0.47,
                                    onClick: () {
                                      checkoutProvider.uploadPaymentMethod(
                                          context: context,
                                          scrollController:
                                              widget.scrollController,
