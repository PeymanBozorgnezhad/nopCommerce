...
class CheckoutAddressAttributes extends StatefulWidget {
  ...
  @override
  State<CheckoutAddressAttributes> createState() =>
      _CheckoutAddressAttributesState();
}
            ...
            case AttributeControlType.DropdownList:
              ...
              widget = Container(
                child: Column(
                  ...
                  children: [
                    addressAttributeHeading(
                        heading: e.name, isRequired: e.isRequired),
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              padding: EdgeInsets.only(
                                  right: FlexoValues.widthSpace1Px),
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  TextRadioButton().textRadioButtonComponent(
                                ...
                                children: [
                                  Transform.scale(
                                    ...
                                    child: CupertinoSwitch(
                                      onChanged: (val) {
                                        if (AttributeControlType.Checkboxes ==
