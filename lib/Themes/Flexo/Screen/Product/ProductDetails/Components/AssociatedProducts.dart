    ...
    return StatefulBuilder(builder: (context, setState) {
      return Column(
        children: productDetailsProvider
            .getProductDetailsModel.associatedProducts
            .map((e) {
          if (e.productEstimateShipping.enabled) {
            if (e.productEstimateShipping.countryId == null ||
                e.productEstimateShipping.countryId == "") {
              List<CountryStateModel> availableCountries = e
              ...
              if (availableCountries.isNotEmpty) {
                ...
                e.productEstimateShipping.countryId =
                    e.productEstimateShipping.availableCountries[0].value;
              }
            }

            if (e.productEstimateShipping.stateProvinceId == null ||
                e.productEstimateShipping.stateProvinceId == '') {
              List<CountryStateModel> availableStates = e
                  .productEstimateShipping.availableStates
                  .where((element) => element.selected)
                  .toList();
              if (availableStates.isNotEmpty) {
                e.productEstimateShipping.stateProvinceId =
                    availableStates[0].value;
              } else {
                e.productEstimateShipping.stateProvinceId =
                    e.productEstimateShipping.availableStates[0].value;
              }
            }

            e.productEstimateShipping.city =
                e.productEstimateShipping.city == null
                    ? ""
                    : e.productEstimateShipping.city;
            e.productEstimateShipping.zipPostalCode =
                e.productEstimateShipping.zipPostalCode == null
                    ? ""
                    : e.productEstimateShipping.zipPostalCode;
          }
          ...
          if (e.addToCart.allowedQuantities.isNotEmpty) {
            ...
            List<AllowedQuantity> checkList = e.addToCart.allowedQuantities
                .where((element) =>
                    int.parse(element.value) == e.addToCart.enteredQuantity)
                .toList();
            if (checkList.isNotEmpty) {
              e.addToCart.enteredQuantity = int.parse(checkList[0].value);
            } else {
              e.addToCart.enteredQuantity =
                  int.parse(e.addToCart.allowedQuantities[0].value);
            }
          }
          ...
          return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  e.shortDescription == null || e.shortDescription == ''
                      ? Container()
                      : Container(
                          margin: EdgeInsets.symmetric(
                              horizontal: FlexoValues.widthSpace2Px),
                                ...
                                return Container(
                                  ...
                                  child: RichText(
                                    ...
                                    text: HTML.toTextSpan(
                                        context, '${e.shortDescription}',
                                        defaultTextStyle:
                                            TextStyleWidget.contentTextStyle16,
                                        linksCallback: (url) {
                                      launch(url!);
                                    }),
                                  ),
                  ...
                  ProductAvailability()
                      .getView(context: context, getProductDetailsModel: e),
                  SKUManGTINVen().getView(
                      context: context,
                      getProductDetailsModel: e,
                      isSimple: false),
                  DeliveryInfo()
                      .getView(context: context, getProductDetailsModel: e),
                  DownloadSample()
                  ...
                  GiftCardInfo()
                      .getView(context: context, giftCard: e.giftCard),
                  RentalInfo()
                      .getView(context: context, getProductDetailsModel: e),
                  ProductPriceWidget()
                      .getView(context: context, productPrice: e.productPrice),
                  ProductTierPrices()
                      .getView(context: context, tierPrices: e.tierPrices),
                  Container(
                    child: Column(
                      children: [
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:
                                        ...
                                        text:
                                            "${localResourceProvider.getResourseByKey("products.enterProductPrice")}: ",
                                      ),
                                    ),
                                    SizedBox(
                                        height: FlexoValues.heightSpace1Px),
                                    TextFieldAttributeWidgets(
                                      ...
                                      initialValue: e
                                          .addToCart.customerEnteredPrice
                                          .ceil()
                                          .toString(),
                                      onChange: (String val) {
                                        if (val != "") {
                                          setState(() {
                                            e.addToCart.customerEnteredPrice =
                                                double.parse(val);
                                          });
                                        }
                                      },
                                  ...
                                  ? StatefulBuilder(
                                      builder: (context, setState) {
                                        return Container(
                                          ...
                                          child: e.addToCart.allowedQuantities
                                                  .isEmpty
                                              ? Container(
                              ...
                              GestureDetector(
                                onTap: () async {
                                  productDetailsProvider.attributeOnChanged(
                                      context: context,
                                      addToCartType: AddToCartType.Wishlist,
                                      getProductDetailsModel: e);
                                },
                                child: Container(
                                  width: FlexoValues.deviceWidth * 0.31,
                            ...
                            ? Container(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    productDetailsProvider.attributeOnChanged(
                                        context: context,
                                        addToCartType: AddToCartType.Cart,
                                        getProductDetailsModel: e);
                                  },
                                  child: Container(
                                    width: FlexoValues.controlsWidth,
                                    ...
                                    child: Text(
                                      e.addToCart.availableForPreOrder
                                          ...
                                          : e.isRental
                                              ...
                                              : productDetailsProvider.isCart
                                                  ? localResourceProvider
                                                      .getResourseByKey(
                                                          "products.wishlist.addToWishlist.update")
                                                      .toString()
                                                      .toUpperCase()
                                                  : localResourceProvider
                                                      .getResourseByKey(
                  ...
                  productDetailsProvider
                              .productEstimateShippingModelMap[e.id] ==
                          null
                      ? Container()
                      : ProductEstimateShipping()
                          .getView(
                              ...
                              getProductDetailsModel: e,
                              estimateShippingMap:
                                  productDetailsProvider.estimateShippingMap,
