                        ...
                        ? Container(
                            ...
                            child: FlexoTextWidget().headingBoldText15(
                                text: localResourceProvider
                                    .getResourseByKey("products.callForPrice")),
                          )
                        : Column(
                            children: [
                                            ...
                                            children: [
                                              Container(
                                                child: FlexoTextWidget()
                                                    .headingBoldText18(
                                                  text:
                                                      '${localResourceProvider.getResourseByKey("products.price")}',
                                                ),
                                              ),
                                              Flexible(
                                                child: Container(
                                              ...
                                              text: HTML.toTextSpan(
                                                  ...
                                                  productDetailsProvider
                                                      ...
                                                      ? localResourceProvider
                                                          .getResourseByKey(
                                                              "products.price.taxShipping.inclTax")
                                                      : localResourceProvider
                                                          .getResourseByKey(
                                                              "products.price.taxShipping.exclTax"),
