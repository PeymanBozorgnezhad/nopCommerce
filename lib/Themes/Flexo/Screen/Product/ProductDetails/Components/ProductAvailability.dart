            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  productDetailsProvider.getSubscribesModel.subscriptionAllowed
                      ? Container()
                      : Container(
                          padding: EdgeInsets.symmetric(
                              horizontal: FlexoValues.widthSpace2Px),
                          child: FlexoTextWidget().headingText16(
                            text: localResourceProvider.getResourseByKey(
                                "BackInStockSubscriptions.NotAllowed"),
                          ),
                        ),
                  productDetailsProvider
                          .getSubscribesModel.isCurrentCustomerRegistered
                      ? Container()
                      : Container(
                          padding: EdgeInsets.symmetric(
                              horizontal: FlexoValues.widthSpace2Px),
                  ...
                  !productDetailsProvider
                              .getSubscribesModel.alreadySubscribed &&
                          productDetailsProvider.getSubscribesModel
                      ...
                      ? Container(
                          ...
                          child: FlexoTextWidget().contentText17(
                            text: productDetailsProvider.max,
                          ),
                        )
                      : Container(),
                  SizedBox(
                  ...
                  !productDetailsProvider.getSubscribesModel.alreadySubscribed
                      ? Container(
                          ...
                          child: FlexoTextWidget().headingText15(
                            text: localResourceProvider.getResourseByKey(
                                "backInStockSubscriptions.tooltip"),
                          ),
                        )
                      : Container(),
                  SizedBox(
                  ...
                  GestureDetector(
                    onTap: () async {
                      Navigator.pop(ctx);
                      productDetailsProvider.backInStockSubscribe(
                          context: context);
                    },
                    child: Container(
                  ...
                  children: [
                    Container(
                      child: FlexoTextWidget().headingBoldText15(
                        text:
                            '${localResourceProvider.getResourseByKey("products.availability")}: ',
                      ),
                    ),
                    Flexible(
                      child: Container(
                        child: FlexoTextWidget().contentText15(
                          text: getProductDetailsModel.stockAvailability,
                        ),
                      ),
                    ),
                  ],
