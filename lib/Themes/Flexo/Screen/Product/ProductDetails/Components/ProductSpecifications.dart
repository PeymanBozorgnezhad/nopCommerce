...
import 'package:nopsuite/Utils/Enum/SpecificationAttributes.dart';
...
class ProductSpecifications {
  getView({required BuildContext context}) {
    ...
    ProductSpecificationModel productSpecificationModel =
        productDetailsProvider.getProductDetailsModel.productSpecificationModel;
    int rowCount = 0;
                    ...
                    children: [
                      FlexoTextWidget().headingBoldText16(
                          text: localResourceProvider
                              .getResourseByKey("Products.Specs")),
                      SizedBox(
                      ...
                      SingleChildScrollView(
                        ...
                        child: Container(
                          child: Column(
                            ...
                            children: [
                              Column(
                                children: productSpecificationModel.groups
                                    .map((group) {
                                  return Column(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    crossAxisAlignment:
