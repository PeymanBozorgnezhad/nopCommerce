...
class ProductsAlsoPurchased {
  getView(
      ...
      required Function({required BuildContext context}) loadData}) {
            ...
            child: Container(
              child: FlexoTextWidget().headingBoldText16(
                text: localResourceProvider
                    .getResourseByKey('products.alsoPurchased'),
              ),
            ),
          ),
          Container(
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: Row(
                  children: productDetailsProvider.getProductsAlsoPurchasedModel
                      .map((e) {
                    return Container(
                      child: ProductBox().getHorizontalProductBox(
                          context: context,
                          productBoxModel: e,
                          localResourceProvider: localResourceProvider,
                          updateHeaderData: loadData),
                    );
                  }).toList(),
                ),
              ),
