...
class FlexoProductAttribute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StatefulBuilder(builder: (ctx, setState) {
      ...
      if (productDetailsProvider.associateProductDetailsAttributeChangeModel[
              getProductDetailsModel.id] !=
          null) {
        disabledAttributeMappingIds = productDetailsProvider
            ...
            child: Column(
              children: getProductDetailsModel.productAttributes.map((e) {
                ...
                if (disabledAttributeMappingIds.isNotEmpty) {
                  disabledAttributeIds = disabledAttributeMappingIds
                ...
                if (disabledAttributeIds.isNotEmpty) {
                  ...
                  switch (e.attributeControlType) {
                    case AttributeControlType.DropdownList:
                      ...
                      dropDownList.add(new DropDownModel(
                          text: localResourceProvider.getResourseByKey(
                              "Products.ProductAttributes.DropdownList.DefaultItem"),
                          value: "0"));
                      for (var item in e.values) {
                        var attributeName = item.priceAdjustment == null
                            ...
                            : localResourceProvider
                                ...
                                .toString()
                                .replaceAll("{0}", item.name)
                                .replaceAll("{1}", item.priceAdjustment)
                                .replaceAll(
                                    "{2}",
                                    item.customerEntersQty
                                        ? localResourceProvider.getResourseByKey(
                                            "Products.ProductAttributes.PriceAdjustment.PerItem")
                                        : "");

                        dropDownList.add(new DropDownModel(
                            text: attributeName, value: item.id.toString()));
                      }
                          ...
                          children: [
                            ...
                            FlexoDropDown(
                                ...
                                onChange: (val) {
                                  setState(() {
                                    e.defaultValue = "$val";
                                    productDetailsProvider.attributeOnChanged(
                                        context: context,
                                        addToCartType: AddToCartType.Other,
                                      ...
                                      children: [
                                        FlexoTextWidget().contentText16(
                                            text: localResourceProvider
                                                .getResourseByKey(
                                                    "Products.ProductAttributes.PriceAdjustment.Quantity")),
                                        SizedBox(
                                            width: FlexoValues.widthSpace1Px),
                                        TextFieldAttributeWidgets(
                                            showRequiredIcon: false,
                                            width:
                                                FlexoValues.deviceWidth * 0.20,
                                            initialValue:
                    ...
                    case AttributeControlType.ImageSquares:
                      ...
                      for (var i in e.values) {
                        imgUrl.add(ImageSelection(
                            i.id, i.imageSquaresPictureModel.fullSizeImageUrl));
                      }
                      widget = Container(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          children: [
                                  ...
                                  child: Row(
                                    children: imgUrl.map((p) {
                                      return GestureDetector(
                                        ...
                                        onTap: () {
                                          setState(() {
                                            productDetailsProvider.selectId =
                                                p.id;
                                            e.defaultValue =
                                                productDetailsProvider.selectId;
                                            productDetailsProvider
                            ...
                            StatefulBuilder(builder: (context, setState) {
                              for (var item in e.values.where(
                                  (element) => element.customerEntersQty)) {
                                return Column(
                                  children: [
                                    Row(
                                      children: [
                    ...
                    case AttributeControlType.Datepicker:
                      ...
                      if (e.selectedDay != 0 ||
                          ...
                          e.selectedYear != 0) {
                        selectedDatePicker =
                            "${e.selectedDay}-${e.selectedMonth}-${e.selectedYear}";
                      }

                      productDetailsProvider.datePickerMap[e.id] =
                          textEditingController;
                      productDetailsProvider.datePickerMap[e.id]!.text =
                          selectedDatePicker;
                          ...
                          children: [
                            ...
                            FlexoDatePickerPlugin(
                              ...
                              onClick: (formattedDate) {
                                setState(() {
                                  DateTime datePicked = new DateFormat(
                                          StringConstants.DATE_FORMAT)
                                      .parse(formattedDate);

                                  e.selectedDay = int.parse(
                                      DateFormat('dd').format(datePicked));
                                  e.selectedDay = int.parse(
                                      DateFormat('MM').format(datePicked));
                                  e.selectedDay = int.parse(
  ...
  void _openFileExplorer(
      ...
      required ProductDetailsProvider productDetailsProvider}) async {
    ...
    if (permissionGranted) {
      try {
        paths = (await FilePicker.platform.pickFiles(
                ...
                type: productAttribute.allowedFileExtensions.isEmpty
                    ? FileType.any
                    : FileType.custom,
      ...
      setState(() {
        if (paths != null && paths != "") {
          ...
          filePath =
              paths != null ? paths!.map((e) => e.path).toString() : '...';
          ...
          productDetailsProvider.attributeUploadFile(
              context: context,
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  ButtonWidget().getRatioButton(
                      text: attributeName, isCheck: item.isPreSelected),
                  SizedBox(height: FlexoValues.heightSpace1Px),
                  StatefulBuilder(builder: (context, setState) {
