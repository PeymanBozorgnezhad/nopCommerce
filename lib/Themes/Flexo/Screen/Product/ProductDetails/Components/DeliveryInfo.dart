    ...
    return Column(
      children: [
        Container(
          ...
          child: Column(
            children: [
              getProductDetailsModel.freeShippingNotificationEnabled &&
                  ...
                  : Container(),
              getProductDetailsModel.deliveryDate == null ||
                      getProductDetailsModel.deliveryDate == ""
                  ? Container()
                  : Container(
                      child: Column(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Container(
                                  child: FlexoTextWidget().headingBoldText15(
                                    text: getProductDetailsModel.deliveryDate,
                                  ),
                                ),
                              ),
                            ],
