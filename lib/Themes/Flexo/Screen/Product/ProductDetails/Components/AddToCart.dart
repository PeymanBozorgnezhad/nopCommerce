                    ...
                    child: Column(
                      children: [
                        ...
                        TextFieldAttributeWidgets(
                          ...
                          initialValue: getProductDetailsModel
                              .addToCart.customerEnteredPrice
                              .toString(),
                          onChange: (String val) {
                            if (val != "") {
                              setState(() {
                                getProductDetailsModel.addToCart
                                    .customerEnteredPrice = double.parse(val);
                              });
                            }
                          },
                        ),
                        ...
                        Container(
                          ...
                          child: FlexoTextWidget().headingText15(
                            text: getProductDetailsModel
                                .addToCart.customerEnteredPriceRange,
                          ),
                        )
                      ],
                    ),
                      ...
                      children: [
                        StatefulBuilder(
                          builder: (context, setState) {
                            return Container(
                              ...
                              child: getProductDetailsModel
                                      .addToCart.allowedQuantities.isEmpty
                                  ? Container(
                                  ...
                                  : FlexoCustomDropDown(
                                      ...
                                      height: FlexoValues.deviceWidth * 0.1,
                                      showRequiredIcon: false,
                                      selectedValue: getProductDetailsModel
                                          .addToCart.enteredQuantity
                                          .toString(),
                                      items: getProductDetailsModel
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              getProductDetailsModel
                                      .addToCart.availableForPreOrder
                                  ? localResourceProvider
                                      .getResourseByKey("shoppingCart.preorder")
                                      .toString()
                                      .toUpperCase()
                                  : getProductDetailsModel.isRental
                                      ? localResourceProvider
                                          .getResourseByKey("shoppingCart.rent")
                                          .toString()
                                          .toUpperCase()
                                      : isCart
                                          ? localResourceProvider
