...
class RentalInfo {
  ...
  getView(
    ...
    if (getProductDetailsModel.rentalStartDate != null) {
      startDobController.text =
          getProductDetailsModel.rentalStartDate.toString();
    }
                                        ...
                                        child: RichText(
                                          ...
                                          text: new TextSpan(
                                              text: localResourceProvider
                                                  .getResourseByKey(
                                                      "products.rentalStartDate"),
                                              style: TextStyleWidget
                                                  .controlsHeadingTextStyle,
                                              children: [
                                                TextSpan(
                                                  text: " *",
                                                  style: TextStyleWidget
                                                      .controlsRequiredTextStyle,
                                                )
                                              ]),
                                        ),
                                      ),
