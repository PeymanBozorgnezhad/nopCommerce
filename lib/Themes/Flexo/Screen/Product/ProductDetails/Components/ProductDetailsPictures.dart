...
class ProductDetailsPictures {
  getView({required BuildContext context}) {
    ...
    int imageIndex = productDetailsProvider.getProductDetailsModel.pictureModels
        .indexWhere((element) =>
            element.imageUrl ==
                      ...
                      Container(
                        ...
                        child: CarouselSlider(
                          items: productDetailsProvider
                              .getProductDetailsModel.pictureModels
                              .map((e) {
                              ...
                              onTap: () {
                                Navigator.push(
                                    ...
                                    PageTransition(
                                        ...
                                        child: ProductImage(
                                            pictureModel: productDetailsProvider
                                                .getProductDetailsModel
                                                .pictureModels,
                                            defaultImage: e.imageUrl)));
                              },
                        ...
                        child: Column(
                          children: [
                            ...
                            productDetailsProvider
                                ...
                                ? productDetailsProvider.getProductDetailsModel
                                        .addToCart.disableWishlistButton
                                    ? Container()
                                    : Column(
                                        children: [
                                          GestureDetector(
                                ...
                                : Container(),
                            productDetailsProvider
                                    .getProductDetailsModel.emailAFriendEnabled
                                ? GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                          context,
                                    ...
                                    child: Container(
                                        child: CircleAvatar(
                                          ...
                                          maxRadius:
                                              FlexoValues.deviceHeight * 0.022,
                                          backgroundColor: Colors.white,
                                        ),
                                        decoration: new BoxDecoration(
                                          shape: BoxShape.circle,
