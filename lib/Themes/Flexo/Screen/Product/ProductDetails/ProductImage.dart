...
class _ProductImageState extends State<ProductImage> {
  ...
  void initState() {
    ...
    imageIndex = widget.pictureModel
        .indexWhere((element) => element.imageUrl == widget.defaultImage);
  }
    ...
    return StatefulBuilder(builder: (context, setState) {
      return Scaffold(
        appBar: FlexoAppBarWidget()
            .appbar(context: context, title: "Product Image", backButton: true),
        body: SafeArea(
          child: Container(
                      ...
                      options: CarouselOptions(
                        ...
                        onPageChanged: (index, reason) {
                          setState(() {
                            imageIndex = index;
                            widget.defaultImage =
                                widget.pictureModel[index].imageUrl;
                          });
                        },
                      ),
