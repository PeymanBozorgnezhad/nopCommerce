...
import 'package:nopsuite/Screens/Products/ProductReview/ProductReview.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/ProductAttribute.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/AssociatedProducts.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/GiftCardInfo.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/ProductsAlsoPurchased.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/RelatedProducts.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/ProductDetailsShimmer.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/ProductPrice.dart';
import 'package:nopsuite/Themes/Flexo/Screen/Product/ProductDetails/Components/SKU_Man_GTIN_Ven.dart';
...
class FlexoProductDetails extends StatefulWidget {
  ...
  final bool isCart;
  FlexoProductDetails(
      {required this.productId, required this.updateId, required this.isCart});
...
class _FlexoProductDetailsState extends State<FlexoProductDetails> {
  ...
  loadLocalResources() async {
    ...
    if (await CheckConnectivity().checkInternet(context)) {
      context.read<ProductDetailsProvider>().loadCacheData(
          context: context,
  ...
  loadData({required BuildContext context}) async {
    context.read<ProductDetailsProvider>().pageLoadData(
        context: context,
        productId: widget.productId,
        updateId: widget.updateId,
        isCart: widget.isCart);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: FlexoAppBarWidget()
            .searchableAppbar(context: context, backButton: true),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: productDetailsProvider.headerModel,
            headerLoader: productDetailsProvider.isPageLoader),
        body: productDetailsProvider.isPageLoader
            ? SingleChildScrollView(
                child: ProductDetailsShimmer().getView(),
              )
            : Column(
                children: [
                  productDetailsProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: FlexoTextWidget().headingBoldText17(
                                      text: productDetailsProvider
                                          .getProductDetailsModel.name,
                                    ),
                                  ),
                                  SizedBox(
                                    height: FlexoValues.widthSpace2Px,
                                  ),
                                  productDetailsProvider.getProductDetailsModel
                                              .productType ==
                                                          ...
                                                          children: [
                                                            Container(
                                                              child: FlexoTextWidget()
                                                                  .headingBoldText15(
                                                                text:
                                                                    '${localResourceProvider.getResourseByKey("products.sku")}: ',
                                                              ),
                                                            ),
                                                            Container(
                                                              child: FlexoTextWidget()
                                                        ...
                                                        Navigator.push(
                                                                ...
                                                                PageTransition(
                                                                    type:
                                                                        selectedTransition,
                                                                    child: ProductReview(
                                                                        productReviewOverview: productDetailsProvider
                                                                            .getProductDetailsModel
                                                                            .productReviewOverview)))
                                                            .then((value) {
                                                          setState(() {
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            child: FlexoTextWidget()
                                                                .redirectText16(
                                                              text: "${productDetailsProvider.getProductDetailsModel.productReviewOverview.totalReviews} " +
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        Container(
                                                                            margin:
                                                                                EdgeInsets.symmetric(horizontal: FlexoValues.widthSpace1Px),
                                                                            height: FlexoValues.heightSpace2Px,
                                                                            child: VerticalDivider(
                                                                              thickness: 1.0,
                                                                              color: FlexoColorConstants.HIGHLIGHT_COLOR,
                                                                              width: FlexoValues.widthSpace1Px,
                                                                            )),
                                                                        Expanded(
                                                                          child:
                                                                              Container(
                                                                            child:
                                                                                FlexoTextWidget().redirectText16(text: localResourceProvider.getResourseByKey('reviews.overview.addNew'), maxLines: 1),
                                                                          ),
                                                                        ),
                                                                      ],
                                                                    ),
                                  ...
                                  Divider(
                                    color:
                                        FlexoColorConstants.LIST_BORDER_COLOR,
                                    height: 1,
                                  ),
                                ],
                              ),
                                          ...
                                          children: [
                                            Container(
                                              child: FlexoTextWidget()
                                                  .headingBoldText15(
                                                text:
                                                    '${localResourceProvider.getResourseByKey("products.manufacturer")}: ',
                                              ),
                                            ),
                                            Flexible(
                                              child: Container(
                            ...
                            productDetailsProvider
                                        .getProductDetailsModel.productType ==
                                    ProductType.SimpleProduct
                                ? Container(
                                    child: Column(
                                      children: [
                                        ProductAvailability().getView(
                                            context: context,
                                            getProductDetailsModel:
                                                productDetailsProvider
                                                    .getProductDetailsModel),
                                        SKUManGTINVen().getView(
                                            context: context,
                                            getProductDetailsModel:
                                                productDetailsProvider
                                                    .getProductDetailsModel,
                                            isSimple: true),
                                        DeliveryInfo().getView(
                                            context: context,
                                            getProductDetailsModel:
                                                productDetailsProvider
                                                    .getProductDetailsModel),
                                        DownloadSample().getView(
                                            context: context,
                                            getProductDetailsModel:
                                                productDetailsProvider
                                                    .getProductDetailsModel),
                                        FlexoProductAttribute(
                                            getProductDetailsModel:
                                                productDetailsProvider
                                                    .getProductDetailsModel),
                                        GiftCardInfo().getView(
                                            context: context,
                                            giftCard: productDetailsProvider
                                                .getProductDetailsModel
                                                .giftCard),
                                        RentalInfo().getView(
                                            context: context,
                                            getProductDetailsModel:
                                                productDetailsProvider
                                                    .getProductDetailsModel),
                                        ProductPriceWidget().getView(
                                            context: context,
                                            productPrice: productDetailsProvider
                                                .getProductDetailsModel
                                                .productPrice),
                                        ProductTierPrices().getView(
                                            context: context,
                                            tierPrices: productDetailsProvider
                                                .getProductDetailsModel
                                                .tierPrices),
                                        AddToCartWidget().getView(
                                            context: context,
                                            getProductDetailsModel:
                                                productDetailsProvider
                                                    .getProductDetailsModel,
                                            isCart:
                                                productDetailsProvider.isCart),
                                        !productDetailsProvider.isEstimateLoad
                                            ? Container()
                                            : ProductEstimateShipping().getView(
                                                context: context,
                                                getProductDetailsModel:
                                                    productDetailsProvider
                                                        .getProductDetailsModel,
                                                ...
                                                productEstimateShippingModel:
                                                    productDetailsProvider
                                                            .productEstimateShippingModelMap[
                                                        productDetailsProvider
                                                            .getProductDetailsModel
                                                            .id]!),
                                      ],
                            ...
                            productDetailsProvider
                                ...
                                ? productDetailsProvider
                                        ...
                                        .isNotEmpty
                                    ? ProductsAlsoPurchased().getView(
                                        context: context, loadData: loadData)
                                    : Container()
                                : Container(),

                            productDetailsProvider
                                    .getRelatedProductsModel.isNotEmpty
                                ? RelatedProducts().getView(
                                    context: context, loadData: loadData)
                                : Container(),
                          ],
                        ),
