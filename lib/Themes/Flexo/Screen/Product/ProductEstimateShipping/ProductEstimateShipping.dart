...
class FlexoProductEstimateShippingPopup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var productEstimateShippingProvider =
        context.watch<ProductEstimateShippingProvider>();
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body:
            productEstimateShippingProvider.isPageLoader ||
                    localResourceProvider.isLocalDataLoad
                ? Loaders.pageLoader()
                : Column(
                    children: [
                      productEstimateShippingProvider.isAPILoader
                          ? Loaders.apiLoader()
                          : Container(),
                      Expanded(
                        child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      FlexoDropDown(
                                          width: FlexoValues.controlsWidth,
                                          selectedValue:
                                              productEstimateShippingProvider
                                                  .countryId,
                                          items: productEstimateShippingProvider
                                              .countryDropDownList,
                                                                  ...
                                                                  child: Column(
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        child:
                                                                            Column(
                                                                          children: productEstimateShippingProvider
