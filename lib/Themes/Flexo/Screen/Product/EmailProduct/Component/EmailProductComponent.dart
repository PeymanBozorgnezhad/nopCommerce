...
import 'package:nopsuite/Screens/Products/EmailProduct/EmailProductProvider.dart';
            ...
            child: Column(
              children: [
                ...
                TextFieldWidget(
                  ...
                  keyBoardType: TextInputType.emailAddress,
                  hintText: localResourceProvider.getResourseByKey(
                      "products.emailAFriend.personalMessage.hint"),
                  required: false,
                  maxLine: 5,
                  heading: localResourceProvider.getResourseByKey(
                      "products.emailAFriend.personalMessage"),
                ),
                SizedBox(
                ...
                ButtonWidget().getButton(
                    text: localResourceProvider
                        .getResourseByKey('products.emailAFriend.button')
                        .toString()
                        .toUpperCase(),
                    width: FlexoValues.controlsWidth,
                    onClick: () {
                      ...
                      if (form.currentState!.validate()) {
                        emailProductProvider.submitOnClickEvent(
                            context: context);
                      }
                    },
