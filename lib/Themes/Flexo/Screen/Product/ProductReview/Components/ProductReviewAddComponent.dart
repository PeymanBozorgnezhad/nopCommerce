        ...
        children: [
          ...
          Container(
            ...
            child: FlexoTextWidget().headingText17(
              text: localResourceProvider.getResourseByKey("reviews.write"),
            ),
          ),
          SizedBox(height: FlexoValues.widthSpace4Px),
          !productReviewProvider.getProductReviewsModel.addProductReview
          ...
          TextFieldWidget(
            ...
            required: true,
            hintText:
                localResourceProvider.getResourseByKey("reviews.fields.title"),
            maxLine: 1,
            heading:
                localResourceProvider.getResourseByKey("reviews.fields.title"),
            errorMsg: localResourceProvider
                .getResourseByKey("reviews.fields.title.required"),
            keyBoardType: TextInputType.name,
            enable: productReviewProvider.getProductReviewsModel
                .addProductReview.canCurrentCustomerLeaveReview,
          ),
          ...
          TextFieldWidget(
            ...
            hintText: localResourceProvider
                .getResourseByKey("reviews.fields.reviewText"),
            maxLine: 5,
            heading: localResourceProvider
                .getResourseByKey("reviews.fields.reviewText"),
            errorMsg: localResourceProvider
                .getResourseByKey("reviews.fields.reviewText.required"),
            keyBoardType: TextInputType.name,
            enable: productReviewProvider.getProductReviewsModel
                .addProductReview.canCurrentCustomerLeaveReview,
          ),
                ...
                Container(
                  ...
                  child: FlexoTextWidget().headingBoldText16(
                    text: localResourceProvider
                        .getResourseByKey("reviews.fields.rating"),
                  ),
                ),
                SizedBox(height: FlexoValues.widthSpace2Px),
                Container(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          localResourceProvider
                              .getResourseByKey("reviews.fields.rating.bad"),
                          style: TextStyle(
                            color: Colors.red,
                      ...
                      Container(
                        ...
                        child: RatingBar.builder(
                          initialRating:
                              productReviewProvider.rating.toDouble(),
                          minRating: 1,
          ...
          Container(
            child: Column(
              children: productReviewProvider
                  .getProductReviewsModel.reviewTypeList
                  .map((e) {
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              alignment: Alignment.center,
                              child: RatingBar.builder(
                                initialRating: productReviewProvider
                                    .dynamicRating
                                    .toDouble(),
                                minRating: 1,
                                direction: Axis.horizontal,
                                ...
                                itemBuilder: (context, _) => Icon(
                                  Icons.star,
                                  color:
                                      FlexoColorConstants.PRODUCT_RATING_COLOR,
                                ),
                                onRatingUpdate: (rating) {
                                  productReviewProvider.dynamicRating =
                                      rating.toInt();
                                  productReviewProvider.customReview[e.id] = {
                                    '"reviewTypeId"': e.id,
                                    '"rating"':
          ...
          ButtonWidget().getButton(
              text: localResourceProvider
                  .getResourseByKey("reviews.submitButton")
                  .toString()
                  .toUpperCase(),
              width: FlexoValues.controlsWidth,
              onClick: () {
                ...
                if (form.currentState!.validate()) {
                  if (productReviewProvider.getProductReviewsModel
                      .addProductReview.canCurrentCustomerLeaveReview) {
                    if (localResourceProvider.getSettingByName(
                      ...
                      FlushBarMessage().warningMessage(
                          ...
                          title: localResourceProvider
                              .getResourseByKey("reviews.seeAfterApproving"));
