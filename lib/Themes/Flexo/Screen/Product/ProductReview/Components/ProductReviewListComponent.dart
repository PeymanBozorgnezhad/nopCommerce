          ...
          ? Container(
              child: Column(
                children: [
                  ...
                  productReviewProvider.getProductReviewsModel.items.isEmpty
                      ? Container()
                      : Container(
                          ...
                          child: FlexoTextWidget().headingBoldText16(
                            text: localResourceProvider
                                .getResourseByKey("reviews.existingReviews"),
                          ),
                        ),
                        ...
                        return Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              e.additionalProductReviewList.isEmpty
                                  ? Container()
                                  : Container(
                                      padding: EdgeInsets.symmetric(
                                          horizontal:
                                              FlexoValues.widthSpace2Px),
                                      child: Column(
                                        children: e.additionalProductReviewList
                                            .map((r) {
                                          return Container(
                                            child: Column(
                                              children: [
                              ...
                              Container(
                                ...
                                child: RichText(
                                  text: new TextSpan(
                                      text:
                                          "${localResourceProvider.getResourseByKey("reviews.from")}:",
                                      style: TextStyleWidget.headingTextStyle16,
                                      children: [
                                        TextSpan(
                                          text: " ${e.customerName}",
                                          style: e.allowViewingProfiles
                                              ? TextStyleWidget
                                                  .redirectTextStyle16
                                              : TextStyleWidget
                                                  .headingTextStyle16,
                                        ...
                                        TextSpan(
                                            text:
                                                " | ${localResourceProvider.getResourseByKey("rewardPoints.fields.createdDate")}: ${e.writtenOnStr}",
                                    ...
                                    Expanded(
                                      child: Container(
                                        child: FlexoTextWidget().contentText15(
                                          text: localResourceProvider
                                              .getResourseByKey(
                                                  "reviews.helpfulness.wasHelpful?"),
                                        ),
                                      ),
                                    ),
                                    Container(
                                        ...
                                        children: [
                                            ...
                                            onTap: () async {
                                              bool response =
                                                  await productReviewProvider
                                                      .reviewHelpfulnessClick(
                                                          context: context,
                                                          productReviewId: e.id,
                                                          isHelpful: true);
                                              if (response) {
                                                e.helpfulness.helpfulYesTotal =
                                                    productReviewProvider
                                                        .setProductReviewHelpfulnessModel
                                                        .totalYes;
                                                e.helpfulness.helpfulNoTotal =
                                                    productReviewProvider
                                                        .setProductReviewHelpfulnessModel
                                                        .totalNo;
                                                FlushBarMessage().simpleMessage(
                                                    context: context,
                                          ...
                                          Container(
                                            child:
                                              ...
                                              text:
                                                  "(${e.helpfulness.helpfulYesTotal}/${e.helpfulness.helpfulNoTotal})",
                                            ),
                                          ),
                                        ],
                                      ),
