    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: FlexoAppBarWidget().appbar(
            ...
            title: localResourceProvider.isLocalDataLoad
                ...
                : localResourceProvider
                    .getResourseByKey('pageTitle.allProductTags')),
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: productTagProvider.headerModel,
            headerLoader: productTagProvider.isAPILoader),
        body: productTagProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  productTagProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ProductTagComponent()
                                .getProductTagComponent(context),
                          ],
                        ),
                      ),
                    ),
