...
import 'package:nopsuite/Themes/Flexo/Screen/Product/CompareProduct/Component/CompareProductComponent.dart';
    ...
    return Scaffold(
      appBar: FlexoAppBarWidget().appbar(
          ...
          title: localResourceProvider.isLocalDataLoad
              ? ""
              : localResourceProvider.getResourseByKey("products.compare")),
      ...
      bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
          ...
          headerData: compareProductProvider.headerModel,
          headerLoader: compareProductProvider.isPageLoader),
      body: compareProductProvider.isPageLoader
          ? Loaders.pageLoader()
          : Column(
              children: [
                compareProductProvider.isAPILoader
                    ? Loaders.apiLoader()
                    : Container(),
                Expanded(
                  child: Container(
                                  ...
                                  child: FlexoTextWidget().contentText16(
                                    text:
                                        localResourceProvider.getResourseByKey(
                                            "products.compare.noItems"),
                                  ),
                                )
                              : CompareProductComponent()
                                  .getCompareProductComponent(context: context),
                        ],
                      ),
                    ),
                  ),
