            ...
            children: [
                  ...
                  children: [
                    ButtonWidget().getButton(
                        text: localResourceProvider
                            .getResourseByKey("products.compare.clear")
                            .toString()
                            .toUpperCase(),
                        width: FlexoValues.deviceWidth * 0.3,
                        onClick: () {
                          compareProductProvider.deleteAllProduct(
                              context: context);
                        },
                        isApiLoad: false),
                  ],
              ...
              Container(
                ...
                child: Scrollbar(
                  ...
                  interactive: true,
                  thickness:
                      compareProductProvider.compareProductDetailsList.length ==
                              1
                          ? 0
                          : 4,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      child: Row(
                                        children: [
                                          ...
                                          Container(
                                            child: Row(
                                              children: compareProductProvider
                                                  .compareProductDetailsList
                                                  .map((product) {
                                                return Container(
                                                  width: compareProductProvider
                                                              .compareProductDetailsList
                                                              .length ==
                                                          1
                                                      ? FlexoValues
                                    ...
                                    localResourceProvider.getSettingByName(
                                                "catalogSettings.includeShortDescriptionInCompareProducts") ==
                                            "True"
                                        ? Container(
                                            child: Row(
                                              children: [
                                                Container(
                                                  ...
                                                  child: FlexoTextWidget()
                                                    ...
                                                    text: localResourceProvider
                                                        .getResourseByKey(
                                                            "Products.Compare.ShortDescription"),
                                                  ),
                                                ),
                                                Container(
                                                  child: Row(
                                        ...
                                        : Container(),
                                    localResourceProvider.getSettingByName(
                                                "catalogSettings.includeFullDescriptionInCompareProducts") ==
                                            "True"
                                        ? Container(
                                            child: Row(
                                              children: [
                                                Container(
                                                  ...
                                                  child: FlexoTextWidget()
                                                    ...
                                                    text: localResourceProvider
                                                        .getResourseByKey(
                                                            "Products.Compare.FullDescription"),
                                                  ),
                                                ),
                                                Container(
                                                  child: Row(
                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: compareProductProvider
                                            ...
                                            .map((group) {
                                          compareProductProvider
                                              .uniqueGroupAttributes = [];
                                          if (group.attributes.length > 0) {
                                            for (var productData
                                                in compareProductProvider
                                                    .compareProductDetailsList) {
                                              for (var group in productData
                                                                ...
                                                                child: Row(
                                                                  children: compareProductProvider
                                                                      ...
                                                                      .map(
                                                                          (product) {
                                                                    return Container(
                                                                      width: compareProductProvider.compareProductDetailsList.length ==
                                                                              1
                                                                          ? FlexoValues.deviceWidth *
                                                                              0.66
                                                                          : FlexoValues.deviceWidth *
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: compareProductProvider
                                                                        ...
                                                                        if (isHasValue) {
                                                                                                      ...
                                                                                                      return Container(
                                                                                                        child: StatefulBuilder(builder: (context, setState) {
                                                                                                          return Container(
                                                                                                            ...
                                                                                                            decoration: BoxDecoration(border: Border(bottom: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR), right: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR))),
                                                                                                            alignment: Alignment.centerLeft,
                                                                                                            child: RichText(
                                                                                                              text: HTML.toTextSpan(
                                                                                                                context,
                                                                          ...
                                                                          return Container(
                                                                            width: compareProductProvider.compareProductDetailsList.length == 1
                                                                                ? FlexoValues.deviceWidth * 0.66
                                                                            ...
                                                                            decoration:
                                                                                BoxDecoration(border: Border(bottom: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR), right: BorderSide(color: FlexoColorConstants.LIST_BORDER_COLOR))),
                                                                            alignment:
                                                                                Alignment.centerLeft,
                                                                          );
                                                                        }
