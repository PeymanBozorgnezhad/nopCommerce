...
import 'package:nopsuite/Screens/Wishlist/EmailWishlist/EmailWishlistProvider.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: emailWishlistProvider.headerModel,
            headerLoader: emailWishlistProvider.isPageLoader),
        body: emailWishlistProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  emailWishlistProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                  Expanded(
                    child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              TextFieldWidget(
                                ...
                                controller:
                                    emailWishlistProvider.friendEmailController,
                                hintText: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.friendEmail.hint"),
                                required: true,
                                errorMsg: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.friendEmail.required"),
                                heading: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.friendEmail"),
                              ...
                              TextFieldWidget(
                                width: FlexoValues.controlsWidth,
                                controller:
                                    emailWishlistProvider.yourEmailController,
                                hintText: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.yourEmailAddress.hint"),
                                required: true,
                                errorMsg: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.yourEmailAddress.required"),
                                heading: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.yourEmailAddress"),
                                keyBoardType: TextInputType.emailAddress,
                              ),
                              SizedBox(
                                height: FlexoValues.heightSpace2Px,
                              ...
                              TextFieldWidget(
                                width: FlexoValues.controlsWidth,
                                controller:
                                    emailWishlistProvider.messageController,
                                hintText: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.personalMessage.hint"),
                                required: false,
                                errorMsg: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.personalMessage.required"),
                                heading: localResourceProvider.getResourseByKey(
                                    "wishlist.emailAFriend.personalMessage"),
                              ...
                              ButtonWidget().getButton(
                                  ...
                                  onClick: () {
                                    ...
                                    if (form.currentState!.validate()) {
                                      emailWishlistProvider.shareEmailWishlist(
                                          context: context);
                                    }
                                  },
                                  isApiLoad: false)
