            ...
            wishlistProvider.wishlistModel.warnings.length > 0
                ? Container(
                    ...
                    child: Column(
                      ...
                      children:
                          wishlistProvider.wishlistModel.warnings.map((w) {
                        return Container(
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: FlexoTextWidget().productBoxText(
                                            text: e.productName, maxLines: 1),
                                                              ...
                                                              child:
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  Navigator.push(
                                                                          ...
                                                                          PageTransition(
                                                                              type: selectedTransition,
                                                                              child: ProductDetails(productId: e.productId, updateId: e.id, isCart: false)))
                                                                      .then((value) {
                                                                    setState(
                                                                        () {
                                                                      wishlistProvider.getWishlistData(
