...
import 'package:nopsuite/Screens/Wishlist/EmailWishlist/EmailWishlist.dart';
import 'package:nopsuite/Screens/Wishlist/Wishlist/WishlistProvider.dart';
    ...
    return StatefulBuilder(builder: (context, setState) {
      return Column(
        children: [
            ...
            child: Row(
              ...
              children: [
                wishlistProvider.wishlistModel.emailWishlistEnabled
                        ...
                        child: Container(
                          ...
                          child: FlexoTextWidget().buttonText(
                              text: localResourceProvider
                                  .getResourseByKey("wishlist.emailAFriend")
                                  .toString()
                                  .toUpperCase(),
                              maxLines: 1),
                        ),
                    ...
                    : Container(),
                wishlistProvider.wishlistModel.isEditable &&
                        wishlistProvider.wishlistModel.items.length > 0
                    ? wishlistProvider.wishlistShareURL != ""
                        ? GestureDetector(
                            onTap: () async {
                              if (!wishlistProvider.isAPILoader) {
                                wishlistProvider.sharedWishlist(
                                    context: context);
                              }
                            },
                            child: Container(
                              width: wishlistProvider
                                      .wishlistModel.emailWishlistEnabled
                                  ? FlexoValues.deviceWidth * 0.47
                              ...
                              child: FlexoTextWidget().buttonText(
                                  text: localResourceProvider
                                      .getResourseByKey(
                                          "nopAdvance.plugin.publicApi.defaultClean.shareWishlist")
                                      .toString()
                                      .toUpperCase(),
                                  maxLines: 1),
                            ),
          ...
          wishlistProvider.wishlistModel.items.length > 0 &&
                  wishlistProvider.wishlistModel.displayTaxShippingInfo
              ? Column(
                  children: [
                    SizedBox(height: FlexoValues.heightSpace1Px),
                    Container(
                      ...
                      child: RichText(
                        ...
                        text: HTML.toTextSpan(
                            context,
                            wishlistProvider.taxTypeModel.currentTaxType ==
