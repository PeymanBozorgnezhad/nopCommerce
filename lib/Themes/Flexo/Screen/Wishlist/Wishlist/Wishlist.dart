    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: FlexoBottomNavigationWidget().bottomNavigation(
            ...
            headerData: wishlistProvider.headerModel,
            headerLoader: wishlistProvider.isPageLoader),
        body: wishlistProvider.isPageLoader
            ? Loaders.pageLoader()
            : Column(
                children: [
                  wishlistProvider.isAPILoader
                      ? Loaders.apiLoader()
                      : Container(),
                      ...
                      ? Expanded(
                          child: Container(
                              ...
                              padding: EdgeInsets.symmetric(
                                  ...
                                  vertical: FlexoValues.heightSpace2Px),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Image.asset(
                                        FlexoAssetsPath.EMPTY_WISHLIST),
                                  ),
                                  ...
                                  Container(
                                    child: FlexoTextWidget().contentText16(
                                        text: localResourceProvider
                                            .getResourseByKey(
                                                "wishlist.cartIsEmpty")),
                                  ),
                                ],
                              )),
                        )
                      : Expanded(
                          child: localResourceProvider.isLocalDataLoad
                              ? Container()
                              : Container(
                                    ...
                                    child: Column(
                                      children: [
                                        WishlistContentComponent()
                                            .getWishlistContentComponent(
                                                context: context),
                                        WishlistProductsComponent()
                                            .getWishlistProductListComponent(
                                                context: context),
                                        SizedBox(
