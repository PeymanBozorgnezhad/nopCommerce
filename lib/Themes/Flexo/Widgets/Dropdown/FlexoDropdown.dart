...
class _FlexoDropDownState extends State<FlexoDropDown> {
  ...
  Widget build(BuildContext context) {
    if (CheckDeviceType().isIOS()) {
      selectedIndex = widget.items
          .indexWhere((element) => element.value == widget.selectedValue);
      iosDisplayValue = widget.items
          .where((element) => element.value == widget.selectedValue)
          .first
          .text;
    }
            ...
            children: [
              CheckDeviceType().isIOS()
                  ? GestureDetector(
                                ...
                                child: CupertinoTheme(
                                  data: CupertinoThemeData(
                                    textTheme: CupertinoTextThemeData(
                                        ...
                                        textStyle:
                                            TextStyleWidget.controlsTextStyle),
                                  ...
                                  child: CupertinoPicker(
                                    children: widget.items.map((e) {
                                      return Container(
                                        child: FlexoTextWidget()
                                            .dropdownControlsText(
                                                text: e.text, maxLines: 1),
                                    ...
                                    onSelectedItemChanged: (value) {
                                      ...
                                      widget.onChange(widget
                                          ...
                                          .toString());
                                      iosDisplayValue =
                                          widget.items[selectedIndex].text;
                                      //});
                                    },
                                    scrollController:
                      ...
                      child: Container(
                        width: widget.showRequiredIcon
                            ? widget.width - FlexoValues.widthSpace3Px
                            : widget.width,
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                child: FlexoTextWidget().controlsText(
                                    text: iosDisplayValue, maxLines: 1),
                              ),
                            ),
                            Container(
                              alignment: Alignment.center,
                  ...
                  : DropdownButtonHideUnderline(
                      child: DropdownButton2(
                        ...
                        buttonWidth: widget.showRequiredIcon
                            ? widget.width - FlexoValues.widthSpace3Px
                            : widget.width,
                        ...
                        dropdownWidth: widget.showRequiredIcon
                            ? widget.width - FlexoValues.widthSpace3Px
                            : widget.width,
