      ...
      child: Column(
        ...
        children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    inputFormatters: <TextInputFormatter>[
                      widget.textFieldType == TextFieldType.Numeric
                    ...
                    obscureText: TextFieldType.Password == widget.textFieldType
                        ? isVisible
                        : false,
                  ),
                ),
                widget.required && widget.showRequiredIcon
                    ? RequiredIconWidget()
                    : SizedBox(
                        width: 0,
                      )
          ...
          isValidate
              ? Container(
                  child: FlexoTextWidget()
                      .controlsErrorText(text: widget.errorMsgForEmail))
              : SizedBox(
                  height: 0,
                ),
        ],
