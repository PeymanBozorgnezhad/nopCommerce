...
class _FlexoDatePickerPluginState extends State<FlexoDatePickerPlugin> {
  ...
  Widget build(BuildContext context) {
    if (widget.controller.text.isNotEmpty) {
      initializeDate =
          DateFormat(StringConstants.DATE_FORMAT).parse(widget.controller.text);
    } else {
                                ...
                                child: CupertinoDatePicker(
                                  ...
                                  onDateTimeChanged: (value) {
                                    ...
                                    String formattedDate =
                                        DateFormat(StringConstants.DATE_FORMAT)
                                            .format(initializeDate);
                                    widget.controller.text = formattedDate;
                                    widget.onClick!(formattedDate);
                                  },
                                  initialDateTime: initializeDate == null
                                      ? DateTime.now()
                                      : initializeDate,
