...
class FlexoTextWidget {
  ...
  Widget productBoxHorizontalText({
    required String text,
    int maxLines = 10,
  }) {
    return Text(
  ...
  Widget richTextContentText16(
      {required String text,
      int maxLines = 10,
      required List<String> subTextList}) {
    return RichText(
      textAlign: TextAlign.start,
      maxLines: 2,
      overflow: TextOverflow.ellipsis,
